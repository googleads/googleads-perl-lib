package Google::Ads::AdWords::v201309::AdGroupAdService::AdGroupAdServiceInterfacePort;
use strict;
use warnings;
...
require Google::Ads::AdWords::v201309::TypeMaps::AdGroupAdService
    if not Google::Ads::AdWords::v201309::TypeMaps::AdGroupAdService->can('get_class');

sub START {
    $_[0]->set_proxy('https://adwords.google.com/api/adwords/cm/v201309/AdGroupAdService') if not $_[2]->{proxy};
    $_[0]->set_class_resolver('Google::Ads::AdWords::v201309::TypeMaps::AdGroupAdService')
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            ...
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201309::AdGroupAdService::get )],
        },
        header => {
           ...
           'use' => 'literal',
            namespace => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle => '',
            parts => [qw( Google::Ads::AdWords::v201309::AdGroupAdService::RequestHeader )],
        },
        headerfault => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201309::AdGroupAdService::mutate )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201309::AdGroupAdService::query )],
        },
        header => {
...
Google::Ads::AdWords::v201309::AdGroupAdService::AdGroupAdServiceInterfacePort - SOAP Interface for the AdGroupAdService Web Service

=head1 SYNOPSIS

 use Google::Ads::AdWords::v201309::AdGroupAdService::AdGroupAdServiceInterfacePort;
 my $interface = Google::Ads::AdWords::v201309::AdGroupAdService::AdGroupAdServiceInterfacePort->new();
...
located at https://adwords.google.com/api/adwords/cm/v201309/AdGroupAdService.
...
Returns a L<Google::Ads::AdWords::v201309::AdGroupAdService::getResponse|Google::Ads::AdWords::v201309::AdGroupAdService::getResponse> object.
...
Returns a L<Google::Ads::AdWords::v201309::AdGroupAdService::mutateResponse|Google::Ads::AdWords::v201309::AdGroupAdService::mutateResponse> object.
...
Returns a L<Google::Ads::AdWords::v201309::AdGroupAdService::queryResponse|Google::Ads::AdWords::v201309::AdGroupAdService::queryResponse> object.
...
Generated by SOAP::WSDL on Thu Jun 26 19:33:09 2014
