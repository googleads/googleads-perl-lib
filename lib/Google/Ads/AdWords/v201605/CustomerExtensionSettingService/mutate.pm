...
package Google::Ads::AdWords::v201605::CustomerExtensionSettingService::mutate;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'operations' => 'Google::Ads::AdWords::v201605::CustomerExtensionSettingOperation',
    },
    {
...
Google::Ads::AdWords::v201605::CustomerExtensionSettingService::mutate

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
mutate from the namespace https://adwords.google.com/api/adwords/cm/v201605.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201605::CustomerExtensionSettingService::mutate->new($data);
