package Google::Ads::AdWords::v201605::CampaignCriterion;
use strict;
use warnings;
...
Google::Ads::AdWords::v201605::CampaignCriterion

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CampaignCriterion from the namespace https://adwords.google.com/api/adwords/cm/v201605.
