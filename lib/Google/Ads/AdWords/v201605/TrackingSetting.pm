package Google::Ads::AdWords::v201605::TrackingSetting;
use strict;
use warnings;
...
Google::Ads::AdWords::v201605::TrackingSetting

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
TrackingSetting from the namespace https://adwords.google.com/api/adwords/cm/v201605.
