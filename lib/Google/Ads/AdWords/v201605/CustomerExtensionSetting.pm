package Google::Ads::AdWords::v201605::CustomerExtensionSetting;
use strict;
use warnings;
...
Google::Ads::AdWords::v201605::CustomerExtensionSetting

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CustomerExtensionSetting from the namespace https://adwords.google.com/api/adwords/cm/v201605.
