package Google::Ads::AdWords::v201605::ManagedCustomerService::ManagedCustomerServiceInterfacePort;
use strict;
use warnings;
...
require Google::Ads::AdWords::v201605::TypeMaps::ManagedCustomerService
    if not Google::Ads::AdWords::v201605::TypeMaps::ManagedCustomerService->can('get_class');

sub START {
    $_[0]->set_proxy('https://adwords.google.com/api/adwords/mcm/v201605/ManagedCustomerService') if not $_[2]->{proxy};
    $_[0]->set_class_resolver('Google::Ads::AdWords::v201605::TypeMaps::ManagedCustomerService')
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            ...
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201605::ManagedCustomerService::get )],
        },
        header => {
           ...
           'use' => 'literal',
            namespace => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle => '',
            parts => [qw( Google::Ads::AdWords::v201605::ManagedCustomerService::RequestHeader )],
        },
        headerfault => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201605::ManagedCustomerService::getPendingInvitations )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201605::ManagedCustomerService::mutate )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201605::ManagedCustomerService::mutateLabel )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201605::ManagedCustomerService::mutateLink )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201605::ManagedCustomerService::mutateManager )],
        },
        header => {
...
Google::Ads::AdWords::v201605::ManagedCustomerService::ManagedCustomerServiceInterfacePort - SOAP Interface for the ManagedCustomerService Web Service

=head1 SYNOPSIS

 use Google::Ads::AdWords::v201605::ManagedCustomerService::ManagedCustomerServiceInterfacePort;
 my $interface = Google::Ads::AdWords::v201605::ManagedCustomerService::ManagedCustomerServiceInterfacePort->new();
...
located at https://adwords.google.com/api/adwords/mcm/v201605/ManagedCustomerService.
...
Returns a L<Google::Ads::AdWords::v201605::ManagedCustomerService::getResponse|Google::Ads::AdWords::v201605::ManagedCustomerService::getResponse> object.
...
Returns a L<Google::Ads::AdWords::v201605::ManagedCustomerService::getPendingInvitationsResponse|Google::Ads::AdWords::v201605::ManagedCustomerService::getPendingInvitationsResponse> object.

 $response = $interface->getPendingInvitations( {
    selector =>  $a_reference_to, # see Google::Ads::AdWords::v201605::PendingInvitationSelector
  },,
 );
...
Returns a L<Google::Ads::AdWords::v201605::ManagedCustomerService::mutateResponse|Google::Ads::AdWords::v201605::ManagedCustomerService::mutateResponse> object.

 $response = $interface->mutate( {
    operations =>  $a_reference_to, # see Google::Ads::AdWords::v201605::ManagedCustomerOperation
  },,
 );
...
Returns a L<Google::Ads::AdWords::v201605::ManagedCustomerService::mutateLabelResponse|Google::Ads::AdWords::v201605::ManagedCustomerService::mutateLabelResponse> object.

 $response = $interface->mutateLabel( {
    operations =>  $a_reference_to, # see Google::Ads::AdWords::v201605::ManagedCustomerLabelOperation
  },,
 );
...
Returns a L<Google::Ads::AdWords::v201605::ManagedCustomerService::mutateLinkResponse|Google::Ads::AdWords::v201605::ManagedCustomerService::mutateLinkResponse> object.
...
Returns a L<Google::Ads::AdWords::v201605::ManagedCustomerService::mutateManagerResponse|Google::Ads::AdWords::v201605::ManagedCustomerService::mutateManagerResponse> object.

 $response = $interface->mutateManager( {
    operations =>  $a_reference_to, # see Google::Ads::AdWords::v201605::MoveOperation
  },,
 );
...
Generated by SOAP::WSDL on Wed May 25 14:40:37 2016
