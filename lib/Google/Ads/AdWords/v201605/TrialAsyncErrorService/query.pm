...
package Google::Ads::AdWords::v201605::TrialAsyncErrorService::query;
use strict;
use warnings;
...
Google::Ads::AdWords::v201605::TrialAsyncErrorService::query
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201605::TrialAsyncErrorService::query->new($data);
