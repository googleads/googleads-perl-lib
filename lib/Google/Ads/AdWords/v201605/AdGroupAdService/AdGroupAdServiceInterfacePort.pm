package Google::Ads::AdWords::v201605::AdGroupAdService::AdGroupAdServiceInterfacePort;
use strict;
use warnings;
...
require Google::Ads::AdWords::v201605::TypeMaps::AdGroupAdService
    if not Google::Ads::AdWords::v201605::TypeMaps::AdGroupAdService->can('get_class');

sub START {
    $_[0]->set_proxy('https://adwords.google.com/api/adwords/cm/v201605/AdGroupAdService') if not $_[2]->{proxy};
    $_[0]->set_class_resolver('Google::Ads::AdWords::v201605::TypeMaps::AdGroupAdService')
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            ...
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201605::AdGroupAdService::get )],
        },
        header => {
           ...
           'use' => 'literal',
            namespace => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle => '',
            parts => [qw( Google::Ads::AdWords::v201605::AdGroupAdService::RequestHeader )],
        },
        headerfault => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201605::AdGroupAdService::mutate )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201605::AdGroupAdService::mutateLabel )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201605::AdGroupAdService::query )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201605::AdGroupAdService::upgradeUrl )],
        },
        header => {
...
Google::Ads::AdWords::v201605::AdGroupAdService::AdGroupAdServiceInterfacePort - SOAP Interface for the AdGroupAdService Web Service

=head1 SYNOPSIS

 use Google::Ads::AdWords::v201605::AdGroupAdService::AdGroupAdServiceInterfacePort;
 my $interface = Google::Ads::AdWords::v201605::AdGroupAdService::AdGroupAdServiceInterfacePort->new();
...
located at https://adwords.google.com/api/adwords/cm/v201605/AdGroupAdService.
...
Returns a L<Google::Ads::AdWords::v201605::AdGroupAdService::getResponse|Google::Ads::AdWords::v201605::AdGroupAdService::getResponse> object.
...
Returns a L<Google::Ads::AdWords::v201605::AdGroupAdService::mutateResponse|Google::Ads::AdWords::v201605::AdGroupAdService::mutateResponse> object.

 $response = $interface->mutate( {
    operations =>  $a_reference_to, # see Google::Ads::AdWords::v201605::AdGroupAdOperation
  },,
 );
...
Returns a L<Google::Ads::AdWords::v201605::AdGroupAdService::mutateLabelResponse|Google::Ads::AdWords::v201605::AdGroupAdService::mutateLabelResponse> object.
...
Returns a L<Google::Ads::AdWords::v201605::AdGroupAdService::queryResponse|Google::Ads::AdWords::v201605::AdGroupAdService::queryResponse> object.
...
Returns a L<Google::Ads::AdWords::v201605::AdGroupAdService::upgradeUrlResponse|Google::Ads::AdWords::v201605::AdGroupAdService::upgradeUrlResponse> object.

 $response = $interface->upgradeUrl( {
    operations =>  $a_reference_to, # see Google::Ads::AdWords::v201605::AdUrlUpgrade
  },,
 );
...
Generated by SOAP::WSDL on Wed May 25 14:37:53 2016
