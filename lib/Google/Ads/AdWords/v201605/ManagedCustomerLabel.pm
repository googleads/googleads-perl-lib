package Google::Ads::AdWords::v201605::ManagedCustomerLabel;
use strict;
use warnings;
...
Google::Ads::AdWords::v201605::ManagedCustomerLabel

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ManagedCustomerLabel from the namespace https://adwords.google.com/api/adwords/mcm/v201605.
