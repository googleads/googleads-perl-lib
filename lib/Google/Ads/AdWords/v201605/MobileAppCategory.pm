package Google::Ads::AdWords::v201605::MobileAppCategory;
use strict;
use warnings;
...
Google::Ads::AdWords::v201605::MobileAppCategory

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
MobileAppCategory from the namespace https://adwords.google.com/api/adwords/cm/v201605.
