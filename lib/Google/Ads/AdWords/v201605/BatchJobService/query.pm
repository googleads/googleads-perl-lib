...
package Google::Ads::AdWords::v201605::BatchJobService::query;
use strict;
use warnings;
...
Google::Ads::AdWords::v201605::BatchJobService::query
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201605::BatchJobService::query->new($data);
