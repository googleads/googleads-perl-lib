...
package Google::Ads::AdWords::v201605::BudgetService::query;
use strict;
use warnings;
...
Google::Ads::AdWords::v201605::BudgetService::query
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201605::BudgetService::query->new($data);
