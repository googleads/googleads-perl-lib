package Google::Ads::AdWords::v201605::StringKey;
use strict;
use warnings;
...
Google::Ads::AdWords::v201605::StringKey

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
StringKey from the namespace https://adwords.google.com/api/adwords/rm/v201605.
