package Google::Ads::AdWords::v201605::WebsiteCallMetricsConversion;
use strict;
use warnings;
...
Google::Ads::AdWords::v201605::WebsiteCallMetricsConversion

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
WebsiteCallMetricsConversion from the namespace https://adwords.google.com/api/adwords/cm/v201605.
