package Google::Ads::AdWords::v201605::CampaignExtensionSettingReturnValue;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'value' => 'Google::Ads::AdWords::v201605::CampaignExtensionSetting',
    },
    {
...
Google::Ads::AdWords::v201605::CampaignExtensionSettingReturnValue

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CampaignExtensionSettingReturnValue from the namespace https://adwords.google.com/api/adwords/cm/v201605.
