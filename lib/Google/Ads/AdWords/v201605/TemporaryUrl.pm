package Google::Ads::AdWords::v201605::TemporaryUrl;
use strict;
use warnings;
...
Google::Ads::AdWords::v201605::TemporaryUrl

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
TemporaryUrl from the namespace https://adwords.google.com/api/adwords/cm/v201605.
