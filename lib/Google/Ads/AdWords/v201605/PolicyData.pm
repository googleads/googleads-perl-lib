package Google::Ads::AdWords::v201605::PolicyData;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'disapprovalReasons' => 'Google::Ads::AdWords::v201605::DisapprovalReason',
...
Google::Ads::AdWords::v201605::PolicyData

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
PolicyData from the namespace https://adwords.google.com/api/adwords/cm/v201605.
