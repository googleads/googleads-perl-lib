...
package Google::Ads::AdWords::v201605::LabelService::query;
use strict;
use warnings;
...
Google::Ads::AdWords::v201605::LabelService::query
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201605::LabelService::query->new($data);
