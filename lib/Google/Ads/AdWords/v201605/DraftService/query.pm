...
package Google::Ads::AdWords::v201605::DraftService::query;
use strict;
use warnings;
...
Google::Ads::AdWords::v201605::DraftService::query
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201605::DraftService::query->new($data);
