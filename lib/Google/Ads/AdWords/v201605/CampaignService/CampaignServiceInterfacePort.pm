package Google::Ads::AdWords::v201605::CampaignService::CampaignServiceInterfacePort;
use strict;
use warnings;
...
require Google::Ads::AdWords::v201605::TypeMaps::CampaignService
    if not Google::Ads::AdWords::v201605::TypeMaps::CampaignService->can('get_class');

sub START {
    $_[0]->set_proxy('https://adwords.google.com/api/adwords/cm/v201605/CampaignService') if not $_[2]->{proxy};
    $_[0]->set_class_resolver('Google::Ads::AdWords::v201605::TypeMaps::CampaignService')
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            ...
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201605::CampaignService::get )],
        },
        header => {
           ...
           'use' => 'literal',
            namespace => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle => '',
            parts => [qw( Google::Ads::AdWords::v201605::CampaignService::RequestHeader )],
        },
        headerfault => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201605::CampaignService::mutate )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201605::CampaignService::mutateLabel )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201605::CampaignService::query )],
        },
        header => {
...
Google::Ads::AdWords::v201605::CampaignService::CampaignServiceInterfacePort - SOAP Interface for the CampaignService Web Service

=head1 SYNOPSIS

 use Google::Ads::AdWords::v201605::CampaignService::CampaignServiceInterfacePort;
 my $interface = Google::Ads::AdWords::v201605::CampaignService::CampaignServiceInterfacePort->new();
...
located at https://adwords.google.com/api/adwords/cm/v201605/CampaignService.
...
Returns a L<Google::Ads::AdWords::v201605::CampaignService::getResponse|Google::Ads::AdWords::v201605::CampaignService::getResponse> object.
...
Returns a L<Google::Ads::AdWords::v201605::CampaignService::mutateResponse|Google::Ads::AdWords::v201605::CampaignService::mutateResponse> object.

 $response = $interface->mutate( {
    operations =>  $a_reference_to, # see Google::Ads::AdWords::v201605::CampaignOperation
  },,
 );
...
Returns a L<Google::Ads::AdWords::v201605::CampaignService::mutateLabelResponse|Google::Ads::AdWords::v201605::CampaignService::mutateLabelResponse> object.

 $response = $interface->mutateLabel( {
    operations =>  $a_reference_to, # see Google::Ads::AdWords::v201605::CampaignLabelOperation
  },,
 );
...
Returns a L<Google::Ads::AdWords::v201605::CampaignService::queryResponse|Google::Ads::AdWords::v201605::CampaignService::queryResponse> object.
...
Generated by SOAP::WSDL on Wed May 25 14:38:59 2016
