package Google::Ads::AdWords::v201605::RuleBasedUserList;
use strict;
use warnings;
...
Google::Ads::AdWords::v201605::RuleBasedUserList

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
RuleBasedUserList from the namespace https://adwords.google.com/api/adwords/rm/v201605.
