package Google::Ads::AdWords::v201605::CrmBasedUserList;
use strict;
use warnings;
...
Google::Ads::AdWords::v201605::CrmBasedUserList

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CrmBasedUserList from the namespace https://adwords.google.com/api/adwords/rm/v201605.
