...
package Google::Ads::AdWords::v201605::DraftAsyncErrorService::query;
use strict;
use warnings;
...
Google::Ads::AdWords::v201605::DraftAsyncErrorService::query
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201605::DraftAsyncErrorService::query->new($data);
