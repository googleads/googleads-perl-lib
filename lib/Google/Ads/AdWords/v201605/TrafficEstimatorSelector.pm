package Google::Ads::AdWords::v201605::TrafficEstimatorSelector;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'campaignEstimateRequests' => 'Google::Ads::AdWords::v201605::CampaignEstimateRequest',
...
Google::Ads::AdWords::v201605::TrafficEstimatorSelector

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
TrafficEstimatorSelector from the namespace https://adwords.google.com/api/adwords/o/v201605.
