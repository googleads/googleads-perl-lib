...
package Google::Ads::AdWords::v201605::FeedItemService::query;
use strict;
use warnings;
...
Google::Ads::AdWords::v201605::FeedItemService::query
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201605::FeedItemService::query->new($data);
