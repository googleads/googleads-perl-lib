package Google::Ads::AdWords::v201605::DimensionProperties;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201605::DataEntry);
# Variety: sequence
...
Google::Ads::AdWords::v201605::DimensionProperties

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
DimensionProperties from the namespace https://adwords.google.com/api/adwords/cm/v201605.
