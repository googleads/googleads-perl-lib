...
package Google::Ads::AdWords::v201605::ReportDefinitionService::getReportFields;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'reportType' => 'Google::Ads::AdWords::v201605::ReportDefinition::ReportType',
    },
    {
...
Google::Ads::AdWords::v201605::ReportDefinitionService::getReportFields

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
getReportFields from the namespace https://adwords.google.com/api/adwords/cm/v201605.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201605::ReportDefinitionService::getReportFields->new($data);
