package Google::Ads::AdWords::v201605::TargetOutrankShareBiddingScheme;
use strict;
use warnings;
...
Google::Ads::AdWords::v201605::TargetOutrankShareBiddingScheme

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
TargetOutrankShareBiddingScheme from the namespace https://adwords.google.com/api/adwords/cm/v201605.
