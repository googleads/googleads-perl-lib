package Google::Ads::AdWords::v201605::UserListConversionType::Category;
use strict;
use warnings;
...
UserListConversionType.Category from the namespace https://adwords.google.com/api/adwords/rm/v201605.
