package Google::Ads::AdWords::v201605::LinkOperation;
use strict;
use warnings;
...
Google::Ads::AdWords::v201605::LinkOperation

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
LinkOperation from the namespace https://adwords.google.com/api/adwords/mcm/v201605.
