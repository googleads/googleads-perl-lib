package Google::Ads::AdWords::v201605::VanityPharma;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'vanityPharmaDisplayUrlMode' => 'Google::Ads::AdWords::v201605::VanityPharmaDisplayUrlMode',
        'vanityPharmaText' => 'Google::Ads::AdWords::v201605::VanityPharmaText',
    },
    {
...
Google::Ads::AdWords::v201605::VanityPharma

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
VanityPharma from the namespace https://adwords.google.com/api/adwords/cm/v201605.
