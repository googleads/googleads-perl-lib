package Google::Ads::AdWords::v201605::PlacesLocationFeedData;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201605::SystemFeedGenerationData);
# Variety: sequence
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'oAuthInfo' => 'Google::Ads::AdWords::v201605::OAuthInfo',
...
Google::Ads::AdWords::v201605::PlacesLocationFeedData

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
PlacesLocationFeedData from the namespace https://adwords.google.com/api/adwords/cm/v201605.
