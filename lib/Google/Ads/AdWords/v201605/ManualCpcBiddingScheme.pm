package Google::Ads::AdWords::v201605::ManualCpcBiddingScheme;
use strict;
use warnings;
...
Google::Ads::AdWords::v201605::ManualCpcBiddingScheme

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ManualCpcBiddingScheme from the namespace https://adwords.google.com/api/adwords/cm/v201605.
