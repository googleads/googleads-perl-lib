package Google::Ads::AdWords::v201605::YouTubeVideo;
use strict;
use warnings;
...
Google::Ads::AdWords::v201605::YouTubeVideo

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
YouTubeVideo from the namespace https://adwords.google.com/api/adwords/cm/v201605.
