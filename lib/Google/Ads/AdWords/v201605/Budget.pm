package Google::Ads::AdWords::v201605::Budget;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'amount' => 'Google::Ads::AdWords::v201605::Money',
        'deliveryMethod' => 'Google::Ads::AdWords::v201605::Budget::BudgetDeliveryMethod',
        'referenceCount' => 'SOAP::WSDL::XSD::Typelib::Builtin::int',
        'isExplicitlyShared' => 'SOAP::WSDL::XSD::Typelib::Builtin::boolean',
        'status' => 'Google::Ads::AdWords::v201605::Budget::BudgetStatus',
    },
    {
...
Google::Ads::AdWords::v201605::Budget

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
Budget from the namespace https://adwords.google.com/api/adwords/cm/v201605.
