package Google::Ads::AdWords::v201605::ProductLegacyCondition;
use strict;
use warnings;
...
Google::Ads::AdWords::v201605::ProductLegacyCondition

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ProductLegacyCondition from the namespace https://adwords.google.com/api/adwords/cm/v201605.
