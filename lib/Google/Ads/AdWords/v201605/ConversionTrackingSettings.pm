package Google::Ads::AdWords::v201605::ConversionTrackingSettings;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'conversionOptimizerMode' => 'Google::Ads::AdWords::v201605::ConversionDeduplicationMode',
...
Google::Ads::AdWords::v201605::ConversionTrackingSettings

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ConversionTrackingSettings from the namespace https://adwords.google.com/api/adwords/mcm/v201605.
