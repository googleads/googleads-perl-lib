package Google::Ads::AdWords::v201605::WebpageCondition;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'operand' => 'Google::Ads::AdWords::v201605::WebpageConditionOperand',
...
Google::Ads::AdWords::v201605::WebpageCondition

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
WebpageCondition from the namespace https://adwords.google.com/api/adwords/cm/v201605.
