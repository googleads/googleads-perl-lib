package Google::Ads::AdWords::v201605::GeoPoint;
use strict;
use warnings;
...
Google::Ads::AdWords::v201605::GeoPoint

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
GeoPoint from the namespace https://adwords.google.com/api/adwords/cm/v201605.
