package Google::Ads::AdWords::v201605::DynamicSearchAdsSetting;
use strict;
use warnings;
...
Google::Ads::AdWords::v201605::DynamicSearchAdsSetting

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
DynamicSearchAdsSetting from the namespace https://adwords.google.com/api/adwords/cm/v201605.
