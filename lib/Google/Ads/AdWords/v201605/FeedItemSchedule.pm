package Google::Ads::AdWords::v201605::FeedItemSchedule;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'dayOfWeek' => 'Google::Ads::AdWords::v201605::DayOfWeek',
        'startHour' => 'SOAP::WSDL::XSD::Typelib::Builtin::int',
        'startMinute' => 'Google::Ads::AdWords::v201605::MinuteOfHour',
        'endHour' => 'SOAP::WSDL::XSD::Typelib::Builtin::int',
        'endMinute' => 'Google::Ads::AdWords::v201605::MinuteOfHour',
    },
    {
...
Google::Ads::AdWords::v201605::FeedItemSchedule

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
FeedItemSchedule from the namespace https://adwords.google.com/api/adwords/cm/v201605.
