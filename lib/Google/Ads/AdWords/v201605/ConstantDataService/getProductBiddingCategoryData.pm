...
package Google::Ads::AdWords::v201605::ConstantDataService::getProductBiddingCategoryData;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'selector' => 'Google::Ads::AdWords::v201605::Selector',
    },
    {
...
Google::Ads::AdWords::v201605::ConstantDataService::getProductBiddingCategoryData

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
getProductBiddingCategoryData from the namespace https://adwords.google.com/api/adwords/cm/v201605.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201605::ConstantDataService::getProductBiddingCategoryData->new($data);
