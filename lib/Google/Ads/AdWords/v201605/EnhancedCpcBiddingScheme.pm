package Google::Ads::AdWords::v201605::EnhancedCpcBiddingScheme;
use strict;
use warnings;
...
Google::Ads::AdWords::v201605::EnhancedCpcBiddingScheme

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
EnhancedCpcBiddingScheme from the namespace https://adwords.google.com/api/adwords/cm/v201605.
