package Google::Ads::AdWords::v201605::DataService::DataServiceInterfacePort;
use strict;
use warnings;
...
require Google::Ads::AdWords::v201605::TypeMaps::DataService
    if not Google::Ads::AdWords::v201605::TypeMaps::DataService->can('get_class');

sub START {
    $_[0]->set_proxy('https://adwords.google.com/api/adwords/cm/v201605/DataService') if not $_[2]->{proxy};
    $_[0]->set_class_resolver('Google::Ads::AdWords::v201605::TypeMaps::DataService')
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            ...
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201605::DataService::getAdGroupBidLandscape )],
        },
        header => {
           ...
           'use' => 'literal',
            namespace => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle => '',
            parts => [qw( Google::Ads::AdWords::v201605::DataService::RequestHeader )],
        },
        headerfault => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201605::DataService::getCampaignCriterionBidLandscape )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201605::DataService::getCriterionBidLandscape )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201605::DataService::getDomainCategory )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201605::DataService::queryAdGroupBidLandscape )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201605::DataService::queryCampaignCriterionBidLandscape )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201605::DataService::queryCriterionBidLandscape )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201605::DataService::queryDomainCategory )],
        },
        header => {
...
Google::Ads::AdWords::v201605::DataService::DataServiceInterfacePort - SOAP Interface for the DataService Web Service

=head1 SYNOPSIS

 use Google::Ads::AdWords::v201605::DataService::DataServiceInterfacePort;
 my $interface = Google::Ads::AdWords::v201605::DataService::DataServiceInterfacePort->new();
...
located at https://adwords.google.com/api/adwords/cm/v201605/DataService.
...
Returns a L<Google::Ads::AdWords::v201605::DataService::getAdGroupBidLandscapeResponse|Google::Ads::AdWords::v201605::DataService::getAdGroupBidLandscapeResponse> object.

 $response = $interface->getAdGroupBidLandscape( {
    serviceSelector =>  $a_reference_to, # see Google::Ads::AdWords::v201605::Selector
  },,
 );
...
Returns a L<Google::Ads::AdWords::v201605::DataService::getCampaignCriterionBidLandscapeResponse|Google::Ads::AdWords::v201605::DataService::getCampaignCriterionBidLandscapeResponse> object.
...
Returns a L<Google::Ads::AdWords::v201605::DataService::getCriterionBidLandscapeResponse|Google::Ads::AdWords::v201605::DataService::getCriterionBidLandscapeResponse> object.
...
Returns a L<Google::Ads::AdWords::v201605::DataService::getDomainCategoryResponse|Google::Ads::AdWords::v201605::DataService::getDomainCategoryResponse> object.
...
Returns a L<Google::Ads::AdWords::v201605::DataService::queryAdGroupBidLandscapeResponse|Google::Ads::AdWords::v201605::DataService::queryAdGroupBidLandscapeResponse> object.
...
Returns a L<Google::Ads::AdWords::v201605::DataService::queryCampaignCriterionBidLandscapeResponse|Google::Ads::AdWords::v201605::DataService::queryCampaignCriterionBidLandscapeResponse> object.
...
Returns a L<Google::Ads::AdWords::v201605::DataService::queryCriterionBidLandscapeResponse|Google::Ads::AdWords::v201605::DataService::queryCriterionBidLandscapeResponse> object.
...
Returns a L<Google::Ads::AdWords::v201605::DataService::queryDomainCategoryResponse|Google::Ads::AdWords::v201605::DataService::queryDomainCategoryResponse> object.
...
Generated by SOAP::WSDL on Wed May 25 14:39:25 2016
