...
package Google::Ads::AdWords::v201605::DataService::queryCampaignCriterionBidLandscape;
use strict;
use warnings;
...
Google::Ads::AdWords::v201605::DataService::queryCampaignCriterionBidLandscape

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
queryCampaignCriterionBidLandscape from the namespace https://adwords.google.com/api/adwords/cm/v201605.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201605::DataService::queryCampaignCriterionBidLandscape->new($data);
