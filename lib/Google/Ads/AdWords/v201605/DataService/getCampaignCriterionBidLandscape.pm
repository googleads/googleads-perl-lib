...
package Google::Ads::AdWords::v201605::DataService::getCampaignCriterionBidLandscape;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'serviceSelector' => 'Google::Ads::AdWords::v201605::Selector',
    },
    {
...
Google::Ads::AdWords::v201605::DataService::getCampaignCriterionBidLandscape

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
getCampaignCriterionBidLandscape from the namespace https://adwords.google.com/api/adwords/cm/v201605.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201605::DataService::getCampaignCriterionBidLandscape->new($data);
