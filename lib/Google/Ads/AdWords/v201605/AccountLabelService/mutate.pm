...
package Google::Ads::AdWords::v201605::AccountLabelService::mutate;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'operations' => 'Google::Ads::AdWords::v201605::AccountLabelOperation',
    },
    {
...
Google::Ads::AdWords::v201605::AccountLabelService::mutate
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201605::AccountLabelService::mutate->new($data);

Constructor. The following data structure may be passed to new():

 {
   operations =>  $a_reference_to, # see Google::Ads::AdWords::v201605::AccountLabelOperation
 },
