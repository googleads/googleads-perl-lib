...
package Google::Ads::AdWords::v201605::AdwordsUserListService::mutateMembers;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'operations' => 'Google::Ads::AdWords::v201605::MutateMembersOperation',
    },
    {
...
Google::Ads::AdWords::v201605::AdwordsUserListService::mutateMembers

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
mutateMembers from the namespace https://adwords.google.com/api/adwords/rm/v201605.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201605::AdwordsUserListService::mutateMembers->new($data);
