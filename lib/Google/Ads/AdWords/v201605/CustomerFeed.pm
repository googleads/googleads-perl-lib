package Google::Ads::AdWords::v201605::CustomerFeed;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'matchingFunction' => 'Google::Ads::AdWords::v201605::Function',
        'placeholderTypes' => 'SOAP::WSDL::XSD::Typelib::Builtin::int',
        'status' => 'Google::Ads::AdWords::v201605::CustomerFeed::Status',
    },
    {
...
Google::Ads::AdWords::v201605::CustomerFeed

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CustomerFeed from the namespace https://adwords.google.com/api/adwords/cm/v201605.
