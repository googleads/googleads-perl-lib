package Google::Ads::AdWords::v201605::ExpandedTextAd;
use strict;
use warnings;
...
Google::Ads::AdWords::v201605::ExpandedTextAd

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ExpandedTextAd from the namespace https://adwords.google.com/api/adwords/cm/v201605.
