...
package Google::Ads::AdWords::v201605::MediaService::upload;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'media' => 'Google::Ads::AdWords::v201605::Media',
    },
    {
...
Google::Ads::AdWords::v201605::MediaService::upload

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
upload from the namespace https://adwords.google.com/api/adwords/cm/v201605.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201605::MediaService::upload->new($data);
