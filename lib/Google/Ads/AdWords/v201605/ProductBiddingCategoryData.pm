package Google::Ads::AdWords::v201605::ProductBiddingCategoryData;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201605::ConstantData);
# Variety: sequence
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'dimensionValue' => 'Google::Ads::AdWords::v201605::ProductBiddingCategory',
        'parentDimensionValue' => 'Google::Ads::AdWords::v201605::ProductBiddingCategory',
        'country' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'status' => 'Google::Ads::AdWords::v201605::ShoppingBiddingDimensionStatus',
        'displayValue' => 'Google::Ads::AdWords::v201605::String_StringMapEntry',
    },
    {
...
Google::Ads::AdWords::v201605::ProductBiddingCategoryData

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ProductBiddingCategoryData from the namespace https://adwords.google.com/api/adwords/cm/v201605.
