package Google::Ads::AdWords::v201605::DateSpecificRuleUserList;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201605::RuleBasedUserList);
# Variety: sequence
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'rule' => 'Google::Ads::AdWords::v201605::Rule',
...
Google::Ads::AdWords::v201605::DateSpecificRuleUserList

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
DateSpecificRuleUserList from the namespace https://adwords.google.com/api/adwords/rm/v201605.
