...
package Google::Ads::AdWords::v201603::AdwordsUserListService::query;
use strict;
use warnings;
...
Google::Ads::AdWords::v201603::AdwordsUserListService::query

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
query from the namespace https://adwords.google.com/api/adwords/rm/v201603.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201603::AdwordsUserListService::query->new($data);
