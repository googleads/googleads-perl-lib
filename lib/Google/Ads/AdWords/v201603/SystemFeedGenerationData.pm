package Google::Ads::AdWords::v201603::SystemFeedGenerationData;
use strict;
use warnings;
...
Google::Ads::AdWords::v201603::SystemFeedGenerationData

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
SystemFeedGenerationData from the namespace https://adwords.google.com/api/adwords/cm/v201603.
