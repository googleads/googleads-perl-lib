...
package Google::Ads::AdWords::v201603::ManagedCustomerService::mutateLabel;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'operations' => 'Google::Ads::AdWords::v201603::ManagedCustomerLabelOperation',
    },
    {
...
Google::Ads::AdWords::v201603::ManagedCustomerService::mutateLabel

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
mutateLabel from the namespace https://adwords.google.com/api/adwords/mcm/v201603.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201603::ManagedCustomerService::mutateLabel->new($data);
