package Google::Ads::AdWords::v201603::FeedItemSchedule;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'dayOfWeek' => 'Google::Ads::AdWords::v201603::DayOfWeek',
        'startHour' => 'SOAP::WSDL::XSD::Typelib::Builtin::int',
        'startMinute' => 'Google::Ads::AdWords::v201603::MinuteOfHour',
        'endHour' => 'SOAP::WSDL::XSD::Typelib::Builtin::int',
        'endMinute' => 'Google::Ads::AdWords::v201603::MinuteOfHour',
    },
    {
...
Google::Ads::AdWords::v201603::FeedItemSchedule

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
FeedItemSchedule from the namespace https://adwords.google.com/api/adwords/cm/v201603.
