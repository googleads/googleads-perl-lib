package Google::Ads::AdWords::v201603::DraftAsyncError;
use strict;
use warnings;
...
Google::Ads::AdWords::v201603::DraftAsyncError

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
DraftAsyncError from the namespace https://adwords.google.com/api/adwords/cm/v201603.
