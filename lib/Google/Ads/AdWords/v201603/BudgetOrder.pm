package Google::Ads::AdWords::v201603::BudgetOrder;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'spendingLimit' => 'Google::Ads::AdWords::v201603::Money',
        'startDateTime' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'endDateTime' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'lastRequest' => 'Google::Ads::AdWords::v201603::BudgetOrderRequest',
    },
    {
...
Google::Ads::AdWords::v201603::BudgetOrder

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
BudgetOrder from the namespace https://adwords.google.com/api/adwords/billing/v201603.
