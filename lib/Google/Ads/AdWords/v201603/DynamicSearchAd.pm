package Google::Ads::AdWords::v201603::DynamicSearchAd;
use strict;
use warnings;
...
Google::Ads::AdWords::v201603::DynamicSearchAd

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
DynamicSearchAd from the namespace https://adwords.google.com/api/adwords/cm/v201603.
