package Google::Ads::AdWords::v201603::ProgressStats;
use strict;
use warnings;
...
Google::Ads::AdWords::v201603::ProgressStats

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ProgressStats from the namespace https://adwords.google.com/api/adwords/cm/v201603.
