package Google::Ads::AdWords::v201603::LevelOfDetail;
use strict;
use warnings;
...
Google::Ads::AdWords::v201603::LevelOfDetail

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
LevelOfDetail from the namespace https://adwords.google.com/api/adwords/cm/v201603.
