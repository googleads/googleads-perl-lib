package Google::Ads::AdWords::v201603::RemarketingSettings;
use strict;
use warnings;
...
Google::Ads::AdWords::v201603::RemarketingSettings

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
RemarketingSettings from the namespace https://adwords.google.com/api/adwords/mcm/v201603.
