package Google::Ads::AdWords::v201603::AdGroupCriterionOperation;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201603::Operation);
# Variety: sequence
...
__PACKAGE__->_factory(
    ...
    {
        'operator' => 'Google::Ads::AdWords::v201603::Operator',
        'Operation__Type' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'operand' => 'Google::Ads::AdWords::v201603::AdGroupCriterion',
        'exemptionRequests' => 'Google::Ads::AdWords::v201603::ExemptionRequest',
    },
    {
...
Google::Ads::AdWords::v201603::AdGroupCriterionOperation

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdGroupCriterionOperation from the namespace https://adwords.google.com/api/adwords/cm/v201603.
