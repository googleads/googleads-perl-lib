package Google::Ads::AdWords::v201603::BidLandscape;
use strict;
use warnings;
...
Google::Ads::AdWords::v201603::BidLandscape

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
BidLandscape from the namespace https://adwords.google.com/api/adwords/cm/v201603.
