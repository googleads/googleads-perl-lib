package Google::Ads::AdWords::v201603::EnumValuePair;
use strict;
use warnings;
...
Google::Ads::AdWords::v201603::EnumValuePair

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
EnumValuePair from the namespace https://adwords.google.com/api/adwords/cm/v201603.
