package Google::Ads::AdWords::v201603::BiddingScheme;
use strict;
use warnings;
...
Google::Ads::AdWords::v201603::BiddingScheme

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
BiddingScheme from the namespace https://adwords.google.com/api/adwords/cm/v201603.
