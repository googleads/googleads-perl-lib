package Google::Ads::AdWords::v201603::ProductBiddingCategory;
use strict;
use warnings;
...
Google::Ads::AdWords::v201603::ProductBiddingCategory

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ProductBiddingCategory from the namespace https://adwords.google.com/api/adwords/cm/v201603.
