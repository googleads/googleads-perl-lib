package Google::Ads::AdWords::v201603::NetworkSetting;
use strict;
use warnings;
...
Google::Ads::AdWords::v201603::NetworkSetting

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
NetworkSetting from the namespace https://adwords.google.com/api/adwords/cm/v201603.
