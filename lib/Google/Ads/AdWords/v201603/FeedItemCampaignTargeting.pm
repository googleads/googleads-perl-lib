package Google::Ads::AdWords::v201603::FeedItemCampaignTargeting;
use strict;
use warnings;
...
Google::Ads::AdWords::v201603::FeedItemCampaignTargeting

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
FeedItemCampaignTargeting from the namespace https://adwords.google.com/api/adwords/cm/v201603.
