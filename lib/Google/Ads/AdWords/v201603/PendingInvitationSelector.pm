package Google::Ads::AdWords::v201603::PendingInvitationSelector;
use strict;
use warnings;
...
Google::Ads::AdWords::v201603::PendingInvitationSelector

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
PendingInvitationSelector from the namespace https://adwords.google.com/api/adwords/mcm/v201603.
