package Google::Ads::AdWords::v201603::ConversionTracker;
use strict;
use warnings;
...
Google::Ads::AdWords::v201603::ConversionTracker

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ConversionTracker from the namespace https://adwords.google.com/api/adwords/cm/v201603.
