package Google::Ads::AdWords::v201603::CallConversionType;
use strict;
use warnings;
...
Google::Ads::AdWords::v201603::CallConversionType

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CallConversionType from the namespace https://adwords.google.com/api/adwords/cm/v201603.
