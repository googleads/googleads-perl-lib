package Google::Ads::AdWords::v201603::ProductType;
use strict;
use warnings;
...
Google::Ads::AdWords::v201603::ProductType

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ProductType from the namespace https://adwords.google.com/api/adwords/cm/v201603.
