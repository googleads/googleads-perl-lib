package Google::Ads::AdWords::v201603::OfflineConversionFeed;
use strict;
use warnings;
...
Google::Ads::AdWords::v201603::OfflineConversionFeed

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
OfflineConversionFeed from the namespace https://adwords.google.com/api/adwords/cm/v201603.
