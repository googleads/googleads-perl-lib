...
package Google::Ads::AdWords::v201603::DataService::getDomainCategory;
use strict;
use warnings;
...
Google::Ads::AdWords::v201603::DataService::getDomainCategory

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
getDomainCategory from the namespace https://adwords.google.com/api/adwords/cm/v201603.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201603::DataService::getDomainCategory->new($data);
