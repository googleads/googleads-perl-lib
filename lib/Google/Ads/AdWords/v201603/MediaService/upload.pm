...
package Google::Ads::AdWords::v201603::MediaService::upload;
use strict;
use warnings;
...
Google::Ads::AdWords::v201603::MediaService::upload

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
upload from the namespace https://adwords.google.com/api/adwords/cm/v201603.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201603::MediaService::upload->new($data);
