...
package Google::Ads::AdWords::v201603::TrialAsyncErrorService::query;
use strict;
use warnings;
...
Google::Ads::AdWords::v201603::TrialAsyncErrorService::query
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201603::TrialAsyncErrorService::query->new($data);
