package Google::Ads::AdWords::v201603::ExtensionFeedItem;
use strict;
use warnings;
...
Google::Ads::AdWords::v201603::ExtensionFeedItem

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ExtensionFeedItem from the namespace https://adwords.google.com/api/adwords/cm/v201603.
