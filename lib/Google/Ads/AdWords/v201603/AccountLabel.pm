package Google::Ads::AdWords::v201603::AccountLabel;
use strict;
use warnings;
...
Google::Ads::AdWords::v201603::AccountLabel

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AccountLabel from the namespace https://adwords.google.com/api/adwords/mcm/v201603.
