package Google::Ads::AdWords::v201402::CustomerChangeData;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'changedCampaigns' => 'Google::Ads::AdWords::v201402::CampaignChangeData',
        'changedFeeds' => 'Google::Ads::AdWords::v201402::FeedChangeData',
...
Google::Ads::AdWords::v201402::CustomerChangeData

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CustomerChangeData from the namespace https://adwords.google.com/api/adwords/ch/v201402.
