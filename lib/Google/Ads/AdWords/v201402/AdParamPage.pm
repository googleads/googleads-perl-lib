package Google::Ads::AdWords::v201402::AdParamPage;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'entries' => 'Google::Ads::AdWords::v201402::AdParam',
...
Google::Ads::AdWords::v201402::AdParamPage

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdParamPage from the namespace https://adwords.google.com/api/adwords/cm/v201402.
