package Google::Ads::AdWords::v201402::TrafficEstimatorService::TrafficEstimatorServiceInterfacePort;
use strict;
use warnings;
...
require Google::Ads::AdWords::v201402::TypeMaps::TrafficEstimatorService
    if not Google::Ads::AdWords::v201402::TypeMaps::TrafficEstimatorService->can('get_class');

sub START {
    $_[0]->set_proxy('https://adwords.google.com/api/adwords/o/v201402/TrafficEstimatorService') if not $_[2]->{proxy};
    $_[0]->set_class_resolver('Google::Ads::AdWords::v201402::TypeMaps::TrafficEstimatorService')
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            ...
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201402::TrafficEstimatorService::get )],
        },
        header => {
           ...
           'use' => 'literal',
            namespace => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle => '',
            parts => [qw( Google::Ads::AdWords::v201402::TrafficEstimatorService::RequestHeader )],
        },
        headerfault => {
...
located at https://adwords.google.com/api/adwords/o/v201402/TrafficEstimatorService.
...
Returns a L<Google::Ads::AdWords::v201402::TrafficEstimatorService::getResponse|Google::Ads::AdWords::v201402::TrafficEstimatorService::getResponse> object.
