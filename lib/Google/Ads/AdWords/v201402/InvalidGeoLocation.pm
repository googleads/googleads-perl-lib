package Google::Ads::AdWords::v201402::InvalidGeoLocation;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201402::GeoLocation);
# Variety: sequence
...
__PACKAGE__->_factory(
    ...
    {
        'geoPoint' => 'Google::Ads::AdWords::v201402::GeoPoint',
        'address' => 'Google::Ads::AdWords::v201402::Address',
...
Google::Ads::AdWords::v201402::InvalidGeoLocation

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
InvalidGeoLocation from the namespace https://adwords.google.com/api/adwords/cm/v201402.
