package Google::Ads::AdWords::v201402::BiddableAdGroupCriterion;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'userStatus' => 'Google::Ads::AdWords::v201402::UserStatus',
        'systemServingStatus' => 'Google::Ads::AdWords::v201402::SystemServingStatus',
        'approvalStatus' => 'Google::Ads::AdWords::v201402::ApprovalStatus',
        'disapprovalReasons' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'destinationUrl' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'experimentData' => 'Google::Ads::AdWords::v201402::BiddableAdGroupCriterionExperimentData',
        'firstPageCpc' => 'Google::Ads::AdWords::v201402::Bid',
        'topOfPageCpc' => 'Google::Ads::AdWords::v201402::Bid',
        'qualityInfo' => 'Google::Ads::AdWords::v201402::QualityInfo',
...
Google::Ads::AdWords::v201402::BiddableAdGroupCriterion

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
BiddableAdGroupCriterion from the namespace https://adwords.google.com/api/adwords/cm/v201402.
