package Google::Ads::AdWords::v201402::BudgetService::BudgetServiceInterfacePort;
use strict;
use warnings;
...
require Google::Ads::AdWords::v201402::TypeMaps::BudgetService
    if not Google::Ads::AdWords::v201402::TypeMaps::BudgetService->can('get_class');

sub START {
    $_[0]->set_proxy('https://adwords.google.com/api/adwords/cm/v201402/BudgetService') if not $_[2]->{proxy};
    $_[0]->set_class_resolver('Google::Ads::AdWords::v201402::TypeMaps::BudgetService')
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            ...
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201402::BudgetService::get )],
        },
        header => {
           ...
           'use' => 'literal',
            namespace => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle => '',
            parts => [qw( Google::Ads::AdWords::v201402::BudgetService::RequestHeader )],
        },
        headerfault => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201402::BudgetService::mutate )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201402::BudgetService::query )],
        },
        header => {
...
located at https://adwords.google.com/api/adwords/cm/v201402/BudgetService.
...
Returns a L<Google::Ads::AdWords::v201402::BudgetService::getResponse|Google::Ads::AdWords::v201402::BudgetService::getResponse> object.
...
Returns a L<Google::Ads::AdWords::v201402::BudgetService::mutateResponse|Google::Ads::AdWords::v201402::BudgetService::mutateResponse> object.
...
Returns a L<Google::Ads::AdWords::v201402::BudgetService::queryResponse|Google::Ads::AdWords::v201402::BudgetService::queryResponse> object.
