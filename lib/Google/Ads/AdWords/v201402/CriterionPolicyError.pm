package Google::Ads::AdWords::v201402::CriterionPolicyError;
use strict;
use warnings;
...
Google::Ads::AdWords::v201402::CriterionPolicyError

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CriterionPolicyError from the namespace https://adwords.google.com/api/adwords/cm/v201402.
