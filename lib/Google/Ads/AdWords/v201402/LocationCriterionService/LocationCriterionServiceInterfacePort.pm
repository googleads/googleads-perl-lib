package Google::Ads::AdWords::v201402::LocationCriterionService::LocationCriterionServiceInterfacePort;
use strict;
use warnings;
...
require Google::Ads::AdWords::v201402::TypeMaps::LocationCriterionService
    if not Google::Ads::AdWords::v201402::TypeMaps::LocationCriterionService->can('get_class');

sub START {
    $_[0]->set_proxy('https://adwords.google.com/api/adwords/cm/v201402/LocationCriterionService') if not $_[2]->{proxy};
    $_[0]->set_class_resolver('Google::Ads::AdWords::v201402::TypeMaps::LocationCriterionService')
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            ...
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201402::LocationCriterionService::get )],
        },
        header => {
           ...
           'use' => 'literal',
            namespace => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle => '',
            parts => [qw( Google::Ads::AdWords::v201402::LocationCriterionService::RequestHeader )],
        },
        headerfault => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201402::LocationCriterionService::query )],
        },
        header => {
...
located at https://adwords.google.com/api/adwords/cm/v201402/LocationCriterionService.
...
Returns a L<Google::Ads::AdWords::v201402::LocationCriterionService::getResponse|Google::Ads::AdWords::v201402::LocationCriterionService::getResponse> object.
...
Returns a L<Google::Ads::AdWords::v201402::LocationCriterionService::queryResponse|Google::Ads::AdWords::v201402::LocationCriterionService::queryResponse> object.
