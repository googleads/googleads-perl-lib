package Google::Ads::AdWords::v201402::RelatedToUrlSearchParameter;
use strict;
use warnings;
...
RelatedToUrlSearchParameter from the namespace https://adwords.google.com/api/adwords/o/v201402.
