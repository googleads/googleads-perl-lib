...
package Google::Ads::AdWords::v201402::AdGroupService::query;
use strict;
use warnings;
...
Google::Ads::AdWords::v201402::AdGroupService::query
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201402::AdGroupService::query->new($data);
