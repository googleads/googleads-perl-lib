package Google::Ads::AdWords::v201402::CampaignService::CampaignServiceInterfacePort;
use strict;
use warnings;
...
require Google::Ads::AdWords::v201402::TypeMaps::CampaignService
    if not Google::Ads::AdWords::v201402::TypeMaps::CampaignService->can('get_class');

sub START {
    $_[0]->set_proxy('https://adwords.google.com/api/adwords/cm/v201402/CampaignService') if not $_[2]->{proxy};
    $_[0]->set_class_resolver('Google::Ads::AdWords::v201402::TypeMaps::CampaignService')
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            ...
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201402::CampaignService::get )],
        },
        header => {
           ...
           'use' => 'literal',
            namespace => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle => '',
            parts => [qw( Google::Ads::AdWords::v201402::CampaignService::RequestHeader )],
        },
        headerfault => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201402::CampaignService::mutate )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201402::CampaignService::query )],
        },
        header => {
...
located at https://adwords.google.com/api/adwords/cm/v201402/CampaignService.
...
Returns a L<Google::Ads::AdWords::v201402::CampaignService::getResponse|Google::Ads::AdWords::v201402::CampaignService::getResponse> object.
...
Returns a L<Google::Ads::AdWords::v201402::CampaignService::mutateResponse|Google::Ads::AdWords::v201402::CampaignService::mutateResponse> object.
...
Returns a L<Google::Ads::AdWords::v201402::CampaignService::queryResponse|Google::Ads::AdWords::v201402::CampaignService::queryResponse> object.
...
Generated by SOAP::WSDL on Thu Jul 31 11:57:00 2014
