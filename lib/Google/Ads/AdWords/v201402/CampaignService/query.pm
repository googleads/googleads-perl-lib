...
package Google::Ads::AdWords::v201402::CampaignService::query;
use strict;
use warnings;
...
Google::Ads::AdWords::v201402::CampaignService::query
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201402::CampaignService::query->new($data);
