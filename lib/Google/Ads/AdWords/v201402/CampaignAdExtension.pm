package Google::Ads::AdWords::v201402::CampaignAdExtension;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'status' => 'Google::Ads::AdWords::v201402::CampaignAdExtension::Status',
        'approvalStatus' => 'Google::Ads::AdWords::v201402::CampaignAdExtension::ApprovalStatus',
    },
    {
...
Google::Ads::AdWords::v201402::CampaignAdExtension

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CampaignAdExtension from the namespace https://adwords.google.com/api/adwords/cm/v201402.
