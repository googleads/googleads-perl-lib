...
package Google::Ads::AdWords::v201402::ManagedCustomerService::getPendingInvitations;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'selector' => 'Google::Ads::AdWords::v201402::PendingInvitationSelector',
    },
    {
...
Google::Ads::AdWords::v201402::ManagedCustomerService::getPendingInvitations

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
getPendingInvitations from the namespace https://adwords.google.com/api/adwords/mcm/v201402.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201402::ManagedCustomerService::getPendingInvitations->new($data);
