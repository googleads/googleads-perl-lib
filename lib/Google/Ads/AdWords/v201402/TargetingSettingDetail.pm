package Google::Ads::AdWords::v201402::TargetingSettingDetail;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'criterionTypeGroup' => 'Google::Ads::AdWords::v201402::CriterionTypeGroup',
...
Google::Ads::AdWords::v201402::TargetingSettingDetail

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
TargetingSettingDetail from the namespace https://adwords.google.com/api/adwords/cm/v201402.
