package Google::Ads::AdWords::v201402::AdSpec;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'DisplayAdSpec' => 'Google::Ads::AdWords::v201402::DisplayAdSpec',
        'InStreamAdSpec' => 'Google::Ads::AdWords::v201402::InStreamAdSpec',
        'TextAdSpec' => 'Google::Ads::AdWords::v201402::TextAdSpec',
    },
    {
...
Google::Ads::AdWords::v201402::AdSpec

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdSpec from the namespace https://adwords.google.com/api/adwords/o/v201402.
