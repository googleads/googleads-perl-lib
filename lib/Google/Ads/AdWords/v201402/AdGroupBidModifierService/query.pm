...
package Google::Ads::AdWords::v201402::AdGroupBidModifierService::query;
use strict;
use warnings;
...
Google::Ads::AdWords::v201402::AdGroupBidModifierService::query
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201402::AdGroupBidModifierService::query->new($data);
