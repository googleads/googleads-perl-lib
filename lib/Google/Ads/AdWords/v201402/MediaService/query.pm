...
package Google::Ads::AdWords::v201402::MediaService::query;
use strict;
use warnings;
...
Google::Ads::AdWords::v201402::MediaService::query
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201402::MediaService::query->new($data);
