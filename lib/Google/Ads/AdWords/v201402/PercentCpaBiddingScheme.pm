package Google::Ads::AdWords::v201402::PercentCpaBiddingScheme;
use strict;
use warnings;
...
Google::Ads::AdWords::v201402::PercentCpaBiddingScheme

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
PercentCpaBiddingScheme from the namespace https://adwords.google.com/api/adwords/cm/v201402.
