package Google::Ads::AdWords::v201402::BiddingStrategyService::BiddingStrategyServiceInterfacePort;
use strict;
use warnings;
...
require Google::Ads::AdWords::v201402::TypeMaps::BiddingStrategyService
    if not Google::Ads::AdWords::v201402::TypeMaps::BiddingStrategyService->can('get_class');

sub START {
    $_[0]->set_proxy('https://adwords.google.com/api/adwords/cm/v201402/BiddingStrategyService') if not $_[2]->{proxy};
    $_[0]->set_class_resolver('Google::Ads::AdWords::v201402::TypeMaps::BiddingStrategyService')
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            ...
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201402::BiddingStrategyService::get )],
        },
        header => {
           ...
           'use' => 'literal',
            namespace => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle => '',
            parts => [qw( Google::Ads::AdWords::v201402::BiddingStrategyService::RequestHeader )],
        },
        headerfault => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201402::BiddingStrategyService::mutate )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201402::BiddingStrategyService::query )],
        },
        header => {
...
located at https://adwords.google.com/api/adwords/cm/v201402/BiddingStrategyService.
...
Returns a L<Google::Ads::AdWords::v201402::BiddingStrategyService::getResponse|Google::Ads::AdWords::v201402::BiddingStrategyService::getResponse> object.
...
Returns a L<Google::Ads::AdWords::v201402::BiddingStrategyService::mutateResponse|Google::Ads::AdWords::v201402::BiddingStrategyService::mutateResponse> object.
...
Returns a L<Google::Ads::AdWords::v201402::BiddingStrategyService::queryResponse|Google::Ads::AdWords::v201402::BiddingStrategyService::queryResponse> object.
