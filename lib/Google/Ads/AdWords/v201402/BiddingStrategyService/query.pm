...
package Google::Ads::AdWords::v201402::BiddingStrategyService::query;
use strict;
use warnings;
...
Google::Ads::AdWords::v201402::BiddingStrategyService::query
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201402::BiddingStrategyService::query->new($data);
