package Google::Ads::AdWords::v201409::AttributeFieldMapping;
use strict;
use warnings;
...
Google::Ads::AdWords::v201409::AttributeFieldMapping

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AttributeFieldMapping from the namespace https://adwords.google.com/api/adwords/cm/v201409.
