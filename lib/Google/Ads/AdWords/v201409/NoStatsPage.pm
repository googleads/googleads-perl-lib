package Google::Ads::AdWords::v201409::NoStatsPage;
use strict;
use warnings;
...
Google::Ads::AdWords::v201409::NoStatsPage

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
NoStatsPage from the namespace https://adwords.google.com/api/adwords/cm/v201409.
