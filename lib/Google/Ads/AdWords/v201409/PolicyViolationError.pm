package Google::Ads::AdWords::v201409::PolicyViolationError;
use strict;
use warnings;
...
Google::Ads::AdWords::v201409::PolicyViolationError

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
PolicyViolationError from the namespace https://adwords.google.com/api/adwords/cm/v201409.
