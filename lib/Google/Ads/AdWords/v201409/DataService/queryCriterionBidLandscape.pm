...
package Google::Ads::AdWords::v201409::DataService::queryCriterionBidLandscape;
use strict;
use warnings;
...
queryCriterionBidLandscape from the namespace https://adwords.google.com/api/adwords/cm/v201409.
