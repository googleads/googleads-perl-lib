package Google::Ads::AdWords::v201409::DynamicSearchAd;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201409::Ad);
# Variety: sequence
