package Google::Ads::AdWords::v201409::AdGroupAd;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'experimentData' => 'Google::Ads::AdWords::v201409::AdGroupAdExperimentData',
        'status' => 'Google::Ads::AdWords::v201409::AdGroupAd::Status',
        'approvalStatus' => 'Google::Ads::AdWords::v201409::AdGroupAd::ApprovalStatus',
...
Google::Ads::AdWords::v201409::AdGroupAd

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdGroupAd from the namespace https://adwords.google.com/api/adwords/cm/v201409.
