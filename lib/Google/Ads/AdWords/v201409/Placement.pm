package Google::Ads::AdWords::v201409::Placement;
use strict;
use warnings;
...
Google::Ads::AdWords::v201409::Placement

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
Placement from the namespace https://adwords.google.com/api/adwords/cm/v201409.
