package Google::Ads::AdWords::v201409::ApiException;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201409::ApplicationException);
# Variety: sequence
...
ApiException from the namespace https://adwords.google.com/api/adwords/cm/v201409.
