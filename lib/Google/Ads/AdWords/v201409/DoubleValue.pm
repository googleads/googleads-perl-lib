package Google::Ads::AdWords::v201409::DoubleValue;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201409::NumberValue);
# Variety: sequence
...
Google::Ads::AdWords::v201409::DoubleValue

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
DoubleValue from the namespace https://adwords.google.com/api/adwords/cm/v201409.
