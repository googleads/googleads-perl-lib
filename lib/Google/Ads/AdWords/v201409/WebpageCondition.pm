package Google::Ads::AdWords::v201409::WebpageCondition;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'operand' => 'Google::Ads::AdWords::v201409::WebpageConditionOperand',
...
WebpageCondition from the namespace https://adwords.google.com/api/adwords/cm/v201409.
