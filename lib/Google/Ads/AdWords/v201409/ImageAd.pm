package Google::Ads::AdWords::v201409::ImageAd;
use strict;
use warnings;
...
Google::Ads::AdWords::v201409::ImageAd

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ImageAd from the namespace https://adwords.google.com/api/adwords/cm/v201409.
