...
use base qw(Google::Ads::AdWords::v201409::AdGroupCriterionExperimentBidMultiplier);
# Variety: sequence
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'multiplierSource' => 'Google::Ads::AdWords::v201409::MultiplierSource',
    },
    {
...
Google::Ads::AdWords::v201409::ManualCPCAdGroupCriterionExperimentBidMultiplier

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ManualCPCAdGroupCriterionExperimentBidMultiplier from the namespace https://adwords.google.com/api/adwords/cm/v201409.
