package Google::Ads::AdWords::v201409::AdGroupAdService::AdGroupAdServiceInterfacePort;
use strict;
use warnings;
...
require Google::Ads::AdWords::v201409::TypeMaps::AdGroupAdService
    if not Google::Ads::AdWords::v201409::TypeMaps::AdGroupAdService->can('get_class');

sub START {
    $_[0]->set_proxy('https://adwords.google.com/api/adwords/cm/v201409/AdGroupAdService') if not $_[2]->{proxy};
    $_[0]->set_class_resolver('Google::Ads::AdWords::v201409::TypeMaps::AdGroupAdService')
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            ...
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201409::AdGroupAdService::get )],
        },
        header => {
           ...
           'use' => 'literal',
            namespace => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle => '',
            parts => [qw( Google::Ads::AdWords::v201409::AdGroupAdService::RequestHeader )],
        },
        headerfault => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201409::AdGroupAdService::mutate )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201409::AdGroupAdService::mutateLabel )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201409::AdGroupAdService::query )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201409::AdGroupAdService::upgradeUrl )],
        },
        header => {
...
Google::Ads::AdWords::v201409::AdGroupAdService::AdGroupAdServiceInterfacePort - SOAP Interface for the AdGroupAdService Web Service

=head1 SYNOPSIS

 use Google::Ads::AdWords::v201409::AdGroupAdService::AdGroupAdServiceInterfacePort;
 my $interface = Google::Ads::AdWords::v201409::AdGroupAdService::AdGroupAdServiceInterfacePort->new();
...
located at https://adwords.google.com/api/adwords/cm/v201409/AdGroupAdService.
...
Returns a L<Google::Ads::AdWords::v201409::AdGroupAdService::getResponse|Google::Ads::AdWords::v201409::AdGroupAdService::getResponse> object.

 $response = $interface->get( {
    serviceSelector =>  $a_reference_to, # see Google::Ads::AdWords::v201409::Selector
  },,
 );
...
Returns a L<Google::Ads::AdWords::v201409::AdGroupAdService::mutateResponse|Google::Ads::AdWords::v201409::AdGroupAdService::mutateResponse> object.

 $response = $interface->mutate( {
    operations =>  $a_reference_to, # see Google::Ads::AdWords::v201409::AdGroupAdOperation
  },,
 );

=head3 mutateLabel

Adds labels to the AdGroupAd or removes labels from the AdGroupAd. <p>Add - Apply an existing label to an existing {@linkplain AdGroupAd ad group ad}. The {@code adGroupId} and {@code adId} must reference an existing {@linkplain AdGroupAd ad group ad}. The {@code labelId} must reference an existing {@linkplain com.google.ads.api.services.campaignmgmt.label.Label label}. <p>Remove - Removes the link between the specified {@linkplain AdGroupAd ad group ad} and {@linkplain com.google.ads.api.services.campaignmgmt.label.Label label}.</p> @param operations The operations to apply. @return A list of AdGroupAdLabel where each entry in the list is the result of applying the operation in the input list with the same index. For an add operation, the returned AdGroupAdLabel contains the AdGroupId, AdId and the LabelId. In the case of a remove operation, the returned AdGroupAdLabel will only have AdGroupId and AdId. @throws ApiException when there are one or more errors with the request. 

Returns a L<Google::Ads::AdWords::v201409::AdGroupAdService::mutateLabelResponse|Google::Ads::AdWords::v201409::AdGroupAdService::mutateLabelResponse> object.

 $response = $interface->mutateLabel( {
    operations =>  $a_reference_to, # see Google::Ads::AdWords::v201409::AdGroupAdLabelOperation
  },,
 );
...
Returns a L<Google::Ads::AdWords::v201409::AdGroupAdService::queryResponse|Google::Ads::AdWords::v201409::AdGroupAdService::queryResponse> object.
...
Returns a L<Google::Ads::AdWords::v201409::AdGroupAdService::upgradeUrlResponse|Google::Ads::AdWords::v201409::AdGroupAdService::upgradeUrlResponse> object.

 $response = $interface->upgradeUrl( {
    operations =>  $a_reference_to, # see Google::Ads::AdWords::v201409::AdUrlUpgrade
  },,
 );
...
Generated by SOAP::WSDL on Mon Oct  6 17:18:17 2014
