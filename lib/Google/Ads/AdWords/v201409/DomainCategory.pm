package Google::Ads::AdWords::v201409::DomainCategory;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201409::DimensionProperties);
# Variety: sequence
...
Google::Ads::AdWords::v201409::DomainCategory

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
DomainCategory from the namespace https://adwords.google.com/api/adwords/cm/v201409.
