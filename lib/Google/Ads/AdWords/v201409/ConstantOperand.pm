package Google::Ads::AdWords::v201409::ConstantOperand;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'type' => 'Google::Ads::AdWords::v201409::ConstantOperand::ConstantType',
        'unit' => 'Google::Ads::AdWords::v201409::ConstantOperand::Unit',
...
Google::Ads::AdWords::v201409::ConstantOperand

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ConstantOperand from the namespace https://adwords.google.com/api/adwords/cm/v201409.
