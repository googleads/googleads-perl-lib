package Google::Ads::AdWords::v201409::Media_Size_StringMapEntry;
use strict;
use warnings;
...
Google::Ads::AdWords::v201409::Media_Size_StringMapEntry

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
Media_Size_StringMapEntry from the namespace https://adwords.google.com/api/adwords/cm/v201409.
