package Google::Ads::AdWords::v201409::CustomerExtensionSettingReturnValue;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'value' => 'Google::Ads::AdWords::v201409::CustomerExtensionSetting',
    },
    {
...
Google::Ads::AdWords::v201409::CustomerExtensionSettingReturnValue

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CustomerExtensionSettingReturnValue from the namespace https://adwords.google.com/api/adwords/cm/v201409.
