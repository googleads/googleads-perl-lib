package Google::Ads::AdWords::v201409::GeoTargetOperand;
use strict;
use warnings;
...
Google::Ads::AdWords::v201409::GeoTargetOperand

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
GeoTargetOperand from the namespace https://adwords.google.com/api/adwords/cm/v201409.
