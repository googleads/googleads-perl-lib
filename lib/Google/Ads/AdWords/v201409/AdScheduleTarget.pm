package Google::Ads::AdWords::v201409::AdScheduleTarget;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201409::Target);
# Variety: sequence
...
Google::Ads::AdWords::v201409::AdScheduleTarget

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdScheduleTarget from the namespace https://adwords.google.com/api/adwords/cm/v201409.
