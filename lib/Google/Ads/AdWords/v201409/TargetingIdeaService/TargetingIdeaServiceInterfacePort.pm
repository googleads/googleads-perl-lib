package Google::Ads::AdWords::v201409::TargetingIdeaService::TargetingIdeaServiceInterfacePort;
use strict;
use warnings;
...
require Google::Ads::AdWords::v201409::TypeMaps::TargetingIdeaService
    if not Google::Ads::AdWords::v201409::TypeMaps::TargetingIdeaService->can('get_class');

sub START {
    $_[0]->set_proxy('https://adwords.google.com/api/adwords/o/v201409/TargetingIdeaService') if not $_[2]->{proxy};
    $_[0]->set_class_resolver('Google::Ads::AdWords::v201409::TypeMaps::TargetingIdeaService')
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            ...
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201409::TargetingIdeaService::get )],
        },
        header => {
           ...
           'use' => 'literal',
            namespace => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle => '',
            parts => [qw( Google::Ads::AdWords::v201409::TargetingIdeaService::RequestHeader )],
        },
        headerfault => {
...
located at https://adwords.google.com/api/adwords/o/v201409/TargetingIdeaService.
...
Returns a L<Google::Ads::AdWords::v201409::TargetingIdeaService::getResponse|Google::Ads::AdWords::v201409::TargetingIdeaService::getResponse> object.
...
Generated by SOAP::WSDL on Mon Oct  6 17:20:55 2014
