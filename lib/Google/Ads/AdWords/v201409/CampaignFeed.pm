package Google::Ads::AdWords::v201409::CampaignFeed;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'matchingFunction' => 'Google::Ads::AdWords::v201409::Function',
        'placeholderTypes' => 'SOAP::WSDL::XSD::Typelib::Builtin::int',
        'status' => 'Google::Ads::AdWords::v201409::CampaignFeed::Status',
    },
    {
...
Google::Ads::AdWords::v201409::CampaignFeed

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CampaignFeed from the namespace https://adwords.google.com/api/adwords/cm/v201409.
