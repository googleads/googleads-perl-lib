...
package Google::Ads::AdWords::v201409::ManagedCustomerService::getPendingInvitations;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'selector' => 'Google::Ads::AdWords::v201409::PendingInvitationSelector',
    },
    {
...
getPendingInvitations from the namespace https://adwords.google.com/api/adwords/mcm/v201409.
