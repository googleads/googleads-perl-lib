package Google::Ads::AdWords::v201409::SystemFeedGenerationData;
use strict;
use warnings;
...
Google::Ads::AdWords::v201409::SystemFeedGenerationData

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
SystemFeedGenerationData from the namespace https://adwords.google.com/api/adwords/cm/v201409.
