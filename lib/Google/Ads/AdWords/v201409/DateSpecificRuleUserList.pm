package Google::Ads::AdWords::v201409::DateSpecificRuleUserList;
use strict;
use warnings;
...
sub get_xmlns { 'https://adwords.google.com/api/adwords/rm/v201409' };
...
use base qw(Google::Ads::AdWords::v201409::RuleBasedUserList);
# Variety: sequence
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'status' => 'Google::Ads::AdWords::v201409::UserListMembershipStatus',
        'integrationCode' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'accessReason' => 'Google::Ads::AdWords::v201409::AccessReason',
        'accountUserListStatus' => 'Google::Ads::AdWords::v201409::AccountUserListStatus',
        'membershipLifeSpan' => 'SOAP::WSDL::XSD::Typelib::Builtin::long',
        'size' => 'SOAP::WSDL::XSD::Typelib::Builtin::long',
        'sizeRange' => 'Google::Ads::AdWords::v201409::SizeRange',
        'sizeForSearch' => 'SOAP::WSDL::XSD::Typelib::Builtin::long',
        'sizeRangeForSearch' => 'Google::Ads::AdWords::v201409::SizeRange',
        'listType' => 'Google::Ads::AdWords::v201409::UserListType',
        'UserList__Type' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'rule' => 'Google::Ads::AdWords::v201409::Rule',
...
Google::Ads::AdWords::v201409::DateSpecificRuleUserList

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
DateSpecificRuleUserList from the namespace https://adwords.google.com/api/adwords/rm/v201409.
