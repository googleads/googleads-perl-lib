package Google::Ads::AdWords::v201409::ProductOfferId;
use strict;
use warnings;
...
Google::Ads::AdWords::v201409::ProductOfferId

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ProductOfferId from the namespace https://adwords.google.com/api/adwords/cm/v201409.
