...
package Google::Ads::AdWords::v201601::FeedItemService::query;
use strict;
use warnings;
...
Google::Ads::AdWords::v201601::FeedItemService::query
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201601::FeedItemService::query->new($data);
