package Google::Ads::AdWords::v201601::TargetCpaBiddingScheme;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'targetCpa' => 'Google::Ads::AdWords::v201601::Money',
        'maxCpcBidCeiling' => 'Google::Ads::AdWords::v201601::Money',
        'maxCpcBidFloor' => 'Google::Ads::AdWords::v201601::Money',
    },
    {
...
Google::Ads::AdWords::v201601::TargetCpaBiddingScheme

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
TargetCpaBiddingScheme from the namespace https://adwords.google.com/api/adwords/cm/v201601.

Target Cpa bidding strategy helps you maximize your return on investment (ROI) by automatically getting you the most possible conversions for your budget. This is similar to the <code>ConversionOptimizerBiddingScheme<code> but does not support user-entered AdGroup-level target CPA bids, but rather a strategy-wide average CPA target. <p>Note that campaigns must meet <a href="//support.google.com/adwords/answer/2471188">specific eligibility requirements</a> before they can use the <code>TargetCpaBiddingScheme</code> bidding strategy. <span class="constraint AdxEnabled">This is disabled for AdX.</span> 
