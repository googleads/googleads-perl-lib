...
package Google::Ads::AdWords::v201601::ManagedCustomerService::mutate;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'operations' => 'Google::Ads::AdWords::v201601::ManagedCustomerOperation',
    },
    {
...
Google::Ads::AdWords::v201601::ManagedCustomerService::mutate

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
mutate from the namespace https://adwords.google.com/api/adwords/mcm/v201601.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201601::ManagedCustomerService::mutate->new($data);

Constructor. The following data structure may be passed to new():

 {
   operations =>  $a_reference_to, # see Google::Ads::AdWords::v201601::ManagedCustomerOperation
 },
