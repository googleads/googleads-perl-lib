...
package Google::Ads::AdWords::v201601::CustomerExtensionSettingService::query;
use strict;
use warnings;
...
Google::Ads::AdWords::v201601::CustomerExtensionSettingService::query

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
query from the namespace https://adwords.google.com/api/adwords/cm/v201601.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201601::CustomerExtensionSettingService::query->new($data);
