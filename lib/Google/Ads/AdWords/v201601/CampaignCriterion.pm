package Google::Ads::AdWords::v201601::CampaignCriterion;
use strict;
use warnings;
...
Google::Ads::AdWords::v201601::CampaignCriterion

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CampaignCriterion from the namespace https://adwords.google.com/api/adwords/cm/v201601.
