package Google::Ads::AdWords::v201601::PlacesLocationFeedData;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201601::SystemFeedGenerationData);
# Variety: sequence
...
Google::Ads::AdWords::v201601::PlacesLocationFeedData

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
PlacesLocationFeedData from the namespace https://adwords.google.com/api/adwords/cm/v201601.
