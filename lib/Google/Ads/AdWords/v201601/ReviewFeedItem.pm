package Google::Ads::AdWords::v201601::ReviewFeedItem;
use strict;
use warnings;
...
Google::Ads::AdWords::v201601::ReviewFeedItem

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ReviewFeedItem from the namespace https://adwords.google.com/api/adwords/cm/v201601.
