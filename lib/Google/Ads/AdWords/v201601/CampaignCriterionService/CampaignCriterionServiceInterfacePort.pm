package Google::Ads::AdWords::v201601::CampaignCriterionService::CampaignCriterionServiceInterfacePort;
use strict;
use warnings;
...
require Google::Ads::AdWords::v201601::TypeMaps::CampaignCriterionService
    if not Google::Ads::AdWords::v201601::TypeMaps::CampaignCriterionService->can('get_class');

sub START {
    $_[0]->set_proxy('https://adwords.google.com/api/adwords/cm/v201601/CampaignCriterionService') if not $_[2]->{proxy};
    $_[0]->set_class_resolver('Google::Ads::AdWords::v201601::TypeMaps::CampaignCriterionService')
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            ...
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201601::CampaignCriterionService::get )],
        },
        header => {
           ...
           'use' => 'literal',
            namespace => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle => '',
            parts => [qw( Google::Ads::AdWords::v201601::CampaignCriterionService::RequestHeader )],
        },
        headerfault => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201601::CampaignCriterionService::mutate )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201601::CampaignCriterionService::query )],
        },
        header => {
...
located at https://adwords.google.com/api/adwords/cm/v201601/CampaignCriterionService.
...
Returns a L<Google::Ads::AdWords::v201601::CampaignCriterionService::getResponse|Google::Ads::AdWords::v201601::CampaignCriterionService::getResponse> object.
...
Returns a L<Google::Ads::AdWords::v201601::CampaignCriterionService::mutateResponse|Google::Ads::AdWords::v201601::CampaignCriterionService::mutateResponse> object.
...
Returns a L<Google::Ads::AdWords::v201601::CampaignCriterionService::queryResponse|Google::Ads::AdWords::v201601::CampaignCriterionService::queryResponse> object.
