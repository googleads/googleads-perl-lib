package Google::Ads::AdWords::v201601::AppUrlList;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'appUrls' => 'Google::Ads::AdWords::v201601::AppUrl',
    },
    {
...
Google::Ads::AdWords::v201601::AppUrlList

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AppUrlList from the namespace https://adwords.google.com/api/adwords/cm/v201601.
