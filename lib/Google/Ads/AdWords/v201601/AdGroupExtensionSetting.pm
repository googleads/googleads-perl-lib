package Google::Ads::AdWords::v201601::AdGroupExtensionSetting;
use strict;
use warnings;
...
Google::Ads::AdWords::v201601::AdGroupExtensionSetting

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdGroupExtensionSetting from the namespace https://adwords.google.com/api/adwords/cm/v201601.
