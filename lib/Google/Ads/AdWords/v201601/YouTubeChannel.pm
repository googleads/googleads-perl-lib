package Google::Ads::AdWords::v201601::YouTubeChannel;
use strict;
use warnings;
...
Google::Ads::AdWords::v201601::YouTubeChannel

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
YouTubeChannel from the namespace https://adwords.google.com/api/adwords/cm/v201601.
