package Google::Ads::AdWords::v201601::ProductPartition;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'partitionType' => 'Google::Ads::AdWords::v201601::ProductPartitionType',
        'parentCriterionId' => 'SOAP::WSDL::XSD::Typelib::Builtin::long',
        'caseValue' => 'Google::Ads::AdWords::v201601::ProductDimension',
    },
    {
...
Google::Ads::AdWords::v201601::ProductPartition

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ProductPartition from the namespace https://adwords.google.com/api/adwords/cm/v201601.
