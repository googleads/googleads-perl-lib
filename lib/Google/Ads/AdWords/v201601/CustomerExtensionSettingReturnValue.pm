package Google::Ads::AdWords::v201601::CustomerExtensionSettingReturnValue;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'value' => 'Google::Ads::AdWords::v201601::CustomerExtensionSetting',
    },
    {
...
Google::Ads::AdWords::v201601::CustomerExtensionSettingReturnValue

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CustomerExtensionSettingReturnValue from the namespace https://adwords.google.com/api/adwords/cm/v201601.
