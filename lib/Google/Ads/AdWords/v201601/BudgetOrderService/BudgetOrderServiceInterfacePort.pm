package Google::Ads::AdWords::v201601::BudgetOrderService::BudgetOrderServiceInterfacePort;
use strict;
use warnings;
...
require Google::Ads::AdWords::v201601::TypeMaps::BudgetOrderService
    if not Google::Ads::AdWords::v201601::TypeMaps::BudgetOrderService->can('get_class');

sub START {
    $_[0]->set_proxy('https://adwords.google.com/api/adwords/billing/v201601/BudgetOrderService') if not $_[2]->{proxy};
    $_[0]->set_class_resolver('Google::Ads::AdWords::v201601::TypeMaps::BudgetOrderService')
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            ...
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201601::BudgetOrderService::get )],
        },
        header => {
           ...
           'use' => 'literal',
            namespace => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle => '',
            parts => [qw( Google::Ads::AdWords::v201601::BudgetOrderService::RequestHeader )],
        },
        headerfault => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201601::BudgetOrderService::getBillingAccounts )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201601::BudgetOrderService::mutate )],
        },
        header => {
...
located at https://adwords.google.com/api/adwords/billing/v201601/BudgetOrderService.
...
Returns a L<Google::Ads::AdWords::v201601::BudgetOrderService::getResponse|Google::Ads::AdWords::v201601::BudgetOrderService::getResponse> object.
...
Returns a L<Google::Ads::AdWords::v201601::BudgetOrderService::getBillingAccountsResponse|Google::Ads::AdWords::v201601::BudgetOrderService::getBillingAccountsResponse> object.
...
Returns a L<Google::Ads::AdWords::v201601::BudgetOrderService::mutateResponse|Google::Ads::AdWords::v201601::BudgetOrderService::mutateResponse> object.
