package Google::Ads::AdWords::v201601::AdGroupCriterion;
use strict;
use warnings;
...
Google::Ads::AdWords::v201601::AdGroupCriterion

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdGroupCriterion from the namespace https://adwords.google.com/api/adwords/cm/v201601.
