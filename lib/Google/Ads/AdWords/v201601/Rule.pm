package Google::Ads::AdWords::v201601::Rule;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'groups' => 'Google::Ads::AdWords::v201601::RuleItemGroup',
    },
    {
...
Google::Ads::AdWords::v201601::Rule

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
Rule from the namespace https://adwords.google.com/api/adwords/rm/v201601.
