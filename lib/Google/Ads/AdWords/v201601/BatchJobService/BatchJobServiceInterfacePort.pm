package Google::Ads::AdWords::v201601::BatchJobService::BatchJobServiceInterfacePort;
use strict;
use warnings;
...
require Google::Ads::AdWords::v201601::TypeMaps::BatchJobService
    if not Google::Ads::AdWords::v201601::TypeMaps::BatchJobService->can('get_class');

sub START {
    $_[0]->set_proxy('https://adwords.google.com/api/adwords/cm/v201601/BatchJobService') if not $_[2]->{proxy};
    $_[0]->set_class_resolver('Google::Ads::AdWords::v201601::TypeMaps::BatchJobService')
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            ...
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201601::BatchJobService::get )],
        },
        header => {
           ...
           'use' => 'literal',
            namespace => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle => '',
            parts => [qw( Google::Ads::AdWords::v201601::BatchJobService::RequestHeader )],
        },
        headerfault => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201601::BatchJobService::mutate )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201601::BatchJobService::query )],
        },
        header => {
...
located at https://adwords.google.com/api/adwords/cm/v201601/BatchJobService.
...
Returns a L<Google::Ads::AdWords::v201601::BatchJobService::getResponse|Google::Ads::AdWords::v201601::BatchJobService::getResponse> object.
...
Returns a L<Google::Ads::AdWords::v201601::BatchJobService::mutateResponse|Google::Ads::AdWords::v201601::BatchJobService::mutateResponse> object.
...
Returns a L<Google::Ads::AdWords::v201601::BatchJobService::queryResponse|Google::Ads::AdWords::v201601::BatchJobService::queryResponse> object.
