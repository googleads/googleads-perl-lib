package Google::Ads::AdWords::v201601::UserListLogicalRule;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'operator' => 'Google::Ads::AdWords::v201601::UserListLogicalRule::Operator',
        'ruleOperands' => 'Google::Ads::AdWords::v201601::LogicalUserListOperand',
    },
    {
...
Google::Ads::AdWords::v201601::UserListLogicalRule

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
UserListLogicalRule from the namespace https://adwords.google.com/api/adwords/rm/v201601.
