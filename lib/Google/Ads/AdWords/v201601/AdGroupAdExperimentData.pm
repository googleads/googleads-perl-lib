package Google::Ads::AdWords::v201601::AdGroupAdExperimentData;
use strict;
use warnings;
...
Google::Ads::AdWords::v201601::AdGroupAdExperimentData

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdGroupAdExperimentData from the namespace https://adwords.google.com/api/adwords/cm/v201601.
