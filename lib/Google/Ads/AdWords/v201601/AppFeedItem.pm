package Google::Ads::AdWords::v201601::AppFeedItem;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201601::ExtensionFeedItem);
# Variety: sequence
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'status' => 'Google::Ads::AdWords::v201601::FeedItem::Status',
        'feedType' => 'Google::Ads::AdWords::v201601::Feed::Type',
        'startTime' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'endTime' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'devicePreference' => 'Google::Ads::AdWords::v201601::FeedItemDevicePreference',
        'scheduling' => 'Google::Ads::AdWords::v201601::FeedItemScheduling',
        'policyData' => 'Google::Ads::AdWords::v201601::FeedItemPolicyData',
        'ExtensionFeedItem__Type' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'appStore' => 'Google::Ads::AdWords::v201601::AppFeedItem::AppStore',
        ...
        'appFinalUrls' => 'Google::Ads::AdWords::v201601::UrlList',
        'appFinalMobileUrls' => 'Google::Ads::AdWords::v201601::UrlList',
        'appTrackingUrlTemplate' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'appUrlCustomParameters' => 'Google::Ads::AdWords::v201601::CustomParameters',
    },
    {
...
Google::Ads::AdWords::v201601::AppFeedItem

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AppFeedItem from the namespace https://adwords.google.com/api/adwords/cm/v201601.
