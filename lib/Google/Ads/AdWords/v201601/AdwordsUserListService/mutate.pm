...
package Google::Ads::AdWords::v201601::AdwordsUserListService::mutate;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'operations' => 'Google::Ads::AdWords::v201601::UserListOperation',
    },
    {
...
Google::Ads::AdWords::v201601::AdwordsUserListService::mutate

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
mutate from the namespace https://adwords.google.com/api/adwords/rm/v201601.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201601::AdwordsUserListService::mutate->new($data);
