...
package Google::Ads::AdWords::v201601::MutateJobService::getResult;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'selector' => 'Google::Ads::AdWords::v201601::JobSelector',
    },
    {
...
Google::Ads::AdWords::v201601::MutateJobService::getResult

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
getResult from the namespace https://adwords.google.com/api/adwords/cm/v201601.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201601::MutateJobService::getResult->new($data);
