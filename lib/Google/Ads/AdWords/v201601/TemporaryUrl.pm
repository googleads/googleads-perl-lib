package Google::Ads::AdWords::v201601::TemporaryUrl;
use strict;
use warnings;
...
Google::Ads::AdWords::v201601::TemporaryUrl

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
TemporaryUrl from the namespace https://adwords.google.com/api/adwords/cm/v201601.
