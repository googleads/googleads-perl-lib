package Google::Ads::AdWords::v201601::ProductAdwordsLabels;
use strict;
use warnings;
...
Google::Ads::AdWords::v201601::ProductAdwordsLabels

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ProductAdwordsLabels from the namespace https://adwords.google.com/api/adwords/cm/v201601.
