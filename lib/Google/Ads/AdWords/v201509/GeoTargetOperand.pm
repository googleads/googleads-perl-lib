package Google::Ads::AdWords::v201509::GeoTargetOperand;
use strict;
use warnings;
...
Google::Ads::AdWords::v201509::GeoTargetOperand

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
GeoTargetOperand from the namespace https://adwords.google.com/api/adwords/cm/v201509.

Represents an operand containing geo information, specifying the scope of the geographical area. 
