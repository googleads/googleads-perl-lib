package Google::Ads::AdWords::v201509::UnknownProductDimension;
use strict;
use warnings;
...
Google::Ads::AdWords::v201509::UnknownProductDimension

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
UnknownProductDimension from the namespace https://adwords.google.com/api/adwords/cm/v201509.
