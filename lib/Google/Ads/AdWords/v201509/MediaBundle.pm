package Google::Ads::AdWords::v201509::MediaBundle;
use strict;
use warnings;
...
Google::Ads::AdWords::v201509::MediaBundle

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
MediaBundle from the namespace https://adwords.google.com/api/adwords/cm/v201509.
