package Google::Ads::AdWords::v201509::Video;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201509::Media);
# Variety: sequence
...
Google::Ads::AdWords::v201509::Video

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
Video from the namespace https://adwords.google.com/api/adwords/cm/v201509.
