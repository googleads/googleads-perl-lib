package Google::Ads::AdWords::v201509::PendingInvitation;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'manager' => 'Google::Ads::AdWords::v201509::ManagedCustomer',
        'client' => 'Google::Ads::AdWords::v201509::ManagedCustomer',
...
Google::Ads::AdWords::v201509::PendingInvitation

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
PendingInvitation from the namespace https://adwords.google.com/api/adwords/mcm/v201509.
