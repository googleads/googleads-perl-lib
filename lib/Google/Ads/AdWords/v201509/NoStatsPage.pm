package Google::Ads::AdWords::v201509::NoStatsPage;
use strict;
use warnings;
...
Google::Ads::AdWords::v201509::NoStatsPage

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
NoStatsPage from the namespace https://adwords.google.com/api/adwords/cm/v201509.
