package Google::Ads::AdWords::v201509::BudgetOrderRequest;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'status' => 'Google::Ads::AdWords::v201509::BudgetOrderRequest::Status',
...
Google::Ads::AdWords::v201509::BudgetOrderRequest

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
BudgetOrderRequest from the namespace https://adwords.google.com/api/adwords/billing/v201509.
