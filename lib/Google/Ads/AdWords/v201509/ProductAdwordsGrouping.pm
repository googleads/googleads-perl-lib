package Google::Ads::AdWords::v201509::ProductAdwordsGrouping;
use strict;
use warnings;
...
Google::Ads::AdWords::v201509::ProductAdwordsGrouping

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ProductAdwordsGrouping from the namespace https://adwords.google.com/api/adwords/cm/v201509.
