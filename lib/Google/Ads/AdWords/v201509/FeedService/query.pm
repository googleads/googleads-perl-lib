...
package Google::Ads::AdWords::v201509::FeedService::query;
use strict;
use warnings;
...
Google::Ads::AdWords::v201509::FeedService::query
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201509::FeedService::query->new($data);
