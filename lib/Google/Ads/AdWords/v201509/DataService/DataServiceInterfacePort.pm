package Google::Ads::AdWords::v201509::DataService::DataServiceInterfacePort;
use strict;
use warnings;
...
require Google::Ads::AdWords::v201509::TypeMaps::DataService
    if not Google::Ads::AdWords::v201509::TypeMaps::DataService->can('get_class');

sub START {
    $_[0]->set_proxy('https://adwords.google.com/api/adwords/cm/v201509/DataService') if not $_[2]->{proxy};
    $_[0]->set_class_resolver('Google::Ads::AdWords::v201509::TypeMaps::DataService')
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            ...
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201509::DataService::getAdGroupBidLandscape )],
        },
        header => {
           ...
           'use' => 'literal',
            namespace => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle => '',
            parts => [qw( Google::Ads::AdWords::v201509::DataService::RequestHeader )],
        },
        headerfault => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201509::DataService::getCriterionBidLandscape )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201509::DataService::getDomainCategory )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201509::DataService::queryAdGroupBidLandscape )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201509::DataService::queryCriterionBidLandscape )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201509::DataService::queryDomainCategory )],
        },
        header => {
...
Google::Ads::AdWords::v201509::DataService::DataServiceInterfacePort - SOAP Interface for the DataService Web Service

=head1 SYNOPSIS

 use Google::Ads::AdWords::v201509::DataService::DataServiceInterfacePort;
 my $interface = Google::Ads::AdWords::v201509::DataService::DataServiceInterfacePort->new();
...
located at https://adwords.google.com/api/adwords/cm/v201509/DataService.
...
Returns a L<Google::Ads::AdWords::v201509::DataService::getAdGroupBidLandscapeResponse|Google::Ads::AdWords::v201509::DataService::getAdGroupBidLandscapeResponse> object.
...
Returns a L<Google::Ads::AdWords::v201509::DataService::getCriterionBidLandscapeResponse|Google::Ads::AdWords::v201509::DataService::getCriterionBidLandscapeResponse> object.
...
Returns a L<Google::Ads::AdWords::v201509::DataService::getDomainCategoryResponse|Google::Ads::AdWords::v201509::DataService::getDomainCategoryResponse> object.
...
Returns a L<Google::Ads::AdWords::v201509::DataService::queryAdGroupBidLandscapeResponse|Google::Ads::AdWords::v201509::DataService::queryAdGroupBidLandscapeResponse> object.
...
Returns a L<Google::Ads::AdWords::v201509::DataService::queryCriterionBidLandscapeResponse|Google::Ads::AdWords::v201509::DataService::queryCriterionBidLandscapeResponse> object.
...
Returns a L<Google::Ads::AdWords::v201509::DataService::queryDomainCategoryResponse|Google::Ads::AdWords::v201509::DataService::queryDomainCategoryResponse> object.
...
Generated by SOAP::WSDL on Fri Oct  2 14:04:50 2015
