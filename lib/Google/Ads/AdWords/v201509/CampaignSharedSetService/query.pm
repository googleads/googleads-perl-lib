...
package Google::Ads::AdWords::v201509::CampaignSharedSetService::query;
use strict;
use warnings;
...
Google::Ads::AdWords::v201509::CampaignSharedSetService::query
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201509::CampaignSharedSetService::query->new($data);
