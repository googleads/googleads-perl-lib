package Google::Ads::AdWords::v201509::LabelAttribute;
use strict;
use warnings;
...
Google::Ads::AdWords::v201509::LabelAttribute

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
LabelAttribute from the namespace https://adwords.google.com/api/adwords/cm/v201509.
