package Google::Ads::AdWords::v201509::CampaignSharedSet;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'sharedSetType' => 'Google::Ads::AdWords::v201509::SharedSetType',
        'campaignName' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'status' => 'Google::Ads::AdWords::v201509::CampaignSharedSet::Status',
    },
    {
...
Google::Ads::AdWords::v201509::CampaignSharedSet

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CampaignSharedSet from the namespace https://adwords.google.com/api/adwords/cm/v201509.
