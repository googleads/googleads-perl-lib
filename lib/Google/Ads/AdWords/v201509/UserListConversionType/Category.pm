package Google::Ads::AdWords::v201509::UserListConversionType::Category;
use strict;
use warnings;
...
UserListConversionType.Category from the namespace https://adwords.google.com/api/adwords/rm/v201509.
