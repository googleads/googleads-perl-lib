package Google::Ads::AdWords::v201509::CallOnlyAd;
use strict;
use warnings;
...
Google::Ads::AdWords::v201509::CallOnlyAd

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CallOnlyAd from the namespace https://adwords.google.com/api/adwords/cm/v201509.
