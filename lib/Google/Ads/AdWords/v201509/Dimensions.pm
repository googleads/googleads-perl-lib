package Google::Ads::AdWords::v201509::Dimensions;
use strict;
use warnings;
...
Google::Ads::AdWords::v201509::Dimensions

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
Dimensions from the namespace https://adwords.google.com/api/adwords/cm/v201509.
