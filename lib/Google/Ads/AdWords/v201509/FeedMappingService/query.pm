...
package Google::Ads::AdWords::v201509::FeedMappingService::query;
use strict;
use warnings;
...
Google::Ads::AdWords::v201509::FeedMappingService::query
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201509::FeedMappingService::query->new($data);
