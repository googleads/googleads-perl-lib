package Google::Ads::AdWords::v201509::DisplayAttribute;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201509::LabelAttribute);
# Variety: sequence
...
Google::Ads::AdWords::v201509::DisplayAttribute

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
DisplayAttribute from the namespace https://adwords.google.com/api/adwords/cm/v201509.
