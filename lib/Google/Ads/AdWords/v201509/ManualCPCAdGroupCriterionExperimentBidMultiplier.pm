package Google::Ads::AdWords::v201509::ManualCPCAdGroupCriterionExperimentBidMultiplier;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201509::AdGroupCriterionExperimentBidMultiplier);
# Variety: sequence
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'maxCpcMultiplier' => 'Google::Ads::AdWords::v201509::BidMultiplier',
        'multiplierSource' => 'Google::Ads::AdWords::v201509::MultiplierSource',
    },
    {
...
ManualCPCAdGroupCriterionExperimentBidMultiplier from the namespace https://adwords.google.com/api/adwords/cm/v201509.
