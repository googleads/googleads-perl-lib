package Google::Ads::AdWords::v201509::Proximity;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201509::Criterion);
# Variety: sequence
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'type' => 'Google::Ads::AdWords::v201509::Criterion::Type',
        'Criterion__Type' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'geoPoint' => 'Google::Ads::AdWords::v201509::GeoPoint',
        'radiusDistanceUnits' => 'Google::Ads::AdWords::v201509::Proximity::DistanceUnits',
        'radiusInUnits' => 'SOAP::WSDL::XSD::Typelib::Builtin::double',
        'address' => 'Google::Ads::AdWords::v201509::Address',
    },
    {
...
Google::Ads::AdWords::v201509::Proximity

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
Proximity from the namespace https://adwords.google.com/api/adwords/cm/v201509.
