package Google::Ads::AdWords::v201509::ProductDimension;
use strict;
use warnings;
...
Google::Ads::AdWords::v201509::ProductDimension

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ProductDimension from the namespace https://adwords.google.com/api/adwords/cm/v201509.
