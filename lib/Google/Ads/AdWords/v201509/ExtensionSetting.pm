package Google::Ads::AdWords::v201509::ExtensionSetting;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'extensions' => 'Google::Ads::AdWords::v201509::ExtensionFeedItem',
        'platformRestrictions' => 'Google::Ads::AdWords::v201509::ExtensionSetting::Platform',
    },
    {
...
Google::Ads::AdWords::v201509::ExtensionSetting

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ExtensionSetting from the namespace https://adwords.google.com/api/adwords/cm/v201509.
