package Google::Ads::AdWords::v201509::CustomParameters;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'parameters' => 'Google::Ads::AdWords::v201509::CustomParameter',
...
Google::Ads::AdWords::v201509::CustomParameters

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CustomParameters from the namespace https://adwords.google.com/api/adwords/cm/v201509.
