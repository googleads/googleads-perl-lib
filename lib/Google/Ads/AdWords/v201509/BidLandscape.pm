package Google::Ads::AdWords::v201509::BidLandscape;
use strict;
use warnings;
...
Google::Ads::AdWords::v201509::BidLandscape

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
BidLandscape from the namespace https://adwords.google.com/api/adwords/cm/v201509.
