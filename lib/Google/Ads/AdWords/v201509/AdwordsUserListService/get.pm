...
package Google::Ads::AdWords::v201509::AdwordsUserListService::get;
use strict;
use warnings;
...
Google::Ads::AdWords::v201509::AdwordsUserListService::get

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
get from the namespace https://adwords.google.com/api/adwords/rm/v201509.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201509::AdwordsUserListService::get->new($data);
