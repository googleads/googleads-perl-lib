package Google::Ads::AdWords::v201509::String_StringMapEntry;
use strict;
use warnings;
...
Google::Ads::AdWords::v201509::String_StringMapEntry

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
String_StringMapEntry from the namespace https://adwords.google.com/api/adwords/cm/v201509.
