package Google::Ads::AdWords::v201509::WebpageCondition;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'operand' => 'Google::Ads::AdWords::v201509::WebpageConditionOperand',
...
Google::Ads::AdWords::v201509::WebpageCondition

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
WebpageCondition from the namespace https://adwords.google.com/api/adwords/cm/v201509.
