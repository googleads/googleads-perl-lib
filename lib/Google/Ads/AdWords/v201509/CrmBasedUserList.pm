package Google::Ads::AdWords::v201509::CrmBasedUserList;
use strict;
use warnings;
...
my %optOutLink_of :ATTR(:get<optOutLink>);
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'optOutLink' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
    },
    {
...
Google::Ads::AdWords::v201509::CrmBasedUserList

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CrmBasedUserList from the namespace https://adwords.google.com/api/adwords/rm/v201509.
