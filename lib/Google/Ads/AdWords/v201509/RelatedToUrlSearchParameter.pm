package Google::Ads::AdWords::v201509::RelatedToUrlSearchParameter;
use strict;
use warnings;
...
Google::Ads::AdWords::v201509::RelatedToUrlSearchParameter

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
RelatedToUrlSearchParameter from the namespace https://adwords.google.com/api/adwords/o/v201509.

A {@link SearchParameter} that specifies a set of URLs that results should in some way be related too. For example, keyword results would be similar to content keywords found on the related URLs. <p>This element is supported by following {@link IdeaType}s: KEYWORD. <p>This element is supported by following {@link RequestType}s: IDEAS, STATS. 
