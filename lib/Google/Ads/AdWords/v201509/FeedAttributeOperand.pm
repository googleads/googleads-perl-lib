package Google::Ads::AdWords::v201509::FeedAttributeOperand;
use strict;
use warnings;
...
Google::Ads::AdWords::v201509::FeedAttributeOperand

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
FeedAttributeOperand from the namespace https://adwords.google.com/api/adwords/cm/v201509.
