package Google::Ads::AdWords::v201509::CustomerChangeData;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'changedCampaigns' => 'Google::Ads::AdWords::v201509::CampaignChangeData',
        'changedFeeds' => 'Google::Ads::AdWords::v201509::FeedChangeData',
...
Google::Ads::AdWords::v201509::CustomerChangeData

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CustomerChangeData from the namespace https://adwords.google.com/api/adwords/ch/v201509.
