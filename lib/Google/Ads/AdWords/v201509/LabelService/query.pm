...
package Google::Ads::AdWords::v201509::LabelService::query;
use strict;
use warnings;
...
Google::Ads::AdWords::v201509::LabelService::query
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201509::LabelService::query->new($data);
