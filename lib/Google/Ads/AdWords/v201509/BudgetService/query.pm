...
package Google::Ads::AdWords::v201509::BudgetService::query;
use strict;
use warnings;
...
Google::Ads::AdWords::v201509::BudgetService::query
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201509::BudgetService::query->new($data);
