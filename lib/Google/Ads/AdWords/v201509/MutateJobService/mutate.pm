...
package Google::Ads::AdWords::v201509::MutateJobService::mutate;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'operations' => 'Google::Ads::AdWords::v201509::Operation',
        'policy' => 'Google::Ads::AdWords::v201509::BulkMutateJobPolicy',
    },
    {
...
Google::Ads::AdWords::v201509::MutateJobService::mutate

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
mutate from the namespace https://adwords.google.com/api/adwords/cm/v201509.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201509::MutateJobService::mutate->new($data);
