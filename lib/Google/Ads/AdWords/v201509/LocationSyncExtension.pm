package Google::Ads::AdWords::v201509::LocationSyncExtension;
use strict;
use warnings;
...
Google::Ads::AdWords::v201509::LocationSyncExtension

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
LocationSyncExtension from the namespace https://adwords.google.com/api/adwords/cm/v201509.
