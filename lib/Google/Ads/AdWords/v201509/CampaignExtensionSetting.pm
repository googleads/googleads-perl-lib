package Google::Ads::AdWords::v201509::CampaignExtensionSetting;
use strict;
use warnings;
...
Google::Ads::AdWords::v201509::CampaignExtensionSetting

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CampaignExtensionSetting from the namespace https://adwords.google.com/api/adwords/cm/v201509.
