...
package Google::Ads::AdWords::v201509::CampaignService::query;
use strict;
use warnings;
...
Google::Ads::AdWords::v201509::CampaignService::query
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201509::CampaignService::query->new($data);
