package Google::Ads::AdWords::v201509::UserListMembershipStatus;
use strict;
use warnings;
...
UserListMembershipStatus from the namespace https://adwords.google.com/api/adwords/rm/v201509.
