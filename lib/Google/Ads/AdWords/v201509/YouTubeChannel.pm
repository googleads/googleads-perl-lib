package Google::Ads::AdWords::v201509::YouTubeChannel;
use strict;
use warnings;
...
Google::Ads::AdWords::v201509::YouTubeChannel

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
YouTubeChannel from the namespace https://adwords.google.com/api/adwords/cm/v201509.
