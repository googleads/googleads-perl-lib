package Google::Ads::AdWords::v201509::LogicalUserListOperand;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'UserList' => 'Google::Ads::AdWords::v201509::UserList',
    },
    {
...
Google::Ads::AdWords::v201509::LogicalUserListOperand

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
LogicalUserListOperand from the namespace https://adwords.google.com/api/adwords/rm/v201509.
