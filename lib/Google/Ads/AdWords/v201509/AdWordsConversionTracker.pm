package Google::Ads::AdWords::v201509::AdWordsConversionTracker;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201509::ConversionTracker);
# Variety: sequence
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'status' => 'Google::Ads::AdWords::v201509::ConversionTracker::Status',
        'category' => 'Google::Ads::AdWords::v201509::ConversionTracker::Category',
        ...
        'countingType' => 'Google::Ads::AdWords::v201509::ConversionDeduplicationMode',
        ...
        'markupLanguage' => 'Google::Ads::AdWords::v201509::AdWordsConversionTracker::MarkupLanguage',
        'textFormat' => 'Google::Ads::AdWords::v201509::AdWordsConversionTracker::TextFormat',
        'conversionPageLanguage' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'backgroundColor' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'trackingCodeType' => 'Google::Ads::AdWords::v201509::AdWordsConversionTracker::TrackingCodeType',
    },
    {
...
Google::Ads::AdWords::v201509::AdWordsConversionTracker

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdWordsConversionTracker from the namespace https://adwords.google.com/api/adwords/cm/v201509.
