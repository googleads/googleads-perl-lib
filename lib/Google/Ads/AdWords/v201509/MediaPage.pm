package Google::Ads::AdWords::v201509::MediaPage;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'entries' => 'Google::Ads::AdWords::v201509::Media',
...
Google::Ads::AdWords::v201509::MediaPage

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
MediaPage from the namespace https://adwords.google.com/api/adwords/cm/v201509.
