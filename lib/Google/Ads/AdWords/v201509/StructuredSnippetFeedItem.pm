package Google::Ads::AdWords::v201509::StructuredSnippetFeedItem;
use strict;
use warnings;
...
Google::Ads::AdWords::v201509::StructuredSnippetFeedItem

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
StructuredSnippetFeedItem from the namespace https://adwords.google.com/api/adwords/cm/v201509.
