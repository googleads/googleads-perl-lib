package Google::Ads::AdWords::v201406::MediaService::MediaServiceInterfacePort;
use strict;
use warnings;
...
require Google::Ads::AdWords::v201406::TypeMaps::MediaService
    if not Google::Ads::AdWords::v201406::TypeMaps::MediaService->can('get_class');

sub START {
    $_[0]->set_proxy('https://adwords.google.com/api/adwords/cm/v201406/MediaService') if not $_[2]->{proxy};
    $_[0]->set_class_resolver('Google::Ads::AdWords::v201406::TypeMaps::MediaService')
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            ...
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201406::MediaService::get )],
        },
        header => {
           ...
           'use' => 'literal',
            namespace => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle => '',
            parts => [qw( Google::Ads::AdWords::v201406::MediaService::RequestHeader )],
        },
        headerfault => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201406::MediaService::query )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201406::MediaService::upload )],
        },
        header => {
...
located at https://adwords.google.com/api/adwords/cm/v201406/MediaService.
...
Returns a L<Google::Ads::AdWords::v201406::MediaService::getResponse|Google::Ads::AdWords::v201406::MediaService::getResponse> object.
...
Returns a L<Google::Ads::AdWords::v201406::MediaService::queryResponse|Google::Ads::AdWords::v201406::MediaService::queryResponse> object.
...
Returns a L<Google::Ads::AdWords::v201406::MediaService::uploadResponse|Google::Ads::AdWords::v201406::MediaService::uploadResponse> object.
