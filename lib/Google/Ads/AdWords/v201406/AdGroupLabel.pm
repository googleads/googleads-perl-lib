package Google::Ads::AdWords::v201406::AdGroupLabel;
use strict;
use warnings;
...
Google::Ads::AdWords::v201406::AdGroupLabel

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdGroupLabel from the namespace https://adwords.google.com/api/adwords/cm/v201406.
