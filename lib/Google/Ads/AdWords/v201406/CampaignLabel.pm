package Google::Ads::AdWords::v201406::CampaignLabel;
use strict;
use warnings;
...
Google::Ads::AdWords::v201406::CampaignLabel

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CampaignLabel from the namespace https://adwords.google.com/api/adwords/cm/v201406.
