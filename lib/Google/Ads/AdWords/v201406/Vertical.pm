package Google::Ads::AdWords::v201406::Vertical;
use strict;
use warnings;
...
Google::Ads::AdWords::v201406::Vertical

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
Vertical from the namespace https://adwords.google.com/api/adwords/cm/v201406.
