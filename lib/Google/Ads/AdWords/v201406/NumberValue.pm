package Google::Ads::AdWords::v201406::NumberValue;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201406::ComparableValue);
# Variety: sequence
...
Google::Ads::AdWords::v201406::NumberValue

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
NumberValue from the namespace https://adwords.google.com/api/adwords/cm/v201406.
