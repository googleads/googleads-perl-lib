package Google::Ads::AdWords::v201406::AdGroupAdLabel;
use strict;
use warnings;
...
Google::Ads::AdWords::v201406::AdGroupAdLabel

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdGroupAdLabel from the namespace https://adwords.google.com/api/adwords/cm/v201406.
