package Google::Ads::AdWords::v201406::AdGroupEstimateRequest;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'keywordEstimateRequests' => 'Google::Ads::AdWords::v201406::KeywordEstimateRequest',
        'maxCpc' => 'Google::Ads::AdWords::v201406::Money',
    },
    {
...
Google::Ads::AdWords::v201406::AdGroupEstimateRequest

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdGroupEstimateRequest from the namespace https://adwords.google.com/api/adwords/o/v201406.
