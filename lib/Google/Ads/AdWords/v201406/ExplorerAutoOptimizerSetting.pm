package Google::Ads::AdWords::v201406::ExplorerAutoOptimizerSetting;
use strict;
use warnings;
...
Google::Ads::AdWords::v201406::ExplorerAutoOptimizerSetting

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ExplorerAutoOptimizerSetting from the namespace https://adwords.google.com/api/adwords/cm/v201406.
