...
package Google::Ads::AdWords::v201406::FeedItemService::query;
use strict;
use warnings;
...
Google::Ads::AdWords::v201406::FeedItemService::query
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201406::FeedItemService::query->new($data);
