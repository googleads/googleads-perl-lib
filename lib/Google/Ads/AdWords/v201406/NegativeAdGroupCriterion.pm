package Google::Ads::AdWords::v201406::NegativeAdGroupCriterion;
use strict;
use warnings;
...
NegativeAdGroupCriterion from the namespace https://adwords.google.com/api/adwords/cm/v201406.
