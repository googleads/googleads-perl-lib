package Google::Ads::AdWords::v201406::KeywordMatchSetting;
use strict;
use warnings;
...
Google::Ads::AdWords::v201406::KeywordMatchSetting

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
KeywordMatchSetting from the namespace https://adwords.google.com/api/adwords/cm/v201406.
