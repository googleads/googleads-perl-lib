package Google::Ads::AdWords::v201406::NoStatsPage;
use strict;
use warnings;
...
Google::Ads::AdWords::v201406::NoStatsPage

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
NoStatsPage from the namespace https://adwords.google.com/api/adwords/mcm/v201406.
