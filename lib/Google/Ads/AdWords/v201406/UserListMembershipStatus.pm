package Google::Ads::AdWords::v201406::UserListMembershipStatus;
use strict;
use warnings;
...
UserListMembershipStatus from the namespace https://adwords.google.com/api/adwords/rm/v201406.
