package Google::Ads::AdWords::v201406::BidLandscape::LandscapePoint;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'bid' => 'Google::Ads::AdWords::v201406::Money',
        'clicks' => 'SOAP::WSDL::XSD::Typelib::Builtin::long',
        'cost' => 'Google::Ads::AdWords::v201406::Money',
        'marginalCpc' => 'Google::Ads::AdWords::v201406::Money',
...
Google::Ads::AdWords::v201406::BidLandscape::LandscapePoint

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
BidLandscape.LandscapePoint from the namespace https://adwords.google.com/api/adwords/cm/v201406.
