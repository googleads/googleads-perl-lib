package Google::Ads::AdWords::v201406::MobileAd;
use strict;
use warnings;
...
Google::Ads::AdWords::v201406::MobileAd

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
MobileAd from the namespace https://adwords.google.com/api/adwords/cm/v201406.
