package Google::Ads::AdWords::v201406::DimensionProperties;
use strict;
use warnings;
...
Google::Ads::AdWords::v201406::DimensionProperties

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
DimensionProperties from the namespace https://adwords.google.com/api/adwords/cm/v201406.
