package Google::Ads::AdWords::v201406::TargetingIdeaSelector;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'searchParameters' => 'Google::Ads::AdWords::v201406::SearchParameter',
        'ideaType' => 'Google::Ads::AdWords::v201406::IdeaType',
        'requestType' => 'Google::Ads::AdWords::v201406::RequestType',
        'requestedAttributeTypes' => 'Google::Ads::AdWords::v201406::AttributeType',
...
Google::Ads::AdWords::v201406::TargetingIdeaSelector

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
TargetingIdeaSelector from the namespace https://adwords.google.com/api/adwords/o/v201406.
