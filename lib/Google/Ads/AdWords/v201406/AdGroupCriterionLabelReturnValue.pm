...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'value' => 'Google::Ads::AdWords::v201406::AdGroupCriterionLabel',
...
Google::Ads::AdWords::v201406::AdGroupCriterionLabelReturnValue

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdGroupCriterionLabelReturnValue from the namespace https://adwords.google.com/api/adwords/cm/v201406.
