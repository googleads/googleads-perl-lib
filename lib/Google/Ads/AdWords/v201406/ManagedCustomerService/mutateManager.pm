...
package Google::Ads::AdWords::v201406::ManagedCustomerService::mutateManager;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'operations' => 'Google::Ads::AdWords::v201406::MoveOperation',
    },
    {
...
Google::Ads::AdWords::v201406::ManagedCustomerService::mutateManager

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
mutateManager from the namespace https://adwords.google.com/api/adwords/mcm/v201406.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201406::ManagedCustomerService::mutateManager->new($data);
