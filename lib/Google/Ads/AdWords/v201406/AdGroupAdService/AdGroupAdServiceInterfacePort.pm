package Google::Ads::AdWords::v201406::AdGroupAdService::AdGroupAdServiceInterfacePort;
use strict;
use warnings;
...
require Google::Ads::AdWords::v201406::TypeMaps::AdGroupAdService
    if not Google::Ads::AdWords::v201406::TypeMaps::AdGroupAdService->can('get_class');

sub START {
    $_[0]->set_proxy('https://adwords.google.com/api/adwords/cm/v201406/AdGroupAdService') if not $_[2]->{proxy};
    $_[0]->set_class_resolver('Google::Ads::AdWords::v201406::TypeMaps::AdGroupAdService')
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            ...
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201406::AdGroupAdService::get )],
        },
        header => {
           ...
           'use' => 'literal',
            namespace => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle => '',
            parts => [qw( Google::Ads::AdWords::v201406::AdGroupAdService::RequestHeader )],
        },
        headerfault => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201406::AdGroupAdService::mutate )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201406::AdGroupAdService::mutateLabel )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201406::AdGroupAdService::query )],
        },
        header => {
...
Google::Ads::AdWords::v201406::AdGroupAdService::AdGroupAdServiceInterfacePort - SOAP Interface for the AdGroupAdService Web Service

=head1 SYNOPSIS

 use Google::Ads::AdWords::v201406::AdGroupAdService::AdGroupAdServiceInterfacePort;
 my $interface = Google::Ads::AdWords::v201406::AdGroupAdService::AdGroupAdServiceInterfacePort->new();
...
located at https://adwords.google.com/api/adwords/cm/v201406/AdGroupAdService.
...
Returns a L<Google::Ads::AdWords::v201406::AdGroupAdService::getResponse|Google::Ads::AdWords::v201406::AdGroupAdService::getResponse> object.
...
Returns a L<Google::Ads::AdWords::v201406::AdGroupAdService::mutateResponse|Google::Ads::AdWords::v201406::AdGroupAdService::mutateResponse> object.

 $response = $interface->mutate( {
    operations =>  $a_reference_to, # see Google::Ads::AdWords::v201406::AdGroupAdOperation
  },,
 );
...
Returns a L<Google::Ads::AdWords::v201406::AdGroupAdService::mutateLabelResponse|Google::Ads::AdWords::v201406::AdGroupAdService::mutateLabelResponse> object.

 $response = $interface->mutateLabel( {
    operations =>  $a_reference_to, # see Google::Ads::AdWords::v201406::AdGroupAdLabelOperation
  },,
 );
...
Returns a L<Google::Ads::AdWords::v201406::AdGroupAdService::queryResponse|Google::Ads::AdWords::v201406::AdGroupAdService::queryResponse> object.
...
Generated by SOAP::WSDL on Mon Jun 30 09:51:32 2014
