package Google::Ads::AdWords::v201406::UserList;
use strict;
use warnings;
...
Google::Ads::AdWords::v201406::UserList

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
UserList from the namespace https://adwords.google.com/api/adwords/rm/v201406.
