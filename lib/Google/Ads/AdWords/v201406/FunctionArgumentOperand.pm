package Google::Ads::AdWords::v201406::FunctionArgumentOperand;
use strict;
use warnings;
...
Google::Ads::AdWords::v201406::FunctionArgumentOperand

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
FunctionArgumentOperand from the namespace https://adwords.google.com/api/adwords/cm/v201406.
