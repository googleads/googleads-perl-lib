...
package Google::Ads::AdWords::v201406::DataService::getCriterionBidLandscape;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'serviceSelector' => 'Google::Ads::AdWords::v201406::Selector',
    },
    {
...
Google::Ads::AdWords::v201406::DataService::getCriterionBidLandscape

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
getCriterionBidLandscape from the namespace https://adwords.google.com/api/adwords/cm/v201406.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201406::DataService::getCriterionBidLandscape->new($data);
