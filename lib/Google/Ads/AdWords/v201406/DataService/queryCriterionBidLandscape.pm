...
package Google::Ads::AdWords::v201406::DataService::queryCriterionBidLandscape;
use strict;
use warnings;
...
Google::Ads::AdWords::v201406::DataService::queryCriterionBidLandscape

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
queryCriterionBidLandscape from the namespace https://adwords.google.com/api/adwords/cm/v201406.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201406::DataService::queryCriterionBidLandscape->new($data);
