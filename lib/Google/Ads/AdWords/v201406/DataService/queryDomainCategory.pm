...
package Google::Ads::AdWords::v201406::DataService::queryDomainCategory;
use strict;
use warnings;
...
Google::Ads::AdWords::v201406::DataService::queryDomainCategory

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
queryDomainCategory from the namespace https://adwords.google.com/api/adwords/cm/v201406.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201406::DataService::queryDomainCategory->new($data);
