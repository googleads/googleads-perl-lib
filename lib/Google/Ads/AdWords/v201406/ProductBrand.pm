package Google::Ads::AdWords::v201406::ProductBrand;
use strict;
use warnings;
...
Google::Ads::AdWords::v201406::ProductBrand

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ProductBrand from the namespace https://adwords.google.com/api/adwords/cm/v201406.
