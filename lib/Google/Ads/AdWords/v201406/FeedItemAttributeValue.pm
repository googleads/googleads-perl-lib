package Google::Ads::AdWords::v201406::FeedItemAttributeValue;
use strict;
use warnings;
...
Google::Ads::AdWords::v201406::FeedItemAttributeValue

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
FeedItemAttributeValue from the namespace https://adwords.google.com/api/adwords/cm/v201406.
