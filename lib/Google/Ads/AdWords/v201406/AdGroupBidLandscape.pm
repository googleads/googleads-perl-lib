package Google::Ads::AdWords::v201406::AdGroupBidLandscape;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201406::BidLandscape);
# Variety: sequence
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'type' => 'Google::Ads::AdWords::v201406::AdGroupBidLandscape::Type',
...
Google::Ads::AdWords::v201406::AdGroupBidLandscape

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdGroupBidLandscape from the namespace https://adwords.google.com/api/adwords/cm/v201406.
