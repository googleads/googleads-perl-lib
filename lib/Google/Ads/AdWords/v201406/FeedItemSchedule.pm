package Google::Ads::AdWords::v201406::FeedItemSchedule;
use strict;
use warnings;
...
Google::Ads::AdWords::v201406::FeedItemSchedule

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
FeedItemSchedule from the namespace https://adwords.google.com/api/adwords/cm/v201406.
