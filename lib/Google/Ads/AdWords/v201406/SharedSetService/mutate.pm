...
package Google::Ads::AdWords::v201406::SharedSetService::mutate;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'operations' => 'Google::Ads::AdWords::v201406::SharedSetOperation',
    },
    {
...
Google::Ads::AdWords::v201406::SharedSetService::mutate
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201406::SharedSetService::mutate->new($data);

Constructor. The following data structure may be passed to new():

 {
   operations =>  $a_reference_to, # see Google::Ads::AdWords::v201406::SharedSetOperation
 },
