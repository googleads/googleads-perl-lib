package Google::Ads::AdWords::v201406::LongAttribute;
use strict;
use warnings;
...
Google::Ads::AdWords::v201406::LongAttribute

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
LongAttribute from the namespace https://adwords.google.com/api/adwords/o/v201406.
