package Google::Ads::AdWords::v201506::ConversionTrackerService::ConversionTrackerServiceInterfacePort;
use strict;
use warnings;
...
require Google::Ads::AdWords::v201506::TypeMaps::ConversionTrackerService
    if not Google::Ads::AdWords::v201506::TypeMaps::ConversionTrackerService->can('get_class');

sub START {
    $_[0]->set_proxy('https://adwords.google.com/api/adwords/cm/v201506/ConversionTrackerService') if not $_[2]->{proxy};
    $_[0]->set_class_resolver('Google::Ads::AdWords::v201506::TypeMaps::ConversionTrackerService')
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            ...
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201506::ConversionTrackerService::get )],
        },
        header => {
           ...
           'use' => 'literal',
            namespace => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle => '',
            parts => [qw( Google::Ads::AdWords::v201506::ConversionTrackerService::RequestHeader )],
        },
        headerfault => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201506::ConversionTrackerService::mutate )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201506::ConversionTrackerService::query )],
        },
        header => {
...
Google::Ads::AdWords::v201506::ConversionTrackerService::ConversionTrackerServiceInterfacePort - SOAP Interface for the ConversionTrackerService Web Service

=head1 SYNOPSIS

 use Google::Ads::AdWords::v201506::ConversionTrackerService::ConversionTrackerServiceInterfacePort;
 my $interface = Google::Ads::AdWords::v201506::ConversionTrackerService::ConversionTrackerServiceInterfacePort->new();
...
located at https://adwords.google.com/api/adwords/cm/v201506/ConversionTrackerService.
...
Returns a L<Google::Ads::AdWords::v201506::ConversionTrackerService::getResponse|Google::Ads::AdWords::v201506::ConversionTrackerService::getResponse> object.
...
Returns a L<Google::Ads::AdWords::v201506::ConversionTrackerService::mutateResponse|Google::Ads::AdWords::v201506::ConversionTrackerService::mutateResponse> object.

 $response = $interface->mutate( {
    operations =>  $a_reference_to, # see Google::Ads::AdWords::v201506::ConversionTrackerOperation
  },,
 );
...
Returns a L<Google::Ads::AdWords::v201506::ConversionTrackerService::queryResponse|Google::Ads::AdWords::v201506::ConversionTrackerService::queryResponse> object.
...
Generated by SOAP::WSDL on Mon Jun 29 11:52:13 2015
