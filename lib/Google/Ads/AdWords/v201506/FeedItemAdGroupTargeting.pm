package Google::Ads::AdWords::v201506::FeedItemAdGroupTargeting;
use strict;
use warnings;
...
Google::Ads::AdWords::v201506::FeedItemAdGroupTargeting

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
FeedItemAdGroupTargeting from the namespace https://adwords.google.com/api/adwords/cm/v201506.
