package Google::Ads::AdWords::v201506::DateKey;
use strict;
use warnings;
...
Google::Ads::AdWords::v201506::DateKey

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
DateKey from the namespace https://adwords.google.com/api/adwords/rm/v201506.
