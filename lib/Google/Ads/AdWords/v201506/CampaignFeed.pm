package Google::Ads::AdWords::v201506::CampaignFeed;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'matchingFunction' => 'Google::Ads::AdWords::v201506::Function',
        'placeholderTypes' => 'SOAP::WSDL::XSD::Typelib::Builtin::int',
        'status' => 'Google::Ads::AdWords::v201506::CampaignFeed::Status',
    },
    {
...
Google::Ads::AdWords::v201506::CampaignFeed

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CampaignFeed from the namespace https://adwords.google.com/api/adwords/cm/v201506.
