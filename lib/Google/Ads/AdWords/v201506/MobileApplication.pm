package Google::Ads::AdWords::v201506::MobileApplication;
use strict;
use warnings;
...
Google::Ads::AdWords::v201506::MobileApplication

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
MobileApplication from the namespace https://adwords.google.com/api/adwords/cm/v201506.
