package Google::Ads::AdWords::v201506::UploadConversion;
use strict;
use warnings;
...
Google::Ads::AdWords::v201506::UploadConversion

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
UploadConversion from the namespace https://adwords.google.com/api/adwords/cm/v201506.
