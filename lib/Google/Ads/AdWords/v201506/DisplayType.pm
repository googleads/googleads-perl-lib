package Google::Ads::AdWords::v201506::DisplayType;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'FlashDisplayType' => 'Google::Ads::AdWords::v201506::FlashDisplayType',
        'HtmlDisplayType' => 'Google::Ads::AdWords::v201506::HtmlDisplayType',
        'ImageDisplayType' => 'Google::Ads::AdWords::v201506::ImageDisplayType',
    },
    {
...
Google::Ads::AdWords::v201506::DisplayType

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
DisplayType from the namespace https://adwords.google.com/api/adwords/o/v201506.
