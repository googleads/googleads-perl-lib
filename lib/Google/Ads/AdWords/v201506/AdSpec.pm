package Google::Ads::AdWords::v201506::AdSpec;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'DisplayAdSpec' => 'Google::Ads::AdWords::v201506::DisplayAdSpec',
        'InStreamAdSpec' => 'Google::Ads::AdWords::v201506::InStreamAdSpec',
        'TextAdSpec' => 'Google::Ads::AdWords::v201506::TextAdSpec',
    },
    {
...
Google::Ads::AdWords::v201506::AdSpec

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdSpec from the namespace https://adwords.google.com/api/adwords/o/v201506.
