package Google::Ads::AdWords::v201506::NegativeAdGroupCriterion;
use strict;
use warnings;
...
NegativeAdGroupCriterion from the namespace https://adwords.google.com/api/adwords/cm/v201506.
