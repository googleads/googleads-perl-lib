...
package Google::Ads::AdWords::v201506::AdwordsUserListService::mutate;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'operations' => 'Google::Ads::AdWords::v201506::UserListOperation',
    },
    {
...
Google::Ads::AdWords::v201506::AdwordsUserListService::mutate

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
mutate from the namespace https://adwords.google.com/api/adwords/rm/v201506.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201506::AdwordsUserListService::mutate->new($data);
