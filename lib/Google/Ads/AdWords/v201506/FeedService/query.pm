...
package Google::Ads::AdWords::v201506::FeedService::query;
use strict;
use warnings;
...
Google::Ads::AdWords::v201506::FeedService::query
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201506::FeedService::query->new($data);
