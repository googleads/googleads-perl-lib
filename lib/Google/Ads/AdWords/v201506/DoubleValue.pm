package Google::Ads::AdWords::v201506::DoubleValue;
use strict;
use warnings;
...
Google::Ads::AdWords::v201506::DoubleValue

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
DoubleValue from the namespace https://adwords.google.com/api/adwords/cm/v201506.
