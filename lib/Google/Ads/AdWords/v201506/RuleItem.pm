package Google::Ads::AdWords::v201506::RuleItem;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'DateRuleItem' => 'Google::Ads::AdWords::v201506::DateRuleItem',
        'NumberRuleItem' => 'Google::Ads::AdWords::v201506::NumberRuleItem',
        'StringRuleItem' => 'Google::Ads::AdWords::v201506::StringRuleItem',
    },
    {
...
Google::Ads::AdWords::v201506::RuleItem

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
RuleItem from the namespace https://adwords.google.com/api/adwords/rm/v201506.
