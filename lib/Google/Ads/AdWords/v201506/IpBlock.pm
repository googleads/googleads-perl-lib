package Google::Ads::AdWords::v201506::IpBlock;
use strict;
use warnings;
...
Google::Ads::AdWords::v201506::IpBlock

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
IpBlock from the namespace https://adwords.google.com/api/adwords/cm/v201506.
