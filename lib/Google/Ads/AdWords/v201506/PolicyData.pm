package Google::Ads::AdWords::v201506::PolicyData;
use strict;
use warnings;
...
Google::Ads::AdWords::v201506::PolicyData

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
PolicyData from the namespace https://adwords.google.com/api/adwords/cm/v201506.
