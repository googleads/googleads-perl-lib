package Google::Ads::AdWords::v201506::LocationSyncExtension;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201506::AdExtension);
# Variety: sequence
...
Google::Ads::AdWords::v201506::LocationSyncExtension

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
LocationSyncExtension from the namespace https://adwords.google.com/api/adwords/cm/v201506.
