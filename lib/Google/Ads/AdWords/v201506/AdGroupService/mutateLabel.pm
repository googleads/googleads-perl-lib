...
package Google::Ads::AdWords::v201506::AdGroupService::mutateLabel;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'operations' => 'Google::Ads::AdWords::v201506::AdGroupLabelOperation',
    },
    {
...
Google::Ads::AdWords::v201506::AdGroupService::mutateLabel
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201506::AdGroupService::mutateLabel->new($data);

Constructor. The following data structure may be passed to new():

 {
   operations =>  $a_reference_to, # see Google::Ads::AdWords::v201506::AdGroupLabelOperation
 },
