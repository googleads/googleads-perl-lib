package Google::Ads::AdWords::v201506::ProductLegacyCondition;
use strict;
use warnings;
...
Google::Ads::AdWords::v201506::ProductLegacyCondition

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ProductLegacyCondition from the namespace https://adwords.google.com/api/adwords/cm/v201506.
