package Google::Ads::AdWords::v201506::AdUrlUpgrade;
use strict;
use warnings;
...
Google::Ads::AdWords::v201506::AdUrlUpgrade

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdUrlUpgrade from the namespace https://adwords.google.com/api/adwords/cm/v201506.
