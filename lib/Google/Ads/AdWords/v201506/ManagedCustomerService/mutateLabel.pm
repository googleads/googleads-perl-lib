...
package Google::Ads::AdWords::v201506::ManagedCustomerService::mutateLabel;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'operations' => 'Google::Ads::AdWords::v201506::ManagedCustomerLabelOperation',
    },
    {
...
Google::Ads::AdWords::v201506::ManagedCustomerService::mutateLabel

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
mutateLabel from the namespace https://adwords.google.com/api/adwords/mcm/v201506.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201506::ManagedCustomerService::mutateLabel->new($data);
