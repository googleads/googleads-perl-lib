package Google::Ads::AdWords::v201506::MoveOperation;
use strict;
use warnings;
...
Google::Ads::AdWords::v201506::MoveOperation

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
MoveOperation from the namespace https://adwords.google.com/api/adwords/mcm/v201506.
