package Google::Ads::AdWords::v201506::CustomerExtensionSetting;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'extensionType' => 'Google::Ads::AdWords::v201506::Feed::Type',
        'extensionSetting' => 'Google::Ads::AdWords::v201506::ExtensionSetting',
    },
    {
...
Google::Ads::AdWords::v201506::CustomerExtensionSetting

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CustomerExtensionSetting from the namespace https://adwords.google.com/api/adwords/cm/v201506.
