package Google::Ads::AdWords::v201506::AdGroupAd;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'experimentData' => 'Google::Ads::AdWords::v201506::AdGroupAdExperimentData',
        'status' => 'Google::Ads::AdWords::v201506::AdGroupAd::Status',
        'approvalStatus' => 'Google::Ads::AdWords::v201506::AdGroupAd::ApprovalStatus',
...
Google::Ads::AdWords::v201506::AdGroupAd

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdGroupAd from the namespace https://adwords.google.com/api/adwords/cm/v201506.
