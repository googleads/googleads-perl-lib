package Google::Ads::AdWords::v201506::ExpressionRuleUserList;
use strict;
use warnings;
...
Google::Ads::AdWords::v201506::ExpressionRuleUserList

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ExpressionRuleUserList from the namespace https://adwords.google.com/api/adwords/rm/v201506.
