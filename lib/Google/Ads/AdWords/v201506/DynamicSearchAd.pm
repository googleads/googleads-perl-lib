package Google::Ads::AdWords::v201506::DynamicSearchAd;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201506::Ad);
# Variety: sequence
...
Google::Ads::AdWords::v201506::DynamicSearchAd

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
DynamicSearchAd from the namespace https://adwords.google.com/api/adwords/cm/v201506.
