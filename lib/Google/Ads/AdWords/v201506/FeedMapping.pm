package Google::Ads::AdWords::v201506::FeedMapping;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'status' => 'Google::Ads::AdWords::v201506::FeedMapping::Status',
        'attributeFieldMappings' => 'Google::Ads::AdWords::v201506::AttributeFieldMapping',
...
Google::Ads::AdWords::v201506::FeedMapping

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
FeedMapping from the namespace https://adwords.google.com/api/adwords/cm/v201506.
