package Google::Ads::AdWords::v201506::CustomParameter;
use strict;
use warnings;
...
Google::Ads::AdWords::v201506::CustomParameter

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CustomParameter from the namespace https://adwords.google.com/api/adwords/cm/v201506.
