package Google::Ads::AdWords::v201506::CategoryProductsAndServicesSearchParameter;
use strict;
use warnings;
...
Google::Ads::AdWords::v201506::CategoryProductsAndServicesSearchParameter

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CategoryProductsAndServicesSearchParameter from the namespace https://adwords.google.com/api/adwords/o/v201506.
