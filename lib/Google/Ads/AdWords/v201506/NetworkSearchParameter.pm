package Google::Ads::AdWords::v201506::NetworkSearchParameter;
use strict;
use warnings;
...
Google::Ads::AdWords::v201506::NetworkSearchParameter

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
NetworkSearchParameter from the namespace https://adwords.google.com/api/adwords/o/v201506.
