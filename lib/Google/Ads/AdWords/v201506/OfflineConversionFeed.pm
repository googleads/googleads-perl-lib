package Google::Ads::AdWords::v201506::OfflineConversionFeed;
use strict;
use warnings;
...
Google::Ads::AdWords::v201506::OfflineConversionFeed

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
OfflineConversionFeed from the namespace https://adwords.google.com/api/adwords/cm/v201506.
