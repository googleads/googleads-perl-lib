...
package Google::Ads::AdWords::v201506::ConstantDataService::getProductBiddingCategoryData;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'selector' => 'Google::Ads::AdWords::v201506::Selector',
    },
    {
...
Google::Ads::AdWords::v201506::ConstantDataService::getProductBiddingCategoryData

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
getProductBiddingCategoryData from the namespace https://adwords.google.com/api/adwords/cm/v201506.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201506::ConstantDataService::getProductBiddingCategoryData->new($data);
