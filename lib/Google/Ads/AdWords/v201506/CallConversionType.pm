package Google::Ads::AdWords::v201506::CallConversionType;
use strict;
use warnings;
...
Google::Ads::AdWords::v201506::CallConversionType

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CallConversionType from the namespace https://adwords.google.com/api/adwords/cm/v201506.
