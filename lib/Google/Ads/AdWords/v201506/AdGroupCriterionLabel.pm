package Google::Ads::AdWords::v201506::AdGroupCriterionLabel;
use strict;
use warnings;
...
Google::Ads::AdWords::v201506::AdGroupCriterionLabel

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdGroupCriterionLabel from the namespace https://adwords.google.com/api/adwords/cm/v201506.
