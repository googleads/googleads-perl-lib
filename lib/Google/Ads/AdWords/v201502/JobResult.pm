package Google::Ads::AdWords::v201502::JobResult;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'SimpleMutateResult' => 'Google::Ads::AdWords::v201502::SimpleMutateResult',
    },
    {
...
Google::Ads::AdWords::v201502::JobResult

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
JobResult from the namespace https://adwords.google.com/api/adwords/cm/v201502.
