package Google::Ads::AdWords::v201502::NegativeCampaignCriterion;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201502::CampaignCriterion);
# Variety: sequence
...
NegativeCampaignCriterion from the namespace https://adwords.google.com/api/adwords/cm/v201502.
