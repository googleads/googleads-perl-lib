package Google::Ads::AdWords::v201502::BidLandscape;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201502::DataEntry);
# Variety: sequence
...
Google::Ads::AdWords::v201502::BidLandscape

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
BidLandscape from the namespace https://adwords.google.com/api/adwords/cm/v201502.
