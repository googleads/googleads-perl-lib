package Google::Ads::AdWords::v201502::BudgetOptimizerBiddingScheme;
use strict;
use warnings;
...
Google::Ads::AdWords::v201502::BudgetOptimizerBiddingScheme

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
BudgetOptimizerBiddingScheme from the namespace https://adwords.google.com/api/adwords/cm/v201502.
