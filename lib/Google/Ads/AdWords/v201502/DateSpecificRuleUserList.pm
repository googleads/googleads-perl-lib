package Google::Ads::AdWords::v201502::DateSpecificRuleUserList;
use strict;
use warnings;
...
sub get_xmlns { 'https://adwords.google.com/api/adwords/rm/v201502' };
...
use base qw(Google::Ads::AdWords::v201502::RuleBasedUserList);
# Variety: sequence
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'status' => 'Google::Ads::AdWords::v201502::UserListMembershipStatus',
        'integrationCode' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'accessReason' => 'Google::Ads::AdWords::v201502::AccessReason',
        'accountUserListStatus' => 'Google::Ads::AdWords::v201502::AccountUserListStatus',
        'membershipLifeSpan' => 'SOAP::WSDL::XSD::Typelib::Builtin::long',
        'size' => 'SOAP::WSDL::XSD::Typelib::Builtin::long',
        'sizeRange' => 'Google::Ads::AdWords::v201502::SizeRange',
        'sizeForSearch' => 'SOAP::WSDL::XSD::Typelib::Builtin::long',
        'sizeRangeForSearch' => 'Google::Ads::AdWords::v201502::SizeRange',
        'listType' => 'Google::Ads::AdWords::v201502::UserListType',
        'UserList__Type' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'rule' => 'Google::Ads::AdWords::v201502::Rule',
...
Google::Ads::AdWords::v201502::DateSpecificRuleUserList

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
DateSpecificRuleUserList from the namespace https://adwords.google.com/api/adwords/rm/v201502.
