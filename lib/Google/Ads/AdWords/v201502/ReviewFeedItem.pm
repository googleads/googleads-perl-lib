package Google::Ads::AdWords::v201502::ReviewFeedItem;
use strict;
use warnings;
...
Google::Ads::AdWords::v201502::ReviewFeedItem

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ReviewFeedItem from the namespace https://adwords.google.com/api/adwords/cm/v201502.
