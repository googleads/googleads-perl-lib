package Google::Ads::AdWords::v201502::NegativeAdGroupCriterion;
use strict;
use warnings;
...
NegativeAdGroupCriterion from the namespace https://adwords.google.com/api/adwords/cm/v201502.
