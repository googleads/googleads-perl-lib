package Google::Ads::AdWords::v201502::AdCallMetricsConversion;
use strict;
use warnings;
...
Google::Ads::AdWords::v201502::AdCallMetricsConversion

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdCallMetricsConversion from the namespace https://adwords.google.com/api/adwords/cm/v201502.
