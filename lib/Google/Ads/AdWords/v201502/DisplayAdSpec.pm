package Google::Ads::AdWords::v201502::DisplayAdSpec;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'displayTypes' => 'Google::Ads::AdWords::v201502::DisplayType',
        'activationOptions' => 'Google::Ads::AdWords::v201502::DisplayAdSpec::ActivationOption',
        'adSizeSpecs' => 'Google::Ads::AdWords::v201502::DisplayAdSpec::AdSizeSpec',
    },
    {
...
Google::Ads::AdWords::v201502::DisplayAdSpec

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
DisplayAdSpec from the namespace https://adwords.google.com/api/adwords/o/v201502.
