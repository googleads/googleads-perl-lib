package Google::Ads::AdWords::v201502::ShoppingSetting;
use strict;
use warnings;
...
Google::Ads::AdWords::v201502::ShoppingSetting

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ShoppingSetting from the namespace https://adwords.google.com/api/adwords/cm/v201502.
