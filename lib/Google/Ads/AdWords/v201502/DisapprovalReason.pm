package Google::Ads::AdWords::v201502::DisapprovalReason;
use strict;
use warnings;
...
Google::Ads::AdWords::v201502::DisapprovalReason

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
DisapprovalReason from the namespace https://adwords.google.com/api/adwords/cm/v201502.
