package Google::Ads::AdWords::v201502::ManagedCustomerLabelReturnValue;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'value' => 'Google::Ads::AdWords::v201502::ManagedCustomerLabel',
    },
    {
...
Google::Ads::AdWords::v201502::ManagedCustomerLabelReturnValue

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ManagedCustomerLabelReturnValue from the namespace https://adwords.google.com/api/adwords/mcm/v201502.
