package Google::Ads::AdWords::v201502::AdGroupCriterion;
use strict;
use warnings;
...
Google::Ads::AdWords::v201502::AdGroupCriterion

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdGroupCriterion from the namespace https://adwords.google.com/api/adwords/cm/v201502.
