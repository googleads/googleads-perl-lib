...
package Google::Ads::AdWords::v201502::FeedItemService::query;
use strict;
use warnings;
...
Google::Ads::AdWords::v201502::FeedItemService::query
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201502::FeedItemService::query->new($data);
