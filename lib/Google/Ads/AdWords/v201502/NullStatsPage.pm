package Google::Ads::AdWords::v201502::NullStatsPage;
use strict;
use warnings;
...
Google::Ads::AdWords::v201502::NullStatsPage

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
NullStatsPage from the namespace https://adwords.google.com/api/adwords/cm/v201502.
