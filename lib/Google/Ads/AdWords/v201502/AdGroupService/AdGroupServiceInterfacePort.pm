package Google::Ads::AdWords::v201502::AdGroupService::AdGroupServiceInterfacePort;
use strict;
use warnings;
...
require Google::Ads::AdWords::v201502::TypeMaps::AdGroupService
    if not Google::Ads::AdWords::v201502::TypeMaps::AdGroupService->can('get_class');

sub START {
    $_[0]->set_proxy('https://adwords.google.com/api/adwords/cm/v201502/AdGroupService') if not $_[2]->{proxy};
    $_[0]->set_class_resolver('Google::Ads::AdWords::v201502::TypeMaps::AdGroupService')
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            ...
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201502::AdGroupService::get )],
        },
        header => {
           ...
           'use' => 'literal',
            namespace => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle => '',
            parts => [qw( Google::Ads::AdWords::v201502::AdGroupService::RequestHeader )],
        },
        headerfault => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201502::AdGroupService::mutate )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201502::AdGroupService::mutateLabel )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201502::AdGroupService::query )],
        },
        header => {
...
Google::Ads::AdWords::v201502::AdGroupService::AdGroupServiceInterfacePort - SOAP Interface for the AdGroupService Web Service

=head1 SYNOPSIS

 use Google::Ads::AdWords::v201502::AdGroupService::AdGroupServiceInterfacePort;
 my $interface = Google::Ads::AdWords::v201502::AdGroupService::AdGroupServiceInterfacePort->new();
...
located at https://adwords.google.com/api/adwords/cm/v201502/AdGroupService.
...
Returns a L<Google::Ads::AdWords::v201502::AdGroupService::getResponse|Google::Ads::AdWords::v201502::AdGroupService::getResponse> object.
...
Returns a L<Google::Ads::AdWords::v201502::AdGroupService::mutateResponse|Google::Ads::AdWords::v201502::AdGroupService::mutateResponse> object.

 $response = $interface->mutate( {
    operations =>  $a_reference_to, # see Google::Ads::AdWords::v201502::AdGroupOperation
  },,
 );
...
Returns a L<Google::Ads::AdWords::v201502::AdGroupService::mutateLabelResponse|Google::Ads::AdWords::v201502::AdGroupService::mutateLabelResponse> object.

 $response = $interface->mutateLabel( {
    operations =>  $a_reference_to, # see Google::Ads::AdWords::v201502::AdGroupLabelOperation
  },,
 );
...
Returns a L<Google::Ads::AdWords::v201502::AdGroupService::queryResponse|Google::Ads::AdWords::v201502::AdGroupService::queryResponse> object.
...
Generated by SOAP::WSDL on Fri Mar  6 16:49:43 2015
