package Google::Ads::AdWords::v201502::FeedItemScheduling;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'feedItemSchedules' => 'Google::Ads::AdWords::v201502::FeedItemSchedule',
    },
    {
...
Google::Ads::AdWords::v201502::FeedItemScheduling

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
FeedItemScheduling from the namespace https://adwords.google.com/api/adwords/cm/v201502.
