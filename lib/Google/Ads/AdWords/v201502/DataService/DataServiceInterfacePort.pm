package Google::Ads::AdWords::v201502::DataService::DataServiceInterfacePort;
use strict;
use warnings;
...
require Google::Ads::AdWords::v201502::TypeMaps::DataService
    if not Google::Ads::AdWords::v201502::TypeMaps::DataService->can('get_class');

sub START {
    $_[0]->set_proxy('https://adwords.google.com/api/adwords/cm/v201502/DataService') if not $_[2]->{proxy};
    $_[0]->set_class_resolver('Google::Ads::AdWords::v201502::TypeMaps::DataService')
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            ...
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201502::DataService::getAdGroupBidLandscape )],
        },
        header => {
           ...
           'use' => 'literal',
            namespace => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle => '',
            parts => [qw( Google::Ads::AdWords::v201502::DataService::RequestHeader )],
        },
        headerfault => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201502::DataService::getCriterionBidLandscape )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201502::DataService::getDomainCategory )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201502::DataService::queryAdGroupBidLandscape )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201502::DataService::queryCriterionBidLandscape )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201502::DataService::queryDomainCategory )],
        },
        header => {
...
Google::Ads::AdWords::v201502::DataService::DataServiceInterfacePort - SOAP Interface for the DataService Web Service

=head1 SYNOPSIS

 use Google::Ads::AdWords::v201502::DataService::DataServiceInterfacePort;
 my $interface = Google::Ads::AdWords::v201502::DataService::DataServiceInterfacePort->new();
...
located at https://adwords.google.com/api/adwords/cm/v201502/DataService.
...
Returns a L<Google::Ads::AdWords::v201502::DataService::getAdGroupBidLandscapeResponse|Google::Ads::AdWords::v201502::DataService::getAdGroupBidLandscapeResponse> object.
...
Returns a L<Google::Ads::AdWords::v201502::DataService::getCriterionBidLandscapeResponse|Google::Ads::AdWords::v201502::DataService::getCriterionBidLandscapeResponse> object.
...
Returns a L<Google::Ads::AdWords::v201502::DataService::getDomainCategoryResponse|Google::Ads::AdWords::v201502::DataService::getDomainCategoryResponse> object.
...
Returns a L<Google::Ads::AdWords::v201502::DataService::queryAdGroupBidLandscapeResponse|Google::Ads::AdWords::v201502::DataService::queryAdGroupBidLandscapeResponse> object.
...
Returns a L<Google::Ads::AdWords::v201502::DataService::queryCriterionBidLandscapeResponse|Google::Ads::AdWords::v201502::DataService::queryCriterionBidLandscapeResponse> object.
...
Returns a L<Google::Ads::AdWords::v201502::DataService::queryDomainCategoryResponse|Google::Ads::AdWords::v201502::DataService::queryDomainCategoryResponse> object.
...
Generated by SOAP::WSDL on Fri Mar  6 16:50:44 2015
