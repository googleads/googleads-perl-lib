...
package Google::Ads::AdWords::v201502::DataService::queryCriterionBidLandscape;
use strict;
use warnings;
...
Google::Ads::AdWords::v201502::DataService::queryCriterionBidLandscape

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
queryCriterionBidLandscape from the namespace https://adwords.google.com/api/adwords/cm/v201502.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201502::DataService::queryCriterionBidLandscape->new($data);
