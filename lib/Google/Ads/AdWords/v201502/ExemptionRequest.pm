package Google::Ads::AdWords::v201502::ExemptionRequest;
use strict;
use warnings;
...
Google::Ads::AdWords::v201502::ExemptionRequest

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ExemptionRequest from the namespace https://adwords.google.com/api/adwords/cm/v201502.
