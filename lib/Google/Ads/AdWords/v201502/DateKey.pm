package Google::Ads::AdWords::v201502::DateKey;
use strict;
use warnings;
...
Google::Ads::AdWords::v201502::DateKey

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
DateKey from the namespace https://adwords.google.com/api/adwords/rm/v201502.
