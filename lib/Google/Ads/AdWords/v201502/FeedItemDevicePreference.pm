package Google::Ads::AdWords::v201502::FeedItemDevicePreference;
use strict;
use warnings;
...
Google::Ads::AdWords::v201502::FeedItemDevicePreference

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
FeedItemDevicePreference from the namespace https://adwords.google.com/api/adwords/cm/v201502.
