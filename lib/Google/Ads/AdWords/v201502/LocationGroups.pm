package Google::Ads::AdWords::v201502::LocationGroups;
use strict;
use warnings;
...
Google::Ads::AdWords::v201502::LocationGroups

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
LocationGroups from the namespace https://adwords.google.com/api/adwords/cm/v201502.
