...
package Google::Ads::AdWords::v201502::ConstantDataService::getUserInterestCriterion;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'userInterestTaxonomyType' => 'Google::Ads::AdWords::v201502::ConstantDataService::UserInterestTaxonomyType',
    },
    {
...
Google::Ads::AdWords::v201502::ConstantDataService::getUserInterestCriterion

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
getUserInterestCriterion from the namespace https://adwords.google.com/api/adwords/cm/v201502.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201502::ConstantDataService::getUserInterestCriterion->new($data);
