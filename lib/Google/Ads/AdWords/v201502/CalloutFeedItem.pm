package Google::Ads::AdWords::v201502::CalloutFeedItem;
use strict;
use warnings;
...
Google::Ads::AdWords::v201502::CalloutFeedItem

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CalloutFeedItem from the namespace https://adwords.google.com/api/adwords/cm/v201502.
