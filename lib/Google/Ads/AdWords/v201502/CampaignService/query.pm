...
package Google::Ads::AdWords::v201502::CampaignService::query;
use strict;
use warnings;
...
Google::Ads::AdWords::v201502::CampaignService::query
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201502::CampaignService::query->new($data);
