package Google::Ads::AdWords::v201502::AdGroupAdService::AdGroupAdServiceInterfacePort;
use strict;
use warnings;
...
require Google::Ads::AdWords::v201502::TypeMaps::AdGroupAdService
    if not Google::Ads::AdWords::v201502::TypeMaps::AdGroupAdService->can('get_class');

sub START {
    $_[0]->set_proxy('https://adwords.google.com/api/adwords/cm/v201502/AdGroupAdService') if not $_[2]->{proxy};
    $_[0]->set_class_resolver('Google::Ads::AdWords::v201502::TypeMaps::AdGroupAdService')
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            ...
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201502::AdGroupAdService::get )],
        },
        header => {
           ...
           'use' => 'literal',
            namespace => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle => '',
            parts => [qw( Google::Ads::AdWords::v201502::AdGroupAdService::RequestHeader )],
        },
        headerfault => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201502::AdGroupAdService::mutate )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201502::AdGroupAdService::mutateLabel )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201502::AdGroupAdService::query )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201502::AdGroupAdService::upgradeUrl )],
        },
        header => {
...
Google::Ads::AdWords::v201502::AdGroupAdService::AdGroupAdServiceInterfacePort - SOAP Interface for the AdGroupAdService Web Service

=head1 SYNOPSIS

 use Google::Ads::AdWords::v201502::AdGroupAdService::AdGroupAdServiceInterfacePort;
 my $interface = Google::Ads::AdWords::v201502::AdGroupAdService::AdGroupAdServiceInterfacePort->new();
...
located at https://adwords.google.com/api/adwords/cm/v201502/AdGroupAdService.
...
Returns a L<Google::Ads::AdWords::v201502::AdGroupAdService::getResponse|Google::Ads::AdWords::v201502::AdGroupAdService::getResponse> object.
...
Returns a L<Google::Ads::AdWords::v201502::AdGroupAdService::mutateResponse|Google::Ads::AdWords::v201502::AdGroupAdService::mutateResponse> object.
...
Returns a L<Google::Ads::AdWords::v201502::AdGroupAdService::mutateLabelResponse|Google::Ads::AdWords::v201502::AdGroupAdService::mutateLabelResponse> object.

 $response = $interface->mutateLabel( {
    operations =>  $a_reference_to, # see Google::Ads::AdWords::v201502::AdGroupAdLabelOperation
  },,
 );
...
Returns a L<Google::Ads::AdWords::v201502::AdGroupAdService::queryResponse|Google::Ads::AdWords::v201502::AdGroupAdService::queryResponse> object.
...
Returns a L<Google::Ads::AdWords::v201502::AdGroupAdService::upgradeUrlResponse|Google::Ads::AdWords::v201502::AdGroupAdService::upgradeUrlResponse> object.

 $response = $interface->upgradeUrl( {
    operations =>  $a_reference_to, # see Google::Ads::AdWords::v201502::AdUrlUpgrade
  },,
 );
...
Generated by SOAP::WSDL on Fri Mar  6 16:49:15 2015
