package Google::Ads::AdWords::v201502::UrlList;
use strict;
use warnings;
...
Google::Ads::AdWords::v201502::UrlList

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
UrlList from the namespace https://adwords.google.com/api/adwords/cm/v201502.
