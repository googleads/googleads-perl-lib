package Google::Ads::AdWords::v201502::OAuthInfo;
use strict;
use warnings;
...
Google::Ads::AdWords::v201502::OAuthInfo

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
OAuthInfo from the namespace https://adwords.google.com/api/adwords/cm/v201502.
