package Google::Ads::AdWords::v201502::ProductTypeFull;
use strict;
use warnings;
...
Google::Ads::AdWords::v201502::ProductTypeFull

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ProductTypeFull from the namespace https://adwords.google.com/api/adwords/cm/v201502.
