package Google::Ads::AdWords::v201306::MobileApplication;
use strict;
use warnings;
...
Google::Ads::AdWords::v201306::MobileApplication

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
MobileApplication from the namespace https://adwords.google.com/api/adwords/cm/v201306.
