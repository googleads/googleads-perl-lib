package Google::Ads::AdWords::v201306::ExperimentService::ExperimentServiceInterfacePort;
use strict;
use warnings;
...
require Google::Ads::AdWords::v201306::TypeMaps::ExperimentService
    if not Google::Ads::AdWords::v201306::TypeMaps::ExperimentService->can('get_class');

sub START {
    $_[0]->set_proxy('https://adwords.google.com/api/adwords/cm/v201306/ExperimentService') if not $_[2]->{proxy};
    $_[0]->set_class_resolver('Google::Ads::AdWords::v201306::TypeMaps::ExperimentService')
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            ...
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201306::ExperimentService::get )],
        },
        header => {
           ...
           'use' => 'literal',
            namespace => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle => '',
            parts => [qw( Google::Ads::AdWords::v201306::ExperimentService::RequestHeader )],
        },
        headerfault => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201306::ExperimentService::mutate )],
        },
        header => {
...
located at https://adwords.google.com/api/adwords/cm/v201306/ExperimentService.
...
Returns a L<Google::Ads::AdWords::v201306::ExperimentService::getResponse|Google::Ads::AdWords::v201306::ExperimentService::getResponse> object.
...
Returns a L<Google::Ads::AdWords::v201306::ExperimentService::mutateResponse|Google::Ads::AdWords::v201306::ExperimentService::mutateResponse> object.
