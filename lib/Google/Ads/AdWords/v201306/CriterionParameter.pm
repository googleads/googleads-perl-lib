package Google::Ads::AdWords::v201306::CriterionParameter;
use strict;
use warnings;
...
Google::Ads::AdWords::v201306::CriterionParameter

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CriterionParameter from the namespace https://adwords.google.com/api/adwords/cm/v201306.
