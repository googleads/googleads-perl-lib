package Google::Ads::AdWords::v201306::FeedItemAttributeError;
use strict;
use warnings;
...
Google::Ads::AdWords::v201306::FeedItemAttributeError

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
FeedItemAttributeError from the namespace https://adwords.google.com/api/adwords/cm/v201306.
