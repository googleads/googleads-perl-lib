package Google::Ads::AdWords::v201306::AdSpec;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'DisplayAdSpec' => 'Google::Ads::AdWords::v201306::DisplayAdSpec',
        'InStreamAdSpec' => 'Google::Ads::AdWords::v201306::InStreamAdSpec',
        'TextAdSpec' => 'Google::Ads::AdWords::v201306::TextAdSpec',
    },
    {
...
Google::Ads::AdWords::v201306::AdSpec

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdSpec from the namespace https://adwords.google.com/api/adwords/o/v201306.
