package Google::Ads::AdWords::v201306::AdExtension;
use strict;
use warnings;
...
Google::Ads::AdWords::v201306::AdExtension

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
AdExtension from the namespace https://adwords.google.com/api/adwords/cm/v201306.
