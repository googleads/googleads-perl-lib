package Google::Ads::AdWords::v201306::CampaignStats;
use strict;
use warnings;
...
Google::Ads::AdWords::v201306::CampaignStats

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CampaignStats from the namespace https://adwords.google.com/api/adwords/cm/v201306.
