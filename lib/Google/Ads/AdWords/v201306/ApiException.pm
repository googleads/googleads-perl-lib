package Google::Ads::AdWords::v201306::ApiException;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201306::ApplicationException);
# Variety: sequence
...
ApiException from the namespace https://adwords.google.com/api/adwords/cm/v201306.
