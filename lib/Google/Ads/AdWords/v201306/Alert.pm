package Google::Ads::AdWords::v201306::Alert;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'alertSeverity' => 'Google::Ads::AdWords::v201306::AlertSeverity',
        'alertType' => 'Google::Ads::AdWords::v201306::AlertType',
        'clientCustomerId' => 'SOAP::WSDL::XSD::Typelib::Builtin::long',
        'details' => 'Google::Ads::AdWords::v201306::Detail',
    },
    {
...
Google::Ads::AdWords::v201306::Alert

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
Alert from the namespace https://adwords.google.com/api/adwords/mcm/v201306.
