package Google::Ads::AdWords::v201306::Customer;
use strict;
use warnings;
...
Google::Ads::AdWords::v201306::Customer

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
Customer from the namespace https://adwords.google.com/api/adwords/mcm/v201306.
