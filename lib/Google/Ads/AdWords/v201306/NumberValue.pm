package Google::Ads::AdWords::v201306::NumberValue;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201306::ComparableValue);
# Variety: sequence
...
Google::Ads::AdWords::v201306::NumberValue

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
NumberValue from the namespace https://adwords.google.com/api/adwords/cm/v201306.
