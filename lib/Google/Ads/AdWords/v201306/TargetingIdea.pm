package Google::Ads::AdWords::v201306::TargetingIdea;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'data' => 'Google::Ads::AdWords::v201306::Type_AttributeMapEntry',
    },
    {
...
Google::Ads::AdWords::v201306::TargetingIdea

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
TargetingIdea from the namespace https://adwords.google.com/api/adwords/o/v201306.
