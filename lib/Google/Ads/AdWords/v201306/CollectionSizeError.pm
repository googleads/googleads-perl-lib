package Google::Ads::AdWords::v201306::CollectionSizeError;
use strict;
use warnings;
...
Google::Ads::AdWords::v201306::CollectionSizeError

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CollectionSizeError from the namespace https://adwords.google.com/api/adwords/cm/v201306.
