package Google::Ads::AdWords::v201306::Attribute;
use strict;
use warnings;
...
Google::Ads::AdWords::v201306::Attribute

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
Attribute from the namespace https://adwords.google.com/api/adwords/o/v201306.
