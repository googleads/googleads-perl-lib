package Google::Ads::AdWords::v201306::SeedAdGroupIdSearchParameter;
use strict;
use warnings;
...
Google::Ads::AdWords::v201306::SeedAdGroupIdSearchParameter

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
SeedAdGroupIdSearchParameter from the namespace https://adwords.google.com/api/adwords/o/v201306.

A {@link SearchParameter} for {@code KEYWORD} {@link IdeaType}s that specifies that the supplied AdGroup should be used as a seed for generating new ideas. For example, an AdGroup's keywords would be used to generate new and related keywords. <p>This element is supported by following {@link IdeaType}s: KEYWORD. <p>This element is supported by following {@link RequestType}s: IDEAS, STATS. 
