package Google::Ads::AdWords::v201306::SharedCriterion;
use strict;
use warnings;
...
Google::Ads::AdWords::v201306::SharedCriterion

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
SharedCriterion from the namespace https://adwords.google.com/api/adwords/cm/v201306.
