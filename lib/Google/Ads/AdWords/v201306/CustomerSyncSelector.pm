package Google::Ads::AdWords::v201306::CustomerSyncSelector;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'dateTimeRange' => 'Google::Ads::AdWords::v201306::DateTimeRange',
...
Google::Ads::AdWords::v201306::CustomerSyncSelector

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
CustomerSyncSelector from the namespace https://adwords.google.com/api/adwords/ch/v201306.
