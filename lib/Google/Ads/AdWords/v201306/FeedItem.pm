package Google::Ads::AdWords::v201306::FeedItem;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'status' => 'Google::Ads::AdWords::v201306::FeedItem::Status',
        'startTime' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'endTime' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'attributeValues' => 'Google::Ads::AdWords::v201306::FeedItemAttributeValue',
        'validationDetails' => 'Google::Ads::AdWords::v201306::FeedItemValidationDetail',
        'devicePreference' => 'Google::Ads::AdWords::v201306::FeedItemDevicePreference',
        'scheduling' => 'Google::Ads::AdWords::v201306::FeedItemScheduling',
    },
    {
...
Google::Ads::AdWords::v201306::FeedItem

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
FeedItem from the namespace https://adwords.google.com/api/adwords/cm/v201306.
