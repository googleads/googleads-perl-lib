package Google::Ads::AdWords::v201306::ManualCPMAdGroupExperimentBidMultipliers;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'maxCpmMultiplier' => 'Google::Ads::AdWords::v201306::BidMultiplier',
    },
    {
...
Google::Ads::AdWords::v201306::ManualCPMAdGroupExperimentBidMultipliers

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ManualCPMAdGroupExperimentBidMultipliers from the namespace https://adwords.google.com/api/adwords/cm/v201306.
