package Google::Ads::AdWords::v201306::AdGroupCriterionService::AdGroupCriterionServiceInterfacePort;
use strict;
use warnings;
...
require Google::Ads::AdWords::v201306::TypeMaps::AdGroupCriterionService
    if not Google::Ads::AdWords::v201306::TypeMaps::AdGroupCriterionService->can('get_class');

sub START {
    $_[0]->set_proxy('https://adwords.google.com/api/adwords/cm/v201306/AdGroupCriterionService') if not $_[2]->{proxy};
    $_[0]->set_class_resolver('Google::Ads::AdWords::v201306::TypeMaps::AdGroupCriterionService')
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            ...
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201306::AdGroupCriterionService::get )],
        },
        header => {
           ...
           'use' => 'literal',
            namespace => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle => '',
            parts => [qw( Google::Ads::AdWords::v201306::AdGroupCriterionService::RequestHeader )],
        },
        headerfault => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201306::AdGroupCriterionService::mutate )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( Google::Ads::AdWords::v201306::AdGroupCriterionService::query )],
        },
        header => {
...
located at https://adwords.google.com/api/adwords/cm/v201306/AdGroupCriterionService.
...
Returns a L<Google::Ads::AdWords::v201306::AdGroupCriterionService::getResponse|Google::Ads::AdWords::v201306::AdGroupCriterionService::getResponse> object.
...
Returns a L<Google::Ads::AdWords::v201306::AdGroupCriterionService::mutateResponse|Google::Ads::AdWords::v201306::AdGroupCriterionService::mutateResponse> object.
...
Returns a L<Google::Ads::AdWords::v201306::AdGroupCriterionService::queryResponse|Google::Ads::AdWords::v201306::AdGroupCriterionService::queryResponse> object.
