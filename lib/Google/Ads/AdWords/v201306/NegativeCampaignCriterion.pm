package Google::Ads::AdWords::v201306::NegativeCampaignCriterion;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201306::CampaignCriterion);
# Variety: sequence
...
NegativeCampaignCriterion from the namespace https://adwords.google.com/api/adwords/cm/v201306.
