package Google::Ads::AdWords::v201306::ConversionOptimizerEligibility;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'rejectionReasons' => 'Google::Ads::AdWords::v201306::ConversionOptimizerEligibility::RejectionReason',
    },
    {
...
Google::Ads::AdWords::v201306::ConversionOptimizerEligibility

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ConversionOptimizerEligibility from the namespace https://adwords.google.com/api/adwords/cm/v201306.
