...
package Google::Ads::AdWords::v201306::CampaignService::query;
use strict;
use warnings;
...
Google::Ads::AdWords::v201306::CampaignService::query
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201306::CampaignService::query->new($data);
