package Google::Ads::AdWords::v201306::BulkMutateJob;
use strict;
use warnings;
...
use base qw(Google::Ads::AdWords::v201306::Job);
# Variety: sequence
...
__PACKAGE__->_factory(
    ...
    {
        'failureReason' => 'Google::Ads::AdWords::v201306::ApiErrorReason',
        'stats' => 'Google::Ads::AdWords::v201306::JobStats',
        'billingSummary' => 'Google::Ads::AdWords::v201306::BillingSummary',
        'Job__Type' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
        'id' => 'SOAP::WSDL::XSD::Typelib::Builtin::long',
        'policy' => 'Google::Ads::AdWords::v201306::BulkMutateJobPolicy',
        'request' => 'Google::Ads::AdWords::v201306::BulkMutateRequest',
        'status' => 'Google::Ads::AdWords::v201306::BasicJobStatus',
        'history' => 'Google::Ads::AdWords::v201306::BulkMutateJobEvent',
        'result' => 'Google::Ads::AdWords::v201306::BulkMutateResult',
...
Google::Ads::AdWords::v201306::BulkMutateJob

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
BulkMutateJob from the namespace https://adwords.google.com/api/adwords/cm/v201306.
