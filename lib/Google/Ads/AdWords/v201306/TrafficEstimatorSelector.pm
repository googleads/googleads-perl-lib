package Google::Ads::AdWords::v201306::TrafficEstimatorSelector;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'campaignEstimateRequests' => 'Google::Ads::AdWords::v201306::CampaignEstimateRequest',
    },
    {
...
Google::Ads::AdWords::v201306::TrafficEstimatorSelector

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
TrafficEstimatorSelector from the namespace https://adwords.google.com/api/adwords/o/v201306.
