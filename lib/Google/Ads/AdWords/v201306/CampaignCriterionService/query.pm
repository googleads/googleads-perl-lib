...
package Google::Ads::AdWords::v201306::CampaignCriterionService::query;
use strict;
use warnings;
...
Google::Ads::AdWords::v201306::CampaignCriterionService::query

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
query from the namespace https://adwords.google.com/api/adwords/cm/v201306.
...
=head2 new
 ...
 my $element = Google::Ads::AdWords::v201306::CampaignCriterionService::query->new($data);
