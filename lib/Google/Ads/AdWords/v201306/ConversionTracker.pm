package Google::Ads::AdWords::v201306::ConversionTracker;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'status' => 'Google::Ads::AdWords::v201306::ConversionTracker::Status',
        'category' => 'Google::Ads::AdWords::v201306::ConversionTracker::Category',
        'stats' => 'Google::Ads::AdWords::v201306::ConversionTrackerStats',
...
Google::Ads::AdWords::v201306::ConversionTracker

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ConversionTracker from the namespace https://adwords.google.com/api/adwords/cm/v201306.
