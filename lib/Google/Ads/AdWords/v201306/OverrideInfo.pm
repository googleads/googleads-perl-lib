package Google::Ads::AdWords::v201306::OverrideInfo;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'LocationOverrideInfo' => 'Google::Ads::AdWords::v201306::LocationOverrideInfo',
    },
    {
...
Google::Ads::AdWords::v201306::OverrideInfo

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
OverrideInfo from the namespace https://adwords.google.com/api/adwords/cm/v201306.
