...
package Google::Ads::AdWords::v201306::ReportDefinitionService::getReportFields;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'reportType' => 'Google::Ads::AdWords::v201306::ReportDefinition::ReportType',
    },
    {
...
getReportFields from the namespace https://adwords.google.com/api/adwords/cm/v201306.
