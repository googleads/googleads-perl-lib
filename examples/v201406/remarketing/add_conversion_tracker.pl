...
use Google::Ads::AdWords::v201406::AdWordsConversionTracker;
use Google::Ads::AdWords::v201406::ConversionTrackerOperation;
...
sub add_conversion_tracker {
  ...
  my $conversion_tracker =
      Google::Ads::AdWords::v201406::AdWordsConversionTracker->new({
  ...
  my $conversion_operation =
      Google::Ads::AdWords::v201406::ConversionTrackerOperation->new({
        operator => "ADD",
