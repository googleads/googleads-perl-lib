...
use Google::Ads::AdWords::v201406::AdGroupCriterion;
use Google::Ads::AdWords::v201406::AdGroupCriterionOperation;
use Google::Ads::AdWords::v201406::BiddableAdGroupCriterion;
use Google::Ads::AdWords::v201406::BulkMutateJobPolicy;
use Google::Ads::AdWords::v201406::BulkMutateJobSelector;
...
sub add_keywords_in_bulk {
  ...
  my $job = $client->MutateJobService()->mutate({
        ...
        policy => Google::Ads::AdWords::v201406::BulkMutateJobPolicy->new({
  ...
  my $job_selector = Google::Ads::AdWords::v201406::BulkMutateJobSelector->new({
    jobIds => [$job_id],
    includeStats => 1,
    includeHistory => 1
  });
