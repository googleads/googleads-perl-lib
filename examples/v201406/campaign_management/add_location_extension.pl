...
use Google::Ads::AdWords::v201406::Address;
use Google::Ads::AdWords::v201406::CampaignAdExtension;
use Google::Ads::AdWords::v201406::CampaignAdExtensionOperation;
use Google::Ads::AdWords::v201406::GeoLocationSelector;
use Google::Ads::AdWords::v201406::LocationExtension;
...
sub add_location_extension {
  ...
  # Create address.
  my $address = Google::Ads::AdWords::v201406::Address->new({
  ...
  my $selector = Google::Ads::AdWords::v201406::GeoLocationSelector->new({
    addresses => [$address]
  });
  ...
  my $location_extension =
      Google::Ads::AdWords::v201406::LocationExtension->new({
  ...
  my $campaign_location_ad_extension =
      Google::Ads::AdWords::v201406::CampaignAdExtension->new({
  ...
  # Create operation.
  my $operation =
      Google::Ads::AdWords::v201406::CampaignAdExtensionOperation->new({
