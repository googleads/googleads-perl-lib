...
use Google::Ads::AdWords::v201406::AdGroup;
...
use Google::Ads::AdWords::v201406::AdGroupExperimentData;
use Google::Ads::AdWords::v201406::AdGroupOperation;
use Google::Ads::AdWords::v201406::BidMultiplier;
use Google::Ads::AdWords::v201406::BiddableAdGroupCriterion;
use Google::Ads::AdWords::v201406::BiddableAdGroupCriterionExperimentData;
use Google::Ads::AdWords::v201406::Criterion;
use Google::Ads::AdWords::v201406::Experiment;
use Google::Ads::AdWords::v201406::ExperimentOperation;
use Google::Ads::AdWords::v201406::ManualCPCAdGroupCriterionExperimentBidMultiplier;
use Google::Ads::AdWords::v201406::ManualCPCAdGroupExperimentBidMultipliers;
...
sub add_experiment {
  ...
  my $end_time = sprintf("%d%02d%02d %02d%02d%02d", ($year + 1900),
      ($mon + 1), $mday, $hour, $min, $sec);
  my $experiment = Google::Ads::AdWords::v201406::Experiment->new({
  ...
  my $experiment_operation =
      Google::Ads::AdWords::v201406::ExperimentOperation->new({
        operator => "ADD",
        operand => $experiment
      });
  ...
  # experiment.
  my $bid_multiplier =
      Google::Ads::AdWords::v201406::ManualCPCAdGroupExperimentBidMultipliers->
          new({
            maxCpcMultiplier => Google::Ads::AdWords::v201406::BidMultiplier->
                new({
                  multiplier => 1.5
                })
          });
  ...
  my $experiment_data =
      Google::Ads::AdWords::v201406::AdGroupExperimentData->new({
  ...
  # Create operation.
  my $operation = Google::Ads::AdWords::v201406::AdGroupOperation->new({
    operand => $ad_group,
    operator => "SET"
  });
  ...
  my $criterion = Google::Ads::AdWords::v201406::Criterion->new({
    id => $criterion_id,
  });
  ...
  # experiment.
  $bid_multiplier =
      Google::Ads::AdWords::v201406::ManualCPCAdGroupCriterionExperimentBidMultiplier->new({
        maxCpcMultiplier => Google::Ads::AdWords::v201406::BidMultiplier->new({
          multiplier => 1.5
        })
      });
  ...
  $experiment_data =
      Google::Ads::AdWords::v201406::BiddableAdGroupCriterionExperimentData->
          new({
            experimentId => $experiment_id,
            experimentDeltaStatus => "MODIFIED",
