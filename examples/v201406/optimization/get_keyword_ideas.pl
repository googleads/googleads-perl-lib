...
use Google::Ads::AdWords::v201406::LanguageSearchParameter;
use Google::Ads::AdWords::Logging;
use Google::Ads::AdWords::v201406::Paging;
use Google::Ads::AdWords::v201406::RelatedToQuerySearchParameter;
use Google::Ads::AdWords::v201406::TargetingIdeaSelector;
...
sub get_keyword_ideas {
  ...
  # Create selector.
  my $selector = Google::Ads::AdWords::v201406::TargetingIdeaSelector->new({
    requestType => "IDEAS",
    ideaType => "KEYWORD",
  ...
  my $paging = Google::Ads::AdWords::v201406::Paging->new({
    startIndex => 0,
    numberResults => 10
  });
  ...
  my $query_search_parameter =
      Google::Ads::AdWords::v201406::RelatedToQuerySearchParameter->new({
        queries => [$seed_query]
      });
  ...
  my $language_english = Google::Ads::AdWords::v201406::Language->new({
    id => 1000
  });
  my $language_search_parameter =
      Google::Ads::AdWords::v201406::LanguageSearchParameter->new({
