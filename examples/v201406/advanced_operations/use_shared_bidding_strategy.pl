...
use Google::Ads::AdWords::v201406::SharedBiddingStrategy;
use Google::Ads::AdWords::v201406::TargetSpendBiddingScheme;
use Google::Ads::AdWords::v201406::Money;
use Google::Ads::AdWords::v201406::BiddingStrategyOperation;
use Google::Ads::AdWords::v201406::BudgetOperation;
use Google::Ads::AdWords::v201406::KeywordMatchSetting;
use Google::Ads::AdWords::v201406::NetworkSetting;
use Google::Ads::AdWords::v201406::CampaignOperation;
...
sub create_bidding_strategy {
  ...
  my $bidding_strategy =
      Google::Ads::AdWords::v201406::SharedBiddingStrategy->new({
        name => "Maximize Clicks " . uniqid(),
        type => "TARGET_SPEND",

        # Create the bidding scheme.
        biddingScheme =>
            Google::Ads::AdWords::v201406::TargetSpendBiddingScheme->new({
              # Optionally set additional bidding scheme parameters.
              bidCeiling => Google::Ads::AdWords::v201406::Money->new({
                microAmount => 2000000,
              }),
              spendTarget => Google::Ads::AdWords::v201406::Money->new({
  ...
  # Create operation.
  my $operation =
      Google::Ads::AdWords::v201406::BiddingStrategyOperation->new({
        operator => "ADD",
...
sub create_shared_budget {
  ...
  my $operation = Google::Ads::AdWords::v201406::BudgetOperation->new({
    operator => 'ADD',
    operand => Google::Ads::AdWords::v201406::Budget->new({
      period => 'DAILY',
      amount => Google::Ads::AdWords::v201406::Money->new({
...
sub create_campaign_with_bidding_strategy {
  ...
  my $campaign = Google::Ads::AdWords::v201406::Campaign->new({
    ...
    budget => Google::Ads::AdWords::v201406::Budget->new({
      budgetId => $budget_id
    }),
    ...
    settings => [
        Google::Ads::AdWords::v201406::KeywordMatchSetting->new({
          optIn => 0
        })
    ],
    ...
    networkSetting => Google::Ads::AdWords::v201406::NetworkSetting->new({
  ...
  # Create operation.
  my $operation = Google::Ads::AdWords::v201406::CampaignOperation->new({
    operator => 'ADD',
    operand => $campaign
  });
