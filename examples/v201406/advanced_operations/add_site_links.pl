...
use Google::Ads::AdWords::v201406::CampaignFeed;
use Google::Ads::AdWords::v201406::CampaignFeedOperation;
...
sub create_site_links_feed() {
  ...
  my $text_attribute = Google::Ads::AdWords::v201406::FeedAttribute->new({
    type => "STRING",
    name => "Link Text"
  });
  my $url_attribute = Google::Ads::AdWords::v201406::FeedAttribute->new({
    type => "URL",
    name => "Link URL"
  });
  my $line_1_attribute = Google::Ads::AdWords::v201406::FeedAttribute->new({
    type => "STRING",
    name => "Line 1 Description"
  });
  my $line_2_attribute = Google::Ads::AdWords::v201406::FeedAttribute->new({
    type => "STRING",
...
sub create_site_links_campaign_feed() {
  ...
  my $request_context_operand =
    Google::Ads::AdWords::v201406::RequestContextOperand->new({
  ...
  my $feed_item_function = Google::Ads::AdWords::v201406::Function->new({
  ...
  my $platform_operand = Google::Ads::AdWords::v201406::ConstantOperand->new({
    stringValue => "Mobile",
    type => "STRING"
  });

  my $platform_function = Google::Ads::AdWords::v201406::Function->new({
  ...
  my $feed_item_function_operand =
    Google::Ads::AdWords::v201406::FunctionOperand->new({
  ...
  my $combined_function = Google::Ads::AdWords::v201406::Function->new({
    lhsOperand => [ $feed_item_function_operand, $platform_function_operand ],
    operator => "AND"
  });

  my $campaign_feed = Google::Ads::AdWords::v201406::CampaignFeed->new({
    feedId => $site_links_data->{"siteLinksFeedId"},
  ...
  my $result = $client->CampaignFeedService()->mutate({
    operations => [
      Google::Ads::AdWords::v201406::CampaignFeedOperation->new({
