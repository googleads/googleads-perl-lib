...
use Google::Ads::AdWords::v201406::CustomParameter;
use Google::Ads::AdWords::v201406::CustomParameters;
use Google::Ads::AdWords::v201406::Image;
use Google::Ads::AdWords::v201406::ImageAd;
use Google::Ads::AdWords::v201406::TemplateAd;
use Google::Ads::AdWords::v201406::TextAd;
use Google::Ads::AdWords::v201406::Video;
...
sub add_text_ad_with_upgraded_urls {
  ...
  # or feed item levels.
  my $season_parameter = Google::Ads::AdWords::v201406::CustomParameter->new({
      key => "season",
      value => "christmas"
  });
  my $promo_code_parameter =
      Google::Ads::AdWords::v201406::CustomParameter->new({
          key => "promocode",
          value => "NYC123"
      });
  my $tracking_url_parameters =
      Google::Ads::AdWords::v201406::CustomParameters->new({
  ...
  my $text_ad_group_ad = Google::Ads::AdWords::v201406::AdGroupAd->new({
