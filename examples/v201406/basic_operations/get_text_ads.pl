...
use Google::Ads::AdWords::v201406::OrderBy;
use Google::Ads::AdWords::v201406::Paging;
use Google::Ads::AdWords::v201406::Predicate;
use Google::Ads::AdWords::v201406::Selector;
...
sub get_text_ads {
  ...
  # Create predicates.
  my $ad_group_predicate = Google::Ads::AdWords::v201406::Predicate->new({
    field => "AdGroupId",
    operator => "IN",
    values => [$ad_group_id]
  });
  my $status_predicate = Google::Ads::AdWords::v201406::Predicate->new({
    field => "Status",
    operator => "IN",
    values => ["ENABLED", "PAUSED", "DISABLED"]
  });
  my $ad_type_predicate = Google::Ads::AdWords::v201406::Predicate->new({
    field => "AdType",
    operator => "EQUALS",
    values => ["TEXT_AD"]
  });
  ...
  my $selector = Google::Ads::AdWords::v201406::Selector->new({
    fields => ["Id", "Status", "Headline", "Description1", "Description2",
               "DisplayUrl"],
    predicates => [$ad_group_predicate, $status_predicate],
    ordering => [Google::Ads::AdWords::v201406::OrderBy->new({
      field => "Id",
      sortOrder => "ASCENDING"
    })],
    paging => $paging
