...
use Google::Ads::AdWords::v201406::Campaign;
use Google::Ads::AdWords::v201406::CampaignOperation;
use Google::Ads::AdWords::v201406::FrequencyCap;
use Google::Ads::AdWords::v201406::GeoTargetTypeSetting;
use Google::Ads::AdWords::v201406::KeywordMatchSetting;
use Google::Ads::AdWords::v201406::ManualCpcBiddingScheme;
...
sub add_campaigns {
  ...
  my $ budget = Google::Ads::AdWords::v201406::Budget->new({
    # Required attributes.
  ...
  my $budget_operation = Google::Ads::AdWords::v201406::BudgetOperation->new({
    operator => "ADD",
    operand => $budget
  });
  ...
  for (my $i = 0; $i < $num_campaigns; $i++) {
    ...
    my $campaign = Google::Ads::AdWords::v201406::Campaign->new({
      ...
      frequencyCap => Google::Ads::AdWords::v201406::FrequencyCap->new({
        impressions => 5,
        timeUnit => "DAY",
        level => "ADGROUP"
      }),
      settings => [
          ...
          Google::Ads::AdWords::v201406::GeoTargetTypeSetting->new({
    ...
    my $campaign_operation =
        Google::Ads::AdWords::v201406::CampaignOperation->new({
          operator => "ADD",
          operand => $campaign
        });
