...
use Google::Ads::AdWords::v201406::AdGroupCriterionOperation;
use Google::Ads::AdWords::v201406::BiddableAdGroupCriterion;
use Google::Ads::AdWords::v201406::BiddingStrategyConfiguration;
use Google::Ads::AdWords::v201406::CpcBid;
use Google::Ads::AdWords::v201406::Criterion;
use Google::Ads::AdWords::v201406::Money;
use Google::Ads::AdWords::v201406::NegativeAdGroupCriterion;
use Google::Ads::AdWords::v201406::ProductBiddingCategory;
use Google::Ads::AdWords::v201406::ProductCanonicalCondition;
use Google::Ads::AdWords::v201406::ProductBrand;
use Google::Ads::AdWords::v201406::ProductPartition;
...
sub add_product_partition_tree {
  ...
  create_unit($operations, $ad_group_id, $root,
    Google::Ads::AdWords::v201406::ProductCanonicalCondition->new({
      condition => "NEW"
    }),
    200000);
  ...
  my $other_condition = create_subdivision($operations, $next_id--,
    $ad_group_id, $root,
    Google::Ads::AdWords::v201406::ProductCanonicalCondition->new());

  create_unit($operations, $ad_group_id, $other_condition,
    Google::Ads::AdWords::v201406::ProductBrand->new({
      value => "CoolBrand"
    }),
    900000);
  ...
  my $other_brand = create_subdivision($operations, $next_id--,
    $ad_group_id, $other_condition,
    Google::Ads::AdWords::v201406::ProductBrand->new());

  # The value for the bidding category is a fixed ID for the 'Luggage & Bags'
  # category. You can retrieve IDs for categories from the ConstantDataService.
  # See the 'get_product_category_taxonomy' example for more details.
  create_unit($operations, $ad_group_id, $other_brand,
    Google::Ads::AdWords::v201406::ProductBiddingCategory->new({
  ...
  foreach my $ad_group_criterion (@{$result->get_value()}) {
    ...
    my $parent_criterion_id = $ad_group_criterion->get_criterion()->
      get_parentCriterionId();
    if ($parent_criterion_id) {
      push $children->{$parent_criterion_id}, $ad_group_criterion->
        get_criterion();
    } else {
...
sub create_subdivision {
  ...
  my $division = Google::Ads::AdWords::v201406::ProductPartition->new({
  ...
  my $criterion =
    Google::Ads::AdWords::v201406::BiddableAdGroupCriterion->new({
...
sub create_unit {
  ...
  my $unit = Google::Ads::AdWords::v201406::ProductPartition->new({
    partitionType => "UNIT",
  });
  ...
  if ($bid_amount && $bid_amount > 0) {
    my $biddingStrategyConfiguration =
      Google::Ads::AdWords::v201406::BiddingStrategyConfiguration->new({
        bids => [
          Google::Ads::AdWords::v201406::CpcBid->new({
            bid => Google::Ads::AdWords::v201406::Money->new({
    ...
    $criterion = Google::Ads::AdWords::v201406::NegativeAdGroupCriterion->new();
  }
...
sub create_add_operation {
  ...
  my $operation =
    Google::Ads::AdWords::v201406::AdGroupCriterionOperation->new({
