...
use Google::Ads::AdWords::v201406::ManagedCustomer;
use Google::Ads::AdWords::v201406::ManagedCustomerOperation;
...
sub create_account {
  ...
  my $account = Google::Ads::AdWords::v201406::ManagedCustomer->new({
  ...
  my $operation = Google::Ads::AdWords::v201406::ManagedCustomerOperation->new({
    operator        => "ADD",
    operand         => $account
  });
