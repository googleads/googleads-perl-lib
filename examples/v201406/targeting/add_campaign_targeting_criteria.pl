...
use Google::Ads::AdWords::v201406::CampaignCriterionOperation;
use Google::Ads::AdWords::v201406::ConstantOperand;
use Google::Ads::AdWords::v201406::Function;
use Google::Ads::AdWords::v201406::GeoTargetOperand;
use Google::Ads::AdWords::v201406::IncomeOperand;
use Google::Ads::AdWords::v201406::Language;
use Google::Ads::AdWords::v201406::Location;
use Google::Ads::AdWords::v201406::LocationExtensionOperand;
use Google::Ads::AdWords::v201406::LocationGroups;
use Google::Ads::AdWords::v201406::PlacesOfInterestOperand;
...
sub add_campaign_targeting_criteria {
  ...
  my $california = Google::Ads::AdWords::v201406::Location->new({
    id => 21137
  });
  push @criteria, $california;
  my $mexico = Google::Ads::AdWords::v201406::Location->new({
    id => 2484 # Mexico
  });
  ...
  my $english = Google::Ads::AdWords::v201406::Language->new({
    id => 1000
  });
  push @criteria, $english;
  my $spanish = Google::Ads::AdWords::v201406::Language->new({
    id => 1003
  });
  ...
  my $income = Google::Ads::AdWords::v201406::LocationGroups->new({
    matchingFunction => Google::Ads::AdWords::v201406::Function->new({
      operator => "AND",
      lhsOperand => Google::Ads::AdWords::v201406::IncomeOperand->new({
      ...
      rhsOperand => Google::Ads::AdWords::v201406::GeoTargetOperand->new({
  ...
  my $placesOfInterest = Google::Ads::AdWords::v201406::LocationGroups->new({
    matchingFunction => Google::Ads::AdWords::v201406::Function->new({
      operator => "AND",
      lhsOperand => Google::Ads::AdWords::v201406::PlacesOfInterestOperand->new({
  ...
  my $radius = Google::Ads::AdWords::v201406::ConstantOperand->new({
    type => "DOUBLE",
    unit => "MILES",
    doubleValue => 10.0
  });
  my $radiusLocationGroup = Google::Ads::AdWords::v201406::LocationGroups->new({
    matchingFunction => Google::Ads::AdWords::v201406::Function->new({
      operator => "IDENTITY",
      lhsOperand => Google::Ads::AdWords::v201406::LocationExtensionOperand->new({
        radius => $radius
      })
    })
  });
  ...
  foreach my $criterion (@criteria) {
    my $operation =
        Google::Ads::AdWords::v201406::CampaignCriterionOperation->new({
          operator => "ADD",
          operand => Google::Ads::AdWords::v201406::CampaignCriterion->new({
