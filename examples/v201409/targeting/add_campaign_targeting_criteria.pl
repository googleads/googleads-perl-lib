...
use Google::Ads::AdWords::v201409::CampaignCriterionOperation;
use Google::Ads::AdWords::v201409::ConstantOperand;
use Google::Ads::AdWords::v201409::Function;
use Google::Ads::AdWords::v201409::GeoTargetOperand;
use Google::Ads::AdWords::v201409::IncomeOperand;
use Google::Ads::AdWords::v201409::Language;
use Google::Ads::AdWords::v201409::Location;
use Google::Ads::AdWords::v201409::LocationExtensionOperand;
use Google::Ads::AdWords::v201409::LocationGroups;
use Google::Ads::AdWords::v201409::PlacesOfInterestOperand;
use Google::Ads::AdWords::v201409::Platform;
...
sub add_campaign_targeting_criteria {
  ...
  my $california = Google::Ads::AdWords::v201409::Location->new({
    id => 21137
  });
  push @criteria, $california;
  my $mexico = Google::Ads::AdWords::v201409::Location->new({
    id => 2484 # Mexico
  });
  ...
  my $english = Google::Ads::AdWords::v201409::Language->new({
    id => 1000
  });
  push @criteria, $english;
  my $spanish = Google::Ads::AdWords::v201409::Language->new({
    id => 1003
  });
  ...
  my $income = Google::Ads::AdWords::v201409::LocationGroups->new({
    matchingFunction => Google::Ads::AdWords::v201409::Function->new({
      operator => "AND",
      lhsOperand => Google::Ads::AdWords::v201409::IncomeOperand->new({
      ...
      rhsOperand => Google::Ads::AdWords::v201409::GeoTargetOperand->new({
  ...
  my $placesOfInterest = Google::Ads::AdWords::v201409::LocationGroups->new({
    matchingFunction => Google::Ads::AdWords::v201409::Function->new({
      operator => "AND",
      lhsOperand => Google::Ads::AdWords::v201409::PlacesOfInterestOperand->new({
  ...
  my $radius = Google::Ads::AdWords::v201409::ConstantOperand->new({
    type => "DOUBLE",
    unit => "MILES",
    doubleValue => 10.0
  });
  my $radiusLocationGroup = Google::Ads::AdWords::v201409::LocationGroups->new({
    matchingFunction => Google::Ads::AdWords::v201409::Function->new({
      operator => "IDENTITY",
      lhsOperand => Google::Ads::AdWords::v201409::LocationExtensionOperand->new({
        radius => $radius
      })
    })
  });
  ...
  foreach my $criterion (@criteria) {
    my $operation =
        Google::Ads::AdWords::v201409::CampaignCriterionOperation->new({
          operator => "ADD",
          operand => Google::Ads::AdWords::v201409::CampaignCriterion->new({
