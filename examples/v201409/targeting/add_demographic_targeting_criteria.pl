...
use Google::Ads::AdWords::v201409::AgeRange;
use Google::Ads::AdWords::v201409::BiddableAdGroupCriterion;
use Google::Ads::AdWords::v201409::Gender;
...
sub add_demographic_targeting_criteria {
  ...
  my $gender_male = Google::Ads::AdWords::v201409::Gender->new({
    id => GENDER_MALE
  });
  ...
  my $age_range = Google::Ads::AdWords::v201409::AgeRange->new({
