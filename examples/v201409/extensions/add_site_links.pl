...
sub add_site_links {
  ...
  my $site_link_1 = Google::Ads::AdWords::v201409::SitelinkFeedItem->new({
    sitelinkText => 'Store Hours',
    sitelinkFinalUrls => Google::Ads::AdWords::v201409::UrlList->new({
  ...
  # from 20 - 27 Nov.
  my $site_link_2 = Google::Ads::AdWords::v201409::SitelinkFeedItem->new({
  ...
  # mobile users.
  my $site_link_3 = Google::Ads::AdWords::v201409::SitelinkFeedItem->new({
    sitelinkText => 'Wifi available',
    sitelinkFinalUrls => Google::Ads::AdWords::v201409::UrlList->new({
      urls => ['http://www.example.com/mobile/wifi']
    }),
    devicePreference =>
      Google::Ads::AdWords::v201409::FeedItemDevicePreference->new({
  ...
  # 6PM to 9PM.
  my $site_link_4 = Google::Ads::AdWords::v201409::SitelinkFeedItem->new({
  ...
  foreach my $day_name ('MONDAY', 'TUESDAY', 'WEDNESDAY', 'THURSDAY',
                        'FRIDAY') {
    push @schedules,
      Google::Ads::AdWords::v201409::FeedItemSchedule->new({
        'dayOfWeek' => $day_name,
        'startHour' => 18,
        'startMinute' => 'ZERO',
        'endHour' => 21,
  ...
  $site_link_4->set_scheduling(
    Google::Ads::AdWords::v201409::FeedItemScheduling->new({
