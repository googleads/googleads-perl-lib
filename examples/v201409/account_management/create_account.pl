...
use Google::Ads::AdWords::v201409::ManagedCustomer;
use Google::Ads::AdWords::v201409::ManagedCustomerOperation;
...
sub create_account {
  ...
  my $account = Google::Ads::AdWords::v201409::ManagedCustomer->new({
  ...
  my $operation = Google::Ads::AdWords::v201409::ManagedCustomerOperation->new({
    operator        => "ADD",
    operand         => $account
  });
