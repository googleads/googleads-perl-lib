...
use Google::Ads::AdWords::v201409::AdGroupBidModifierOperation;
use Google::Ads::AdWords::v201409::AdGroupBidModifier;
...
sub add_ad_group_bid_modifier {
  ...
  my $mobile = Google::Ads::AdWords::v201409::Platform->new({
    id => 30001
  });

  # Create the bid modifier.
  my $modifier = Google::Ads::AdWords::v201409::AdGroupBidModifier->new({
  ...
  my $operation =
      Google::Ads::AdWords::v201409::AdGroupBidModifierOperation->new({
        operator => "ADD",
        operand => $modifier
      });
