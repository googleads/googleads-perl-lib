...
use Google::Ads::AdWords::v201409::UploadConversion;
use Google::Ads::AdWords::v201409::ConversionTrackerOperation;
use Google::Ads::AdWords::v201409::OfflineConversionFeed;
use Google::Ads::AdWords::v201409::OfflineConversionFeedOperation;
...
sub upload_offline_conversions {
  ...
  my $upload_conversion = Google::Ads::AdWords::v201409::UploadConversion->new({
    category => 'PAGE_VIEW',
  ...
  my $upload_operation =
      Google::Ads::AdWords::v201409::ConversionTrackerOperation->new({
        operator => "ADD",
  ...
  my $tracker_result = $client->ConversionTrackerService()->mutate({
    operations => \@conversion_tracker_operations
  });
  ...
  my $feed = Google::Ads::AdWords::v201409::OfflineConversionFeed->new({
  ...
  my $offline_conversion_operation =
      Google::Ads::AdWords::v201409::OfflineConversionFeedOperation->new({
        operator => "ADD",
        operand => $feed
      });
