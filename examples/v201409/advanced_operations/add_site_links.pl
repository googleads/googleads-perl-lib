...
use Google::Ads::AdWords::v201409::CampaignFeed;
...
sub create_site_links_feed() {
  ...
  my $line_2_attribute = Google::Ads::AdWords::v201409::FeedAttribute->new({
    type => "STRING",
...
sub create_site_links_campaign_feed() {
  ...
  my $request_context_operand =
    Google::Ads::AdWords::v201409::RequestContextOperand->new({
  ...
  my $feed_item_function = Google::Ads::AdWords::v201409::Function->new({
  ...
  my $platform_operand = Google::Ads::AdWords::v201409::ConstantOperand->new({
    stringValue => "Mobile",
    type => "STRING"
  });

  my $platform_function = Google::Ads::AdWords::v201409::Function->new({
  ...
  my $feed_item_function_operand =
    Google::Ads::AdWords::v201409::FunctionOperand->new({
  ...
  my $combined_function = Google::Ads::AdWords::v201409::Function->new({
    lhsOperand => [ $feed_item_function_operand, $platform_function_operand ],
    operator => "AND"
  });

  my $campaign_feed = Google::Ads::AdWords::v201409::CampaignFeed->new({
    feedId => $site_links_data->{"siteLinksFeedId"},
