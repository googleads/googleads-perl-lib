...
use Google::Ads::AdWords::v201409::SharedBiddingStrategy;
use Google::Ads::AdWords::v201409::TargetSpendBiddingScheme;
use Google::Ads::AdWords::v201409::Money;
use Google::Ads::AdWords::v201409::BiddingStrategyOperation;
use Google::Ads::AdWords::v201409::BudgetOperation;
use Google::Ads::AdWords::v201409::NetworkSetting;
use Google::Ads::AdWords::v201409::CampaignOperation;
...
sub create_bidding_strategy {
  ...
  my $bidding_strategy =
      Google::Ads::AdWords::v201409::SharedBiddingStrategy->new({
        name => "Maximize Clicks " . uniqid(),
        type => "TARGET_SPEND",

        # Create the bidding scheme.
        biddingScheme =>
            Google::Ads::AdWords::v201409::TargetSpendBiddingScheme->new({
              # Optionally set additional bidding scheme parameters.
              bidCeiling => Google::Ads::AdWords::v201409::Money->new({
                microAmount => 2000000,
              }),
              spendTarget => Google::Ads::AdWords::v201409::Money->new({
  ...
  # Create operation.
  my $operation =
      Google::Ads::AdWords::v201409::BiddingStrategyOperation->new({
        operator => "ADD",
...
sub create_shared_budget {
  ...
  my $operation = Google::Ads::AdWords::v201409::BudgetOperation->new({
    operator => 'ADD',
    operand => Google::Ads::AdWords::v201409::Budget->new({
      period => 'DAILY',
...
sub create_campaign_with_bidding_strategy {
  ...
  my $campaign = Google::Ads::AdWords::v201409::Campaign->new({
    ...
    networkSetting => Google::Ads::AdWords::v201409::NetworkSetting->new({
  ...
  # Create operation.
  my $operation = Google::Ads::AdWords::v201409::CampaignOperation->new({
    operator => 'ADD',
    operand => $campaign
  });
