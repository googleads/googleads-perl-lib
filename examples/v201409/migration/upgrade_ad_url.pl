...
use Google::Ads::AdWords::v201409::AdUrlUpgrade;
...
sub upgrade_ad_url {
  ...
  if ($ad_group_ad) {
    ...
    my $ad_url_upgrade = Google::Ads::AdWords::v201409::AdUrlUpgrade->new({
...
sub get_ad_group_ad {
  ...
  my $ad_group_id_predicate = Google::Ads::AdWords::v201409::Predicate->new({
    field => "AdGroupId",
    operator => "EQUALS",
    values => [$ad_group_id]
  });

  my $ad_id_predicate = Google::Ads::AdWords::v201409::Predicate->new({
    field => "Id",
    operator => "EQUALS",
    values => [$ad_id]
  });
