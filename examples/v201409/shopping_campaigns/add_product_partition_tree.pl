...
use Google::Ads::AdWords::v201409::AdGroupCriterionOperation;
use Google::Ads::AdWords::v201409::BiddableAdGroupCriterion;
use Google::Ads::AdWords::v201409::BiddingStrategyConfiguration;
use Google::Ads::AdWords::v201409::CpcBid;
use Google::Ads::AdWords::v201409::Criterion;
use Google::Ads::AdWords::v201409::Money;
use Google::Ads::AdWords::v201409::NegativeAdGroupCriterion;
use Google::Ads::AdWords::v201409::ProductBiddingCategory;
use Google::Ads::AdWords::v201409::ProductCanonicalCondition;
use Google::Ads::AdWords::v201409::ProductBrand;
use Google::Ads::AdWords::v201409::ProductPartition;
...
sub add_product_partition_tree {
  ...
  create_unit($operations, $ad_group_id, $root,
    Google::Ads::AdWords::v201409::ProductCanonicalCondition->new({
      condition => "NEW"
    }),
    200000);
  ...
  create_unit($operations, $ad_group_id, $other_condition,
    Google::Ads::AdWords::v201409::ProductBrand->new({
      value => "CoolBrand"
    }),
    900000);
  ...
  create_unit($operations, $ad_group_id, $other_brand,
    Google::Ads::AdWords::v201409::ProductBiddingCategory->new({
...
sub create_subdivision {
  ...
  my $division = Google::Ads::AdWords::v201409::ProductPartition->new({
...
sub create_unit {
  ...
  my $unit = Google::Ads::AdWords::v201409::ProductPartition->new({
    partitionType => "UNIT",
  });
  ...
  if ($bid_amount && $bid_amount > 0) {
    my $biddingStrategyConfiguration =
      Google::Ads::AdWords::v201409::BiddingStrategyConfiguration->new({
        bids => [
          Google::Ads::AdWords::v201409::CpcBid->new({
            bid => Google::Ads::AdWords::v201409::Money->new({
    ...
    $criterion = Google::Ads::AdWords::v201409::NegativeAdGroupCriterion->new();
  }
