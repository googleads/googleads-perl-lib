...
use Google::Ads::AdWords::v201409::Campaign;
use Google::Ads::AdWords::v201409::CampaignOperation;
use Google::Ads::AdWords::v201409::BiddingStrategyConfiguration;
use Google::Ads::AdWords::v201409::Budget;
use Google::Ads::AdWords::v201409::ProductAd;
use Google::Ads::AdWords::v201409::ShoppingSetting;
...
sub add_shopping_campaign {
  ...
  my $campaign = Google::Ads::AdWords::v201409::Campaign->new({
    ...
    settings => [
      ...
      Google::Ads::AdWords::v201409::ShoppingSetting->new({
        salesCountry => "US",
        campaignPriority => 0,
  ...
  # Create operation
  $operation = Google::Ads::AdWords::v201409::AdGroupOperation->new({
    operand => $ad_group,
    operator => "ADD"
  });
  ...
  # Create product ad
  my $product_ad = Google::Ads::AdWords::v201409::ProductAd->new();

  # Create ad group ad
  my $ad_group_ad = Google::Ads::AdWords::v201409::AdGroupAd->new({
    adGroupId => $ad_group->get_id(),
    ad => $product_ad
  });

  # Create operation
  $operation = Google::Ads::AdWords::v201409::AdGroupAdOperation->new({
    operand => $ad_group_ad,
    operator => "ADD"
  });
