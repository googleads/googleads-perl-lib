...
use Google::Ads::AdWords::v201409::UserListConversionType;
...
sub add_audience {
  ...
  my $conversion_type =
      Google::Ads::AdWords::v201409::UserListConversionType->new({
          name => $name
      });

  # Create remarketing user list.
  my $user_list = Google::Ads::AdWords::v201409::BasicUserList->new({
    name => $name,
  ...
  # Create operation.
  my $operation = Google::Ads::AdWords::v201409::UserListOperation->new({
    operator => "ADD",
    operand => $user_list
  });
  ...
  if ($result->get_value()) {
    ...
    sleep(5);
    my $predicate = Google::Ads::AdWords::v201409::Predicate->new({
      field => "Id",
      operator => "IN",
    ...
    $selector = Google::Ads::AdWords::v201409::Selector->new({
      fields => ["Id"],
