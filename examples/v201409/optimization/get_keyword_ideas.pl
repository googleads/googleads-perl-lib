...
use Google::Ads::AdWords::v201409::LanguageSearchParameter;
use Google::Ads::AdWords::Logging;
use Google::Ads::AdWords::v201409::Paging;
use Google::Ads::AdWords::v201409::RelatedToQuerySearchParameter;
use Google::Ads::AdWords::v201409::TargetingIdeaSelector;
...
sub get_keyword_ideas {
  ...
  # Create selector.
  my $selector = Google::Ads::AdWords::v201409::TargetingIdeaSelector->new({
    requestType => "IDEAS",
    ideaType => "KEYWORD",
  ...
  my $paging = Google::Ads::AdWords::v201409::Paging->new({
    startIndex => 0,
    numberResults => 10
  });
  ...
  my $query_search_parameter =
      Google::Ads::AdWords::v201409::RelatedToQuerySearchParameter->new({
        queries => [$seed_query]
      });
  ...
  my $language_english = Google::Ads::AdWords::v201409::Language->new({
    id => 1000
  });
  my $language_search_parameter =
      Google::Ads::AdWords::v201409::LanguageSearchParameter->new({
