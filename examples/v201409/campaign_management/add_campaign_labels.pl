...
use Google::Ads::AdWords::v201409::CampaignLabel;
use Google::Ads::AdWords::v201409::CampaignLabelOperation;

use Cwd qw(abs_path);
use Data::Uniqid qw(uniqid);

# Replace with valid values of your account.
my $campaign_ids = ["INSERT_CAMPAIGN_ID_1_HERE",
...
sub add_campaign_labels {
  ...
  foreach my $campaign_id (@{$campaign_ids}) {
    my $campaign_label = Google::Ads::AdWords::v201409::CampaignLabel->new({
      campaignId => $campaign_id,
      labelId => $label_id
    });
    my $campaign_label_operation =
        Google::Ads::AdWords::v201409::CampaignLabelOperation->new({
          operator => "ADD",
  ...
  # Add campaign labels.
  my $result = $client->CampaignService()->mutateLabel({
