...
use Google::Ads::AdWords::v201409::AdGroup;
...
use Google::Ads::AdWords::v201409::AdGroupExperimentData;
use Google::Ads::AdWords::v201409::AdGroupOperation;
use Google::Ads::AdWords::v201409::BidMultiplier;
use Google::Ads::AdWords::v201409::BiddableAdGroupCriterion;
use Google::Ads::AdWords::v201409::BiddableAdGroupCriterionExperimentData;
...
use Google::Ads::AdWords::v201409::ManualCPCAdGroupCriterionExperimentBidMultiplier;
use Google::Ads::AdWords::v201409::ManualCPCAdGroupExperimentBidMultipliers;
...
sub add_experiment {
  ...
  my $ad_group = Google::Ads::AdWords::v201409::AdGroup->new({
    id => $ad_group_id
  });
  ...
  # experiment.
  my $bid_multiplier =
      Google::Ads::AdWords::v201409::ManualCPCAdGroupExperimentBidMultipliers->
          new({
            maxCpcMultiplier => Google::Ads::AdWords::v201409::BidMultiplier->
                new({
                  multiplier => 1.5
                })
          });
  ...
  my $experiment_data =
      Google::Ads::AdWords::v201409::AdGroupExperimentData->new({
  ...
  # Create operation.
  my $operation = Google::Ads::AdWords::v201409::AdGroupOperation->new({
    operand => $ad_group,
    operator => "SET"
  });
  ...
  my $criterion = Google::Ads::AdWords::v201409::Criterion->new({
    id => $criterion_id,
  });
  ...
  # experiment.
  $bid_multiplier =
      Google::Ads::AdWords::v201409::ManualCPCAdGroupCriterionExperimentBidMultiplier->new({
        maxCpcMultiplier => Google::Ads::AdWords::v201409::BidMultiplier->new({
          multiplier => 1.5
        })
      });
  ...
  $experiment_data =
      Google::Ads::AdWords::v201409::BiddableAdGroupCriterionExperimentData->
          new({
            experimentId => $experiment_id,
            experimentDeltaStatus => "MODIFIED",
