...
use Google::Ads::AdWords::v201409::Address;
use Google::Ads::AdWords::v201409::CampaignAdExtension;
use Google::Ads::AdWords::v201409::CampaignAdExtensionOperation;
use Google::Ads::AdWords::v201409::GeoLocationSelector;
use Google::Ads::AdWords::v201409::LocationExtension;
...
sub add_location_extension {
  ...
  # Create address.
  my $address = Google::Ads::AdWords::v201409::Address->new({
  ...
  my $selector = Google::Ads::AdWords::v201409::GeoLocationSelector->new({
    addresses => [$address]
  });
  ...
  my $location_extension =
      Google::Ads::AdWords::v201409::LocationExtension->new({
  ...
  my $campaign_location_ad_extension =
      Google::Ads::AdWords::v201409::CampaignAdExtension->new({
  ...
  # Create operation.
  my $operation =
      Google::Ads::AdWords::v201409::CampaignAdExtensionOperation->new({
