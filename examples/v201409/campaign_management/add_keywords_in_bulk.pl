...
use Google::Ads::AdWords::v201409::AdGroupCriterion;
use Google::Ads::AdWords::v201409::AdGroupCriterionOperation;
use Google::Ads::AdWords::v201409::BiddableAdGroupCriterion;
use Google::Ads::AdWords::v201409::BulkMutateJobPolicy;
use Google::Ads::AdWords::v201409::BulkMutateJobSelector;
...
sub add_keywords_in_bulk {
  ...
  my $job = $client->MutateJobService()->mutate({
        ...
        policy => Google::Ads::AdWords::v201409::BulkMutateJobPolicy->new({
  ...
  my $job_selector = Google::Ads::AdWords::v201409::BulkMutateJobSelector->new({
    jobIds => [$job_id],
    includeStats => 1,
    includeHistory => 1
  });
