...
use Google::Ads::AdWords::v201409::TargetingSetting;
use Google::Ads::AdWords::v201409::TargetingSettingDetail;
...
sub add_ad_groups {
  ...
  for (my $i = 0; $i < $num_ad_groups; $i++) {
      ...
      settings => [
        ...
        Google::Ads::AdWords::v201409::TargetingSetting->new({
          details => [
            ...
            Google::Ads::AdWords::v201409::TargetingSettingDetail->new({
    ...
    my $ad_group_operation =
        Google::Ads::AdWords::v201409::AdGroupOperation->new({
          operator => "ADD",
          operand => $ad_group
        });
