...
use Google::Ads::AdWords::v201409::FrequencyCap;
use Google::Ads::AdWords::v201409::GeoTargetTypeSetting;
use Google::Ads::AdWords::v201409::ManualCpcBiddingScheme;
...
sub add_campaigns {
  ...
  for (my $i = 0; $i < $num_campaigns; $i++) {
    ...
    my $campaign = Google::Ads::AdWords::v201409::Campaign->new({
      ...
      frequencyCap => Google::Ads::AdWords::v201409::FrequencyCap->new({
        impressions => 5,
        timeUnit => "DAY",
        level => "ADGROUP"
      }),
      settings => [
          ...
          Google::Ads::AdWords::v201409::GeoTargetTypeSetting->new({
