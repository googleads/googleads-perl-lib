...
use Google::Ads::AdWords::v201502::BiddableAdGroupCriterion;
use Google::Ads::AdWords::v201502::BiddingStrategyConfiguration;
use Google::Ads::AdWords::v201502::CpcBid;
use Google::Ads::AdWords::v201502::Criterion;
use Google::Ads::AdWords::v201502::Money;
use Google::Ads::AdWords::v201502::NegativeAdGroupCriterion;
use Google::Ads::AdWords::v201502::ProductBiddingCategory;
use Google::Ads::AdWords::v201502::ProductCanonicalCondition;
use Google::Ads::AdWords::v201502::ProductBrand;
use Google::Ads::AdWords::v201502::ProductPartition;
...
sub add_product_partition_tree {
  ...
  create_unit($operations, $ad_group_id, $root,
    Google::Ads::AdWords::v201502::ProductCanonicalCondition->new({
      condition => "NEW"
    }),
    200000);
  ...
  create_unit($operations, $ad_group_id, $other_condition,
    Google::Ads::AdWords::v201502::ProductBrand->new({
      value => "CoolBrand"
    }),
    900000);
  ...
  create_unit($operations, $ad_group_id, $other_brand,
    Google::Ads::AdWords::v201502::ProductBiddingCategory->new({
...
sub create_subdivision {
  ...
  my $division = Google::Ads::AdWords::v201502::ProductPartition->new({
  ...
  my $criterion =
    Google::Ads::AdWords::v201502::BiddableAdGroupCriterion->new({
...
sub create_unit {
  ...
  my $unit = Google::Ads::AdWords::v201502::ProductPartition->new({
    partitionType => "UNIT",
  });
  ...
  if ($bid_amount && $bid_amount > 0) {
    my $biddingStrategyConfiguration =
      Google::Ads::AdWords::v201502::BiddingStrategyConfiguration->new({
        bids => [
          Google::Ads::AdWords::v201502::CpcBid->new({
            bid => Google::Ads::AdWords::v201502::Money->new({
    ...
    $criterion = Google::Ads::AdWords::v201502::NegativeAdGroupCriterion->new();
  }
