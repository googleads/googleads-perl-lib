...
use Google::Ads::AdWords::v201502::Campaign;
use Google::Ads::AdWords::v201502::CampaignOperation;
use Google::Ads::AdWords::v201502::BiddingStrategyConfiguration;
use Google::Ads::AdWords::v201502::Budget;
use Google::Ads::AdWords::v201502::ProductAd;
use Google::Ads::AdWords::v201502::ShoppingSetting;
...
sub add_shopping_campaign {
  ...
  my $campaign = Google::Ads::AdWords::v201502::Campaign->new({
    ...
    settings => [
      ...
      Google::Ads::AdWords::v201502::ShoppingSetting->new({
        salesCountry => "US",
        campaignPriority => 0,
  ...
  # Create operation
  $operation = Google::Ads::AdWords::v201502::AdGroupOperation->new({
    operand => $ad_group,
    operator => "ADD"
  });
  ...
  # Create product ad
  my $product_ad = Google::Ads::AdWords::v201502::ProductAd->new();

  # Create ad group ad
  my $ad_group_ad = Google::Ads::AdWords::v201502::AdGroupAd->new({
    adGroupId => $ad_group->get_id(),
    ad => $product_ad
  });

  # Create operation
  $operation = Google::Ads::AdWords::v201502::AdGroupAdOperation->new({
    operand => $ad_group_ad,
    operator => "ADD"
  });
