...
use Google::Ads::AdWords::v201502::UserListConversionType;
...
sub add_audience {
  ...
  my $conversion_type =
      Google::Ads::AdWords::v201502::UserListConversionType->new({
          name => $name
      });

  # Create remarketing user list.
  my $user_list = Google::Ads::AdWords::v201502::BasicUserList->new({
    name => $name,
  ...
  # Create operation.
  my $operation = Google::Ads::AdWords::v201502::UserListOperation->new({
    operator => "ADD",
    operand => $user_list
  });
  ...
  if ($result->get_value()) {
    ...
    sleep(5);
    my $predicate = Google::Ads::AdWords::v201502::Predicate->new({
      field => "Id",
      operator => "IN",
