...
sub create_site_links_feed() {
  ...
  my $text_attribute = Google::Ads::AdWords::v201502::FeedAttribute->new({
    type => "STRING",
    name => "Link Text"
  });
  my $final_url_attribute = Google::Ads::AdWords::v201502::FeedAttribute->new({
    type => "URL_LIST",
    name => "Link Final URLs"
  });
  my $line_1_attribute = Google::Ads::AdWords::v201502::FeedAttribute->new({
    type => "STRING",
    name => "Line 1 Description"
  });
  my $line_2_attribute = Google::Ads::AdWords::v201502::FeedAttribute->new({
    type => "STRING",
...
sub create_site_links_campaign_feed() {
  ...
  my $result = $client->CampaignFeedService()->mutate({
    operations => [
      Google::Ads::AdWords::v201502::CampaignFeedOperation->new({
