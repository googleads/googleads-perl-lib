...
use Google::Ads::AdWords::v201502::CampaignExtensionSetting;
...
sub add_site_links {
  ...
  my $site_link_1 = Google::Ads::AdWords::v201502::SitelinkFeedItem->new({
    sitelinkText => 'Store Hours',
    sitelinkFinalUrls => Google::Ads::AdWords::v201502::UrlList->new({
  ...
  # from 20 - 27 Nov.
  my $site_link_2 = Google::Ads::AdWords::v201502::SitelinkFeedItem->new({
  ...
  my $start_time = sprintf("%d1120 000000 %s", ($year + 1900),
    $customer_time_zone);
  my $end_time = sprintf("%d1127 235959 %s", ($year + 1900),
    $customer_time_zone);
  ...
  # mobile users.
  my $site_link_3 = Google::Ads::AdWords::v201502::SitelinkFeedItem->new({
    sitelinkText => 'Wifi available',
    sitelinkFinalUrls => Google::Ads::AdWords::v201502::UrlList->new({
      urls => ['http://www.example.com/mobile/wifi']
    }),
    devicePreference =>
      Google::Ads::AdWords::v201502::FeedItemDevicePreference->new({
  ...
  # 6PM to 9PM.
  my $site_link_4 = Google::Ads::AdWords::v201502::SitelinkFeedItem->new({
  ...
  my @schedules = ();
  foreach my $day_name ('MONDAY', 'TUESDAY', 'WEDNESDAY', 'THURSDAY',
                        'FRIDAY') {
    push @schedules,
      Google::Ads::AdWords::v201502::FeedItemSchedule->new({
        'dayOfWeek' => $day_name,
        'startHour' => 18,
        'startMinute' => 'ZERO',
        'endHour' => 21,
  ...
  $site_link_4->set_scheduling(
    Google::Ads::AdWords::v201502::FeedItemScheduling->new({
    ...
    Google::Ads::AdWords::v201502::CampaignExtensionSetting->new({
      ...
      extensionSetting =>
        Google::Ads::AdWords::v201502::ExtensionSetting->new({
          extensions => [
            $site_link_1, $site_link_2, $site_link_3, $site_link_4
          ]
        })
    });
  ...
  my $mutate_result = $client->CampaignExtensionSettingService()->mutate({
    operations => [
      Google::Ads::AdWords::v201502::CampaignExtensionSettingOperation->new({
