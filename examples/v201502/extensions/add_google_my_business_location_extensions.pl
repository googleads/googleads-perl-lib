...
use Google::Ads::AdWords::v201502::PlacesLocationFeedData;
use Google::Ads::AdWords::v201502::OAuthInfo;
...
sub add_gmb_location_extensions {
  ...
  my $gmb_feed = Google::Ads::AdWords::v201502::Feed->new({
  ...
  my $oauth_info = Google::Ads::AdWords::v201502::OAuthInfo->new({
    httpMethod => "GET",
    httpRequestUrl => Google::Ads::AdWords::Constants::DEFAULT_OAUTH_SCOPE,
    httpAuthorizationHeader => "Bearer ${gmb_access_token}"
  });
  my $feed_data = Google::Ads::AdWords::v201502::PlacesLocationFeedData->new({
  ...
  my $feed_operation = Google::Ads::AdWords::v201502::FeedOperation->new({
    operand => $gmb_feed,
    operator => "ADD"
  });
  ...
  my $customer_matching_function =
    Google::Ads::AdWords::v201502::Function->new({
      lhsOperand => [ Google::Ads::AdWords::v201502::ConstantOperand->new({
          type => "BOOLEAN",
          booleanValue => 1
        })
      ],
