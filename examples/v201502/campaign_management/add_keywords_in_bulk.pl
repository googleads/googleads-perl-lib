...
use Google::Ads::AdWords::v201502::BulkMutateJobPolicy;
use Google::Ads::AdWords::v201502::BulkMutateJobSelector;
...
sub add_keywords_in_bulk {
  ...
  for (my $i = 1 ; $i < KEYWORD_COUNT; $i++) {
    # Create keyword.
    my $keyword = Google::Ads::AdWords::v201502::Keyword->new({
      matchType => "BROAD"
    });
  ...
  my $job = $client->MutateJobService()->mutate({
        ...
        policy => Google::Ads::AdWords::v201502::BulkMutateJobPolicy->new({
  ...
  my $job_selector = Google::Ads::AdWords::v201502::BulkMutateJobSelector->new({
    jobIds => [$job_id],
    includeStats => 1,
    includeHistory => 1
  });
