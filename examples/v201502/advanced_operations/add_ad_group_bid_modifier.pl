...
use Google::Ads::AdWords::v201502::AdGroupBidModifierOperation;
use Google::Ads::AdWords::v201502::AdGroupBidModifier;
...
sub add_ad_group_bid_modifier {
  ...
  my $mobile = Google::Ads::AdWords::v201502::Platform->new({
    id => 30001
  });

  # Create the bid modifier.
  my $modifier = Google::Ads::AdWords::v201502::AdGroupBidModifier->new({
  ...
  my $operation =
      Google::Ads::AdWords::v201502::AdGroupBidModifierOperation->new({
        operator => "ADD",
        operand => $modifier
      });
