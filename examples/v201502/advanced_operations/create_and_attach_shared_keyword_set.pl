...
sub create_and_attach_shared_keyword_set {
  ...
  my $shared_set = Google::Ads::AdWords::v201502::SharedSet->new({
  ...
  my $shared_set_result = $client->SharedSetService()->mutate({
    operations => [
      Google::Ads::AdWords::v201502::SharedSetOperation->new({
        operator => 'ADD',
        operand => $shared_set
      })
    ]
  ...
  foreach my $keyword (@keywords) {
    my $keyword_criterion = Google::Ads::AdWords::v201502::Keyword->new({
      text => $keyword,
      matchType => 'BROAD'
    });

    my $shared_criterion = Google::Ads::AdWords::v201502::SharedCriterion->new({
  ...
  my $shared_criterion_result = $client->SharedCriterionService()->mutate({
  ...
  my $campaign_shared_set =
    Google::Ads::AdWords::v201502::CampaignSharedSet->new({
  ...
  my $campaign_shared_set_result = $client->CampaignSharedSetService->mutate({
    operations => [
      Google::Ads::AdWords::v201502::CampaignSharedSetOperation->new({
        operator => 'ADD',
