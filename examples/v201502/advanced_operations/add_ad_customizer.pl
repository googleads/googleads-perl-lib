...
use Google::Ads::AdWords::v201502::AdGroupAd;
use Google::Ads::AdWords::v201502::AdGroupAdOperation;
use Google::Ads::AdWords::v201502::ConstantOperand;
use Google::Ads::AdWords::v201502::CustomerFeed;
use Google::Ads::AdWords::v201502::CustomerFeedOperation;
use Google::Ads::AdWords::v201502::Feed;
use Google::Ads::AdWords::v201502::FeedAttribute;
use Google::Ads::AdWords::v201502::FeedItem;
use Google::Ads::AdWords::v201502::FeedItemAdGroupTargeting;
use Google::Ads::AdWords::v201502::FeedItemAttributeValue;
use Google::Ads::AdWords::v201502::FeedItemOperation;
use Google::Ads::AdWords::v201502::FeedMapping;
...
use Google::Ads::AdWords::v201502::TextAd;
...
sub create_customizer_feed() {
  ...
  my $name_attribute = Google::Ads::AdWords::v201502::FeedAttribute->new({
    type => "STRING",
    name => "Name"
  });
  my $price_attribute = Google::Ads::AdWords::v201502::FeedAttribute->new({
    type => "STRING",
    name => "Price"
  });
  my $date_attribute = Google::Ads::AdWords::v201502::FeedAttribute->new({
    type => "DATE_TIME",
    name => "Date"
  });
  my $feed = Google::Ads::AdWords::v201502::Feed->new({
    name => "CustomizerFeed",
  ...
  my $operation =
    Google::Ads::AdWords::v201502::FeedOperation->new({
      operator => "ADD",
      operand => $feed
  });
...
sub create_customizer_feed_mapping() {
  ...
  my $name_field_mapping =
    Google::Ads::AdWords::v201502::AttributeFieldMapping->new({
  ...
  my $feed_mapping = Google::Ads::AdWords::v201502::FeedMapping->new({
  ...
  my $operation = Google::Ads::AdWords::v201502::FeedMappingOperation->new({
...
sub create_feed_item_add_operation() {
  ...
  my $name_attribute_value =
    Google::Ads::AdWords::v201502::FeedItemAttributeValue->new({
      feedAttributeId => $customizers_data->{"nameFeedAttributeId"},
      stringValue => $name
  });
  ...
  my $feed_item = Google::Ads::AdWords::v201502::FeedItem->new({
    feedId => $customizers_data->{"customizersFeedId"},
    attributeValues => [
      $name_attribute_value, $price_attribute_value, $date_attribute_value
    ],
    adGroupTargeting =>
      Google::Ads::AdWords::v201502::FeedItemAdGroupTargeting->new({
        TargetingAdGroupId => $ad_group_id
    })
  });

  my $operation = Google::Ads::AdWords::v201502::FeedItemOperation->new({
    operand => $feed_item,
    operator => "ADD"
  });
...
sub create_customizer_customer_feed() {
  ...
  # placeholder type.
  my $customer_feed = Google::Ads::AdWords::v201502::CustomerFeed->new({
    feedId => $customizers_data->{"customizersFeedId"},
  ...
  my $result = $client->CustomerFeedService()->mutate({
    operations => [
      Google::Ads::AdWords::v201502::CustomerFeedOperation->new({
...
sub create_ads_with_customizations() {
  ...
  my $text_ad = Google::Ads::AdWords::v201502::TextAd->new({
  ...
  foreach my $ad_group_id (@{$ad_group_ids}) {
    push @operations, Google::Ads::AdWords::v201502::AdGroupAdOperation->new({
      operator => "ADD",
      operand => Google::Ads::AdWords::v201502::AdGroupAd->new({
