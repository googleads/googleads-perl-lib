...
use Google::Ads::AdWords::v201502::CampaignSharedSet;
use Google::Ads::AdWords::v201502::CampaignSharedSetOperation;
...
use Google::Ads::AdWords::v201502::Placement;
use Google::Ads::AdWords::v201502::Predicate;
use Google::Ads::AdWords::v201502::Selector;
use Google::Ads::AdWords::v201502::SharedCriterion;
...
sub find_and_remove_criteria_from_shared_set {
  ...
  my $selector = Google::Ads::AdWords::v201502::Selector->new({
    ...
    predicates => [
      Google::Ads::AdWords::v201502::Predicate->new({
        field => "CampaignId",
        operator => "EQUALS",
        values => [$campaign_id]
      })
  ...
  $selector = Google::Ads::AdWords::v201502::Selector->new({
    fields => [
      ...
      sub {
        ...
        if ($criterion->isa("Google::Ads::AdWords::v201502::Keyword")) {
          printf "Shared negative keyword with ID %d and text '%s' was " .
                 ...
                 $criterion->get_id(),
                 $criterion->get_text();
        } elsif ($criterion->isa("Google::Ads::AdWords::v201502::Placement")) {
        ...
        my $shared_criterion_operation =
          Google::Ads::AdWords::v201502::SharedCriterionOperation->new({
            operator => 'REMOVE',
            operand => Google::Ads::AdWords::v201502::SharedCriterion->new({
              criterion => Google::Ads::AdWords::v201502::Criterion->new({
                id => $criterion->get_id()
              }),
  ...
  if (@remove_criterion_operations) {
    my $remove_criteria_result = $client->SharedCriterionService()->mutate({
      operations => \@remove_criterion_operations
    });
