...
use Google::Ads::AdWords::v201502::AgeRange;
use Google::Ads::AdWords::v201502::BiddableAdGroupCriterion;
use Google::Ads::AdWords::v201502::Gender;
...
sub add_demographic_targeting_criteria {
  ...
  my $gender_male = Google::Ads::AdWords::v201502::Gender->new({
    id => GENDER_MALE
  });
  ...
  my $age_range = Google::Ads::AdWords::v201502::AgeRange->new({
