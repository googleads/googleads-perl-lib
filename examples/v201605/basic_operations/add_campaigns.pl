...
use Google::Ads::AdWords::v201605::Campaign;
use Google::Ads::AdWords::v201605::CampaignOperation;
use Google::Ads::AdWords::v201605::FrequencyCap;
use Google::Ads::AdWords::v201605::GeoTargetTypeSetting;
use Google::Ads::AdWords::v201605::ManualCpcBiddingScheme;
...
sub add_campaigns {
  ...
  for (my $i = 0 ; $i < $num_campaigns ; $i++) {
    ...
    my $campaign = Google::Ads::AdWords::v201605::Campaign->new({
        ...
        budget =>
          Google::Ads::AdWords::v201605::Budget->new({budgetId => $budgetId}),
        ...
        frequencyCap => Google::Ads::AdWords::v201605::FrequencyCap->new({
            impressions => 5,
            timeUnit    => "DAY",
            level       => "ADGROUP"
          }
        ...
        settings => [
          ...
          Google::Ads::AdWords::v201605::GeoTargetTypeSetting->new({
