...
use Google::Ads::AdWords::v201605::ConstantOperand;
use Google::Ads::AdWords::v201605::Function;
use Google::Ads::AdWords::v201605::GeoTargetOperand;
use Google::Ads::AdWords::v201605::IncomeOperand;
use Google::Ads::AdWords::v201605::Language;
use Google::Ads::AdWords::v201605::Location;
use Google::Ads::AdWords::v201605::LocationExtensionOperand;
use Google::Ads::AdWords::v201605::LocationGroups;
use Google::Ads::AdWords::v201605::PlacesOfInterestOperand;
use Google::Ads::AdWords::v201605::Platform;
...
sub add_campaign_targeting_criteria {
  ...
  my $california = Google::Ads::AdWords::v201605::Location->new({id => 21137});
  push @criteria, $california;
  my $mexico = Google::Ads::AdWords::v201605::Location->new({
      id => 2484    # Mexico
  });
  ...
  my $english = Google::Ads::AdWords::v201605::Language->new({id => 1000});
  push @criteria, $english;
  my $spanish = Google::Ads::AdWords::v201605::Language->new({id => 1003});
  ...
  my $income = Google::Ads::AdWords::v201605::LocationGroups->new({
      matchingFunction => Google::Ads::AdWords::v201605::Function->new({
          operator   => "AND",
          lhsOperand => Google::Ads::AdWords::v201605::IncomeOperand->new({
          ...
          rhsOperand => Google::Ads::AdWords::v201605::GeoTargetOperand->new({
              locations => [1015116]    # Miami, FL
            })})});
  push @criteria, $income;

  my $placesOfInterest = Google::Ads::AdWords::v201605::LocationGroups->new({
      matchingFunction => Google::Ads::AdWords::v201605::Function->new({
          operator => "AND",
          lhsOperand =>
            Google::Ads::AdWords::v201605::PlacesOfInterestOperand->new({
  ...
  if ($location_feed_id) {
    ...
    my $radius = Google::Ads::AdWords::v201605::ConstantOperand->new({
        type        => "DOUBLE",
        unit        => "MILES",
        doubleValue => 10.0
    });
    my $radiusLocationGroup =
      Google::Ads::AdWords::v201605::LocationGroups->new({
        matchingFunction => Google::Ads::AdWords::v201605::Function->new({
            operator => "IDENTITY",
            lhsOperand =>
              Google::Ads::AdWords::v201605::LocationExtensionOperand->new(
              {radius => $radius})}
        ),
  ...
  foreach my $criterion (@criteria) {
    my $operation =
      Google::Ads::AdWords::v201605::CampaignCriterionOperation->new({
        operator => "ADD",
        operand  => Google::Ads::AdWords::v201605::CampaignCriterion->new({
