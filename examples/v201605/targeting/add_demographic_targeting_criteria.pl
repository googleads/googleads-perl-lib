...
use Google::Ads::AdWords::v201605::AgeRange;
use Google::Ads::AdWords::v201605::BiddableAdGroupCriterion;
use Google::Ads::AdWords::v201605::Gender;
...
sub add_demographic_targeting_criteria {
  ...
  my $gender_male =
    Google::Ads::AdWords::v201605::Gender->new({id => GENDER_MALE});
  ...
  my $age_range = Google::Ads::AdWords::v201605::AgeRange->new(
  ...
  foreach my $criterion (@criteria) {
    my $operation =
      Google::Ads::AdWords::v201605::AdGroupCriterionOperation->new({
        operator => "ADD",
        operand => Google::Ads::AdWords::v201605::BiddableAdGroupCriterion->new(
          {
