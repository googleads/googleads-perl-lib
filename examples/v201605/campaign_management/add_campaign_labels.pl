...
use Google::Ads::AdWords::v201605::CampaignLabel;
use Google::Ads::AdWords::v201605::CampaignLabelOperation;
...
sub add_campaign_labels {
  ...
  foreach my $campaign_id (@{$campaign_ids}) {
    my $campaign_label = Google::Ads::AdWords::v201605::CampaignLabel->new({
        campaignId => $campaign_id,
        labelId    => $label_id
    });
    my $campaign_label_operation =
      Google::Ads::AdWords::v201605::CampaignLabelOperation->new({
        operator => "ADD",
