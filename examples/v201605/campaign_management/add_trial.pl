...
use Google::Ads::AdWords::v201605::Trial;
use Google::Ads::AdWords::v201605::TrialOperation;
...
sub add_trial {
  ...
  my $trial = Google::Ads::AdWords::v201605::Trial->new({
      draftId             => $draft_id,
  ...
  # Create operation.
  my $trial_operation = Google::Ads::AdWords::v201605::TrialOperation->new({
      operator => "ADD",
      operand  => $trial
  });
  ...
  if ($result) {
    ...
    if ($trial->get_status() eq 'ACTIVE') {
      ...
      my $error_selector = Google::Ads::AdWords::v201605::Selector->new({
