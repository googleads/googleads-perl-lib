...
use Google::Ads::AdWords::v201605::AdGroupExperimentData;
use Google::Ads::AdWords::v201605::AdGroupOperation;
use Google::Ads::AdWords::v201605::BidMultiplier;
use Google::Ads::AdWords::v201605::BiddableAdGroupCriterion;
use Google::Ads::AdWords::v201605::BiddableAdGroupCriterionExperimentData;
use Google::Ads::AdWords::v201605::Criterion;
use Google::Ads::AdWords::v201605::Experiment;
use Google::Ads::AdWords::v201605::ExperimentOperation;
use
  Google::Ads::AdWords::v201605::ManualCPCAdGroupCriterionExperimentBidMultiplier;
use Google::Ads::AdWords::v201605::ManualCPCAdGroupExperimentBidMultipliers;
...
sub add_experiment {
  ...
  my $experiment = Google::Ads::AdWords::v201605::Experiment->new({
  ...
  my $experiment_operation =
    Google::Ads::AdWords::v201605::ExperimentOperation->new({
      operator => "ADD",
      operand  => $experiment
    });
  ...
  my $ad_group =
    Google::Ads::AdWords::v201605::AdGroup->new({id => $ad_group_id});

  # Create experiment bid multiplier rule that will modify ad group bid for the
  # experiment.
  my $bid_multiplier =
    Google::Ads::AdWords::v201605::ManualCPCAdGroupExperimentBidMultipliers->
    new({
      maxCpcMultiplier =>
        Google::Ads::AdWords::v201605::BidMultiplier->new({multiplier => 1.5})}
    );

  # Set experiment data to the ad group.
  my $experiment_data =
    Google::Ads::AdWords::v201605::AdGroupExperimentData->new({
  ...
  my $criterion =
    Google::Ads::AdWords::v201605::Criterion->new({id => $criterion_id,});
  ...
  $experiment_data =
    Google::Ads::AdWords::v201605::BiddableAdGroupCriterionExperimentData->new({
      experimentId            => $experiment_id,
      experimentDeltaStatus   => "MODIFIED",
  ...
  # Create operation.
  $operation = Google::Ads::AdWords::v201605::AdGroupCriterionOperation->new({
