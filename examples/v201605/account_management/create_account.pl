...
use Google::Ads::AdWords::v201605::ManagedCustomer;
use Google::Ads::AdWords::v201605::ManagedCustomerOperation;
...
sub create_account {
  ...
  my $account = Google::Ads::AdWords::v201605::ManagedCustomer->new({
  ...
  my $operation = Google::Ads::AdWords::v201605::ManagedCustomerOperation->new({
      operator => "ADD",
      operand  => $account
  });
