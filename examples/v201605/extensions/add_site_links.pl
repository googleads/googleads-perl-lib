...
sub add_site_links {
  ...
  my $site_link_1 = Google::Ads::AdWords::v201605::SitelinkFeedItem->new({
      sitelinkText      => 'Store Hours',
      sitelinkFinalUrls => Google::Ads::AdWords::v201605::UrlList->new(
        {urls => ['http://www.example.com/storehours']})});

  # Set the startTime and endTime to show the Thanksgiving specials link only
  # from 20 - 27 Nov.
  my $site_link_2 = Google::Ads::AdWords::v201605::SitelinkFeedItem->new({
  ...
  my $location = Google::Ads::AdWords::v201605::Location->new({
  ...
  my $site_link_3 = Google::Ads::AdWords::v201605::SitelinkFeedItem->new({
      ...
      devicePreference =>
        Google::Ads::AdWords::v201605::FeedItemDevicePreference->new({
  ...
  # 6PM to 9PM.
  my $site_link_4 = Google::Ads::AdWords::v201605::SitelinkFeedItem->new({
  ...
  {
    push @schedules,
      Google::Ads::AdWords::v201605::FeedItemSchedule->new({
        'dayOfWeek'   => $day_name,
        'startHour'   => 18,
        'startMinute' => 'ZERO',
        'endHour'     => 21,
  ...
  $site_link_4->set_scheduling(
    Google::Ads::AdWords::v201605::FeedItemScheduling->new(
  ...
  my $campaign_extension_setting =
    Google::Ads::AdWords::v201605::CampaignExtensionSetting->new({
      ...
      extensionSetting => Google::Ads::AdWords::v201605::ExtensionSetting->new({
