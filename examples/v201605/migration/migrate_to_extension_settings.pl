...
use Google::Ads::AdWords::v201605::CampaignExtensionSetting;
use Google::Ads::AdWords::v201605::CampaignExtensionSettingOperation;
use Google::Ads::AdWords::v201605::CampaignFeedOperation;
use Google::Ads::AdWords::v201605::ExtensionSetting;
use Google::Ads::AdWords::v201605::ExtensionSetting::Platform;
use Google::Ads::AdWords::v201605::FeedItem;
use Google::Ads::AdWords::v201605::FeedItemOperation;
use Google::Ads::AdWords::v201605::SitelinkFeedItem;
use Google::Ads::AdWords::v201605::UrlList;
...
sub get_feed_items_from_argument() {
  ...
  if ( $lhs_operand_size == 1
    && $lhs_operand->[0]
    ->isa("Google::Ads::AdWords::v201605::RequestContextOperand")
...
sub delete_campaign_feed() {
  ...
  my $result = $client->CampaignFeedService()->mutate({
      operations => [
        Google::Ads::AdWords::v201605::CampaignFeedOperation->new({
...
sub create_extension_setting() {
  ...
  my $campaign_extension_setting =
    Google::Ads::AdWords::v201605::CampaignExtensionSetting->new({
  ...
  foreach my $feed_item_id (@{$feed_item_ids}) {
    ...
    my $sitelink_feed_item =
      Google::Ads::AdWords::v201605::SitelinkFeedItem->new({
    ...
    if ($item_attributes->{'final_urls'}) {
      $sitelink_feed_item->set_sitelinkFinalUrls(
        Google::Ads::AdWords::v201605::UrlList->new(
  ...
  $campaign_extension_setting->set_extensionSetting(
    Google::Ads::AdWords::v201605::ExtensionSetting->new({
  ...
  my $result = $client->CampaignExtensionSettingService()->mutate({
      operations => [
        Google::Ads::AdWords::v201605::CampaignExtensionSettingOperation->new({
...
sub delete_old_feed_items() {
  ...
  foreach my $feed_item_id (@{$feed_item_ids}) {
    push @operations,
      Google::Ads::AdWords::v201605::FeedItemOperation->new({
        operator => 'REMOVE',
        operand  => Google::Ads::AdWords::v201605::FeedItem->new({
            feedId     => $feed->get_id(),
