...
use Google::Ads::AdWords::v201605::Dimensions;
use Google::Ads::AdWords::v201605::MediaBundle;
use Google::Ads::AdWords::v201605::TemplateAd;
use Google::Ads::AdWords::v201605::TemplateElementField;
...
sub add_html5_ad {
  ...
  my $html5_ad = Google::Ads::AdWords::v201605::TemplateAd->new({
      name       => "Ad for HTML5",
      templateId => 419,
      finalUrls  => ["http://example.com/html5"],
      displayUrl => "www.example.com/html5",
      dimensions => Google::Ads::AdWords::v201605::Dimensions->new({
          width  => 300,
          height => 250
        })});
  ...
  # for an example.
  my $media_bundle = Google::Ads::AdWords::v201605::MediaBundle->new({
      data       => $html5_zip,
  ...
  my $media = Google::Ads::AdWords::v201605::TemplateElementField->new({
      name       => "Custom_layout",
      fieldMedia => $media_bundle,
      type       => "MEDIA_BUNDLE"
  });
  my $layout = Google::Ads::AdWords::v201605::TemplateElementField->new({
      name      => "layout",
      fieldText => "Custom",
      type      => "ENUM"
  });

  my $adData = Google::Ads::AdWords::v201605::TemplateElement->new({
      uniqueName => "adData",
      fields     => [$media, $layout]});
  ...
  my $html5_ad_group_ad = Google::Ads::AdWords::v201605::AdGroupAd->new({
