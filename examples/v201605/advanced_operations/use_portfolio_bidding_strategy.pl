...
use Google::Ads::AdWords::v201605::SharedBiddingStrategy;
use Google::Ads::AdWords::v201605::TargetSpendBiddingScheme;
use Google::Ads::AdWords::v201605::Money;
use Google::Ads::AdWords::v201605::BiddingStrategyOperation;
use Google::Ads::AdWords::v201605::BudgetOperation;
use Google::Ads::AdWords::v201605::NetworkSetting;
...
sub create_bidding_strategy {
  ...
  my $bidding_strategy =
    Google::Ads::AdWords::v201605::SharedBiddingStrategy->new({
      name => "Maximize Clicks " . uniqid(),
      type => "TARGET_SPEND",

      # Create the bidding scheme.
      biddingScheme =>
        Google::Ads::AdWords::v201605::TargetSpendBiddingScheme->new({
          # Optionally set additional bidding scheme parameters.
          bidCeiling => Google::Ads::AdWords::v201605::Money->new(
            {microAmount => 2000000,}
          ),
          spendTarget => Google::Ads::AdWords::v201605::Money->new(
            {microAmount => 20000000,})})});

  # Create operation.
  my $operation = Google::Ads::AdWords::v201605::BiddingStrategyOperation->new({
      operator => "ADD",
...
sub create_shared_budget {
  ...
  my $operation = Google::Ads::AdWords::v201605::BudgetOperation->new({
      operator => 'ADD',
      operand  => Google::Ads::AdWords::v201605::Budget->new({
          period => 'DAILY',
          amount => Google::Ads::AdWords::v201605::Money->new(
...
sub create_campaign_with_bidding_strategy {
  ...
  my $campaign = Google::Ads::AdWords::v201605::Campaign->new({
      ...
      budget =>
        Google::Ads::AdWords::v201605::Budget->new({budgetId => $budget_id}),
      ...
      networkSetting => Google::Ads::AdWords::v201605::NetworkSetting->new({
  ...
  # Create operation.
  my $operation = Google::Ads::AdWords::v201605::CampaignOperation->new({
      operator => 'ADD',
      operand  => $campaign
  });
