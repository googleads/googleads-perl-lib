...
use Google::Ads::AdWords::v201605::AdCustomizerFeed;
use Google::Ads::AdWords::v201605::AdCustomizerFeedAttribute;
use Google::Ads::AdWords::v201605::AdCustomizerFeedOperation;
...
use Google::Ads::AdWords::v201605::Feed;
use Google::Ads::AdWords::v201605::FeedAttribute;
use Google::Ads::AdWords::v201605::FeedItem;
use Google::Ads::AdWords::v201605::FeedItemAdGroupTargeting;
use Google::Ads::AdWords::v201605::FeedItemAttributeValue;
use Google::Ads::AdWords::v201605::FeedItemOperation;
use Google::Ads::AdWords::v201605::Function;
use Google::Ads::AdWords::v201605::FunctionOperand;
use Google::Ads::AdWords::v201605::RequestContextOperand;
...
sub create_customizer_feed() {
  ...
  my $name_attribute =
    Google::Ads::AdWords::v201605::AdCustomizerFeedAttribute->new({
      type => "STRING",
      name => "Name"
    });
  my $price_attribute =
  ...
  my $ad_customizer_feed = Google::Ads::AdWords::v201605::AdCustomizerFeed->new(
    {
      feedName       => $feed_name,
      feedAttributes => [$name_attribute, $price_attribute, $date_attribute]});

  my $operation = Google::Ads::AdWords::v201605::AdCustomizerFeedOperation->new(
    {
      operator => "ADD",
...
sub create_feed_item_add_operation() {
  ...
  my $name_attribute_value =
    Google::Ads::AdWords::v201605::FeedItemAttributeValue->new({
      feedAttributeId =>
  ...
  my $feed_item = Google::Ads::AdWords::v201605::FeedItem->new({
      feedId => $ad_customizer_feed->get_feedId(),
      attributeValues =>
        [$name_attribute_value, $price_attribute_value, $date_attribute_value],
      adGroupTargeting =>
        Google::Ads::AdWords::v201605::FeedItemAdGroupTargeting->new(
        {TargetingAdGroupId => $ad_group_id})});

  my $operation = Google::Ads::AdWords::v201605::FeedItemOperation->new({
      operand  => $feed_item,
      operator => "ADD"
  });
  ...
  foreach my $ad_group_id (@{$ad_group_ids}) {
    push @operations,
      Google::Ads::AdWords::v201605::AdGroupAdOperation->new({
        operator => "ADD",
        operand  => Google::Ads::AdWords::v201605::AdGroupAd->new({
