...
use Google::Ads::AdWords::v201605::CustomParameter;
use Google::Ads::AdWords::v201605::CustomParameters;
use Google::Ads::AdWords::v201605::Image;
use Google::Ads::AdWords::v201605::ImageAd;
use Google::Ads::AdWords::v201605::TemplateAd;
use Google::Ads::AdWords::v201605::TextAd;
use Google::Ads::AdWords::v201605::Video;
...
sub add_text_ad_with_upgraded_urls {
  ...
  # or feed item levels.
  my $season_parameter = Google::Ads::AdWords::v201605::CustomParameter->new({
      key   => "season",
      value => "christmas"
  });
  my $promo_code_parameter =
    Google::Ads::AdWords::v201605::CustomParameter->new({
      key   => "promocode",
      value => "NYC123"
    });
  my $tracking_url_parameters =
    Google::Ads::AdWords::v201605::CustomParameters->new(
