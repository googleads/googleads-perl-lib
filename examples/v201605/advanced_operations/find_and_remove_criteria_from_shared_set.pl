...
use Google::Ads::AdWords::v201605::CampaignSharedSet;
use Google::Ads::AdWords::v201605::CampaignSharedSetOperation;
use Google::Ads::AdWords::v201605::Criterion;
use Google::Ads::AdWords::v201605::Keyword;
use Google::Ads::AdWords::v201605::OrderBy;
use Google::Ads::AdWords::v201605::Paging;
use Google::Ads::AdWords::v201605::Placement;
use Google::Ads::AdWords::v201605::Predicate;
use Google::Ads::AdWords::v201605::Selector;
use Google::Ads::AdWords::v201605::SharedCriterion;
use Google::Ads::AdWords::v201605::SharedCriterionOperation;
use Google::Ads::AdWords::v201605::SharedSet;
use Google::Ads::AdWords::v201605::SharedSetOperation;
...
sub find_and_remove_criteria_from_shared_set {
  ...
  my $selector = Google::Ads::AdWords::v201605::Selector->new({
      ...
      predicates => [
        Google::Ads::AdWords::v201605::Predicate->new({
            field    => "CampaignId",
            operator => "EQUALS",
            values   => [$campaign_id]})
      ],
  ...
  $paging = Google::Ads::AdWords::v201605::Paging->new({
      startIndex    => 0,
      numberResults => PAGE_SIZE
  });
  $selector = Google::Ads::AdWords::v201605::Selector->new({
      fields => [
  ...
  my @remove_criterion_operations =
    ...
    sub {
      ...
      if ($criterion->isa("Google::Ads::AdWords::v201605::Keyword")) {
        printf "Shared negative keyword with ID %d and text '%s' was " .
          "found.\n",
          $criterion->get_id(),
          $criterion->get_text();
      } elsif ($criterion->isa("Google::Ads::AdWords::v201605::Placement")) {
      ...
      my $shared_criterion_operation =
        Google::Ads::AdWords::v201605::SharedCriterionOperation->new({
          operator => 'REMOVE',
          operand  => Google::Ads::AdWords::v201605::SharedCriterion->new({
              criterion => Google::Ads::AdWords::v201605::Criterion->new(
                {id => $criterion->get_id()}
              ),
