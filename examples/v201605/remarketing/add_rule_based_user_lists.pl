...
use Google::Ads::AdWords::v201605::BasicUserList;
use Google::Ads::AdWords::v201605::DateKey;
use Google::Ads::AdWords::v201605::DateRuleItem;
use Google::Ads::AdWords::v201605::DateSpecificRuleUserList;
use Google::Ads::AdWords::v201605::ExpressionRuleUserList;
use Google::Ads::AdWords::v201605::NumberKey;
use Google::Ads::AdWords::v201605::NumberRuleItem;
use Google::Ads::AdWords::v201605::Operator;
use Google::Ads::AdWords::v201605::Rule;
use Google::Ads::AdWords::v201605::RuleItem;
use Google::Ads::AdWords::v201605::RuleItemGroup;
use Google::Ads::AdWords::v201605::StringKey;
use Google::Ads::AdWords::v201605::StringRuleItem;
use Google::Ads::AdWords::v201605::UserListOperation;
...
sub add_rule_based_user_lists {
  ...
  my $checkout_string_rule_item =
    Google::Ads::AdWords::v201605::StringRuleItem->new({
      key => Google::Ads::AdWords::v201605::StringKey->new(
        {name => "ecomm_pagetype"}
      ),
      op    => "EQUALS",
      value => "checkout"
    });
  my $checkout_rule_item = Google::Ads::AdWords::v201605::RuleItem->new(
    {StringRuleItem => $checkout_string_rule_item});

  my $cart_size_number_rule_item =
    Google::Ads::AdWords::v201605::NumberRuleItem->new({
      key =>
        Google::Ads::AdWords::v201605::NumberKey->new({name => "cartsize"}),
      op    => "GREATER_THAN",
      value => "1"
    });
  my $cart_size_rule_item = Google::Ads::AdWords::v201605::RuleItem->new(
  ...
  my $checkout_multiple_item_group =
    Google::Ads::AdWords::v201605::RuleItemGroup->new(
  ...
  my $start_date_date_rule_item =
    Google::Ads::AdWords::v201605::DateRuleItem->new({
      key =>
        Google::Ads::AdWords::v201605::DateKey->new({name => "checkoutdate"}),
      op    => "AFTER",
      value => $rule_start_date
    });

  my $start_date_rule_item = Google::Ads::AdWords::v201605::RuleItem->new(
  ...
  my $end_date_rule_item = Google::Ads::AdWords::v201605::RuleItem->new(
  ...
  # together.
  my $rule = Google::Ads::AdWords::v201605::Rule->new({
      groups => [
  ...
  my $expression_user_list =
    Google::Ads::AdWords::v201605::ExpressionRuleUserList->new({
  ...
  my $date_user_list =
    Google::Ads::AdWords::v201605::DateSpecificRuleUserList->new({
  ...
  my $operations = [
    Google::Ads::AdWords::v201605::UserListOperation->new({
        operator => "ADD",
