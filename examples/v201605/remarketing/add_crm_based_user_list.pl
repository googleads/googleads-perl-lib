...
use Google::Ads::AdWords::v201605::CrmBasedUserList;
use Google::Ads::AdWords::v201605::MutateMembersOperand;
use Google::Ads::AdWords::v201605::MutateMembersOperation;
...
sub add_crm_based_user_list {
  ...
  my $user_list = Google::Ads::AdWords::v201605::CrmBasedUserList->new({
  ...
  if ($result->get_value()) {
    ...
    my $operand     = Google::Ads::AdWords::v201605::MutateMembersOperand->new({
        userListId => $userlist_id,
        members    => \@email_list
    });

    my $member_operation =
      Google::Ads::AdWords::v201605::MutateMembersOperation->new({
        operator => "ADD",
        operand  => $operand
      });
