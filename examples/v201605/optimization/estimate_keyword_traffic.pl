...
use Google::Ads::AdWords::v201605::AdGroupEstimateRequest;
use Google::Ads::AdWords::v201605::CampaignEstimateRequest;
use Google::Ads::AdWords::v201605::Keyword;
use Google::Ads::AdWords::v201605::KeywordEstimateRequest;
use Google::Ads::AdWords::v201605::Language;
use Google::Ads::AdWords::v201605::Location;
use Google::Ads::AdWords::v201605::TrafficEstimatorSelector;
...
sub estimate_keyword_traffic {
  ...
  my @keywords = (
    Google::Ads::AdWords::v201605::Keyword->new({
        text      => "mars cruise",
        matchType => "BROAD"
      }
    ),
  ...
  foreach my $keyword (@keywords) {
    push @keyword_estimate_requests,
      Google::Ads::AdWords::v201605::KeywordEstimateRequest->new(
      {keyword => $keyword,});
  }
  ...
  my $ad_group_estimate_request =
    Google::Ads::AdWords::v201605::AdGroupEstimateRequest->new({
      keywordEstimateRequests => \@keyword_estimate_requests,
      maxCpc =>
        Google::Ads::AdWords::v201605::Money->new({microAmount => 1000000})});

  my $location = Google::Ads::AdWords::v201605::Location->new({
      id => "2840"    # US - see http://goo.gl/rlrFr
  });
  my $language = Google::Ads::AdWords::v201605::Language->new({
      id => "1000"    # en - see http://goo.gl/LvMmS
  });

  # Create campaign estimate requests.
  my $campaign_estimate_request =
    Google::Ads::AdWords::v201605::CampaignEstimateRequest->new({
  ...
  # Create selector.
  my $selector = Google::Ads::AdWords::v201605::TrafficEstimatorSelector->new({
