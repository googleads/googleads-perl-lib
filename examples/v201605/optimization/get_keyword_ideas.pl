...
use Google::Ads::AdWords::v201605::LanguageSearchParameter;
use Google::Ads::AdWords::v201605::NetworkSearchParameter;
use Google::Ads::AdWords::v201605::NetworkSetting;
use Google::Ads::AdWords::v201605::Paging;
use Google::Ads::AdWords::v201605::RelatedToQuerySearchParameter;
use Google::Ads::AdWords::v201605::TargetingIdeaSelector;
...
sub get_keyword_ideas {
  ...
  # Create selector.
  my $selector = Google::Ads::AdWords::v201605::TargetingIdeaSelector->new({
      requestType => "IDEAS",
      ideaType    => "KEYWORD",
  ...
  my $related_to_query_search_parameter =
    Google::Ads::AdWords::v201605::RelatedToQuerySearchParameter->new(
    {queries => [$keyword],});
  ...
  my $language_english =
    Google::Ads::AdWords::v201605::Language->new({id => 1000});
  my $language_search_parameter =
    Google::Ads::AdWords::v201605::LanguageSearchParameter->new(
    {languages => [$language_english]});

  # Create network search paramter (optional).
  my $network_setting = Google::Ads::AdWords::v201605::NetworkSetting->new({
  ...
  my $network_setting_parameter =
    Google::Ads::AdWords::v201605::NetworkSearchParameter->new(
