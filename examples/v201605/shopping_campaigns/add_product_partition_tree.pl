...
use Google::Ads::AdWords::v201605::BiddingStrategyConfiguration;
use Google::Ads::AdWords::v201605::CpcBid;
use Google::Ads::AdWords::v201605::Criterion;
use Google::Ads::AdWords::v201605::Money;
use Google::Ads::AdWords::v201605::NegativeAdGroupCriterion;
use Google::Ads::AdWords::v201605::ProductBiddingCategory;
use Google::Ads::AdWords::v201605::ProductCanonicalCondition;
use Google::Ads::AdWords::v201605::ProductBrand;
use Google::Ads::AdWords::v201605::ProductPartition;
...
sub add_product_partition_tree {
  ...
  create_unit(
    ...
    $ad_group_id,
    $root,
    Google::Ads::AdWords::v201605::ProductCanonicalCondition->new(
      {condition => "NEW"}
    ),
    200000
  );
  ...
  create_unit($operations, $ad_group_id, $other_condition,
    Google::Ads::AdWords::v201605::ProductBrand->new({value => "CoolBrand"}),
    900000);

  create_unit($operations, $ad_group_id, $other_condition,
    Google::Ads::AdWords::v201605::ProductBrand->new({value => "CheapBrand"}),
    10000);

  my $other_brand =
    create_subdivision($operations, $next_id--, $ad_group_id, $other_condition,
    Google::Ads::AdWords::v201605::ProductBrand->new());
  ...
  create_unit(
    ...
    $ad_group_id,
    $other_brand,
    Google::Ads::AdWords::v201605::ProductBiddingCategory->new({
...
sub create_subdivision {
  ...
  my $division = Google::Ads::AdWords::v201605::ProductPartition->new({
  ...
  my $criterion = Google::Ads::AdWords::v201605::BiddableAdGroupCriterion->new({
...
sub create_unit {
  ...
  my $unit = Google::Ads::AdWords::v201605::ProductPartition->new(
    {partitionType => "UNIT",});
  ...
  if ($bid_amount && $bid_amount > 0) {
    ...
    $criterion = Google::Ads::AdWords::v201605::NegativeAdGroupCriterion->new();
  }
...
sub create_add_operation {
  ...
  my $operation = Google::Ads::AdWords::v201605::AdGroupCriterionOperation->new(
    {
