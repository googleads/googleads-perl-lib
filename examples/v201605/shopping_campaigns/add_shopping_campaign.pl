...
use Google::Ads::AdWords::v201605::ProductAd;
use Google::Ads::AdWords::v201605::ShoppingSetting;
...
sub add_shopping_campaign {
  ...
  my $campaign = Google::Ads::AdWords::v201605::Campaign->new({
      ...
      settings => [
        ...
        Google::Ads::AdWords::v201605::ShoppingSetting->new({
            salesCountry     => "US",
            campaignPriority => 0,
  ...
  # Create operation
  $operation = Google::Ads::AdWords::v201605::AdGroupOperation->new({
      operand  => $ad_group,
      operator => "ADD"
  });
  ...
  # Create product ad
  my $product_ad = Google::Ads::AdWords::v201605::ProductAd->new();

  # Create ad group ad
  my $ad_group_ad = Google::Ads::AdWords::v201605::AdGroupAd->new({
      adGroupId => $ad_group->get_id(),
      ad        => $product_ad
  });

  # Create operation
  $operation = Google::Ads::AdWords::v201605::AdGroupAdOperation->new({
      operand  => $ad_group_ad,
      operator => "ADD"
  });
