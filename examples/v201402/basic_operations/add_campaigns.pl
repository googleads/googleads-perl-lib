...
use Google::Ads::AdWords::v201402::FrequencyCap;
use Google::Ads::AdWords::v201402::GeoTargetTypeSetting;
use Google::Ads::AdWords::v201402::KeywordMatchSetting;
use Google::Ads::AdWords::v201402::ManualCpcBiddingScheme;
...
sub add_campaigns {
  ...
  my $budget_operation = Google::Ads::AdWords::v201402::BudgetOperation->new({
    operator => "ADD",
    operand => $budget
  });
  ...
  for (my $i = 0; $i < $num_campaigns; $i++) {
    ...
    my $campaign = Google::Ads::AdWords::v201402::Campaign->new({
      ...
      frequencyCap => Google::Ads::AdWords::v201402::FrequencyCap->new({
        impressions => 5,
        timeUnit => "DAY",
        level => "ADGROUP"
      }),
      settings => [
          ...
          Google::Ads::AdWords::v201402::GeoTargetTypeSetting->new({
