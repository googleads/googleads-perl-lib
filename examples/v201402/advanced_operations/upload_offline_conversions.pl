...
use Google::Ads::AdWords::v201402::UploadConversion;
use Google::Ads::AdWords::v201402::ConversionTrackerOperation;
use Google::Ads::AdWords::v201402::OfflineConversionFeed;
use Google::Ads::AdWords::v201402::OfflineConversionFeedOperation;
...
sub upload_offline_conversions {
  ...
  my $upload_conversion = Google::Ads::AdWords::v201402::UploadConversion->new({
    category => 'PAGE_VIEW',
