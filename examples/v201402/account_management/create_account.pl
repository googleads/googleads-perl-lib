...
use Google::Ads::AdWords::v201402::ManagedCustomer;
use Google::Ads::AdWords::v201402::ManagedCustomerOperation;
...
sub create_account {
  ...
  my $account = Google::Ads::AdWords::v201402::ManagedCustomer->new({
  ...
  my $operation = Google::Ads::AdWords::v201402::ManagedCustomerOperation->new({
    operator        => "ADD",
    operand         => $account
  });
