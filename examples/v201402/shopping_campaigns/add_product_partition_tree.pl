...
use Google::Ads::AdWords::v201402::NegativeAdGroupCriterion;
use Google::Ads::AdWords::v201402::ProductBiddingCategory;
use Google::Ads::AdWords::v201402::ProductCanonicalCondition;
use Google::Ads::AdWords::v201402::ProductBrand;
use Google::Ads::AdWords::v201402::ProductPartition;
...
sub add_product_partition_tree {
  ...
  create_unit($operations, $ad_group_id, $root,
    Google::Ads::AdWords::v201402::ProductCanonicalCondition->new({
      condition => "NEW"
    }),
    200000);
  ...
  create_unit($operations, $ad_group_id, $other_condition,
    Google::Ads::AdWords::v201402::ProductBrand->new({
      value => "CoolBrand"
    }),
    900000);
  ...
  create_unit($operations, $ad_group_id, $other_brand,
    Google::Ads::AdWords::v201402::ProductBiddingCategory->new({
...
sub create_subdivision {
  ...
  my $division = Google::Ads::AdWords::v201402::ProductPartition->new({
...
sub create_unit {
  ...
  my $unit = Google::Ads::AdWords::v201402::ProductPartition->new({
    partitionType => "UNIT",
  });
  ...
  if ($bid_amount && $bid_amount > 0) {
    ...
    $criterion = Google::Ads::AdWords::v201402::NegativeAdGroupCriterion->new();
  }
...
sub create_add_operation {
  ...
  my $operation =
    Google::Ads::AdWords::v201402::AdGroupCriterionOperation->new({
