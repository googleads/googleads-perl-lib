...
use Google::Ads::AdWords::v201402::ProductCustomAttribute;
use Google::Ads::AdWords::v201402::ProductOfferId;
use Google::Ads::AdWords::v201402::ProductScope;
use Google::Ads::AdWords::v201402::ProductType;
...
sub add_product_scope {
  ...
  my $product_scope = Google::Ads::AdWords::v201402::ProductScope->new({
    ...
    dimensions => [
      ...
      Google::Ads::AdWords::v201402::ProductCustomAttribute->new({
        type => "CUSTOM_ATTRIBUTE_0",
        value => "my attribute value"
      }),
      Google::Ads::AdWords::v201402::ProductOfferId->new({
        value => "book1"
      }),
      Google::Ads::AdWords::v201402::ProductType->new({
  ...
  my $campaign_criterion = Google::Ads::AdWords::v201402::CampaignCriterion->
    new({
  ...
  # Create operation.
  my $operation = Google::Ads::AdWords::v201402::CampaignCriterionOperation->
    new({
