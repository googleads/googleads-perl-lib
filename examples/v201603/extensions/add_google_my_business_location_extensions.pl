...
use Google::Ads::AdWords::v201603::ConstantOperand;
use Google::Ads::AdWords::v201603::CustomerFeed;
use Google::Ads::AdWords::v201603::CustomerFeedOperation;
use Google::Ads::AdWords::v201603::Feed;
use Google::Ads::AdWords::v201603::FeedOperation;
use Google::Ads::AdWords::v201603::Function;
use Google::Ads::AdWords::v201603::PlacesLocationFeedData;
use Google::Ads::AdWords::v201603::OAuthInfo;
...
sub add_gmb_location_extensions {
  ...
  my $gmb_feed = Google::Ads::AdWords::v201603::Feed->new({
  ...
  my $oauth_info = Google::Ads::AdWords::v201603::OAuthInfo->new({
      httpMethod     => "GET",
      httpRequestUrl => Google::Ads::AdWords::Constants::DEFAULT_OAUTH_SCOPE,
      httpAuthorizationHeader => "Bearer ${gmb_access_token}"
  });
  my $feed_data = Google::Ads::AdWords::v201603::PlacesLocationFeedData->new({
  ...
  my $feed_operation = Google::Ads::AdWords::v201603::FeedOperation->new({
      operand  => $gmb_feed,
      operator => "ADD"
  });
  ...
  my $feed_result = $client->FeedService()->mutate({
      operations => [
        Google::Ads::AdWords::v201603::FeedOperation->new({
            operator => "ADD",
            operand  => $gmb_feed
          })]});
  ...
  my $customer_feed = Google::Ads::AdWords::v201603::CustomerFeed->new({
      feedId           => $added_feed->get_id(),
      placeholderTypes => [PLACEHOLDER_LOCATION]});

  # Create a matching function that will always evaluate to true.
  my $customer_matching_function = Google::Ads::AdWords::v201603::Function->new(
    {
      lhsOperand => [
        Google::Ads::AdWords::v201603::ConstantOperand->new({
            type         => "BOOLEAN",
            booleanValue => 1
          })
      ],
  ...
  my $customer_feed_operation =
    Google::Ads::AdWords::v201603::CustomerFeedOperation->new({
