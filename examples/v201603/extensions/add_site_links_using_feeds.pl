...
use Google::Ads::AdWords::v201603::AttributeFieldMapping;
use Google::Ads::AdWords::v201603::CampaignFeed;
use Google::Ads::AdWords::v201603::CampaignFeedOperation;
use Google::Ads::AdWords::v201603::Feed;
use Google::Ads::AdWords::v201603::FeedAttribute;
use Google::Ads::AdWords::v201603::FeedItem;
use Google::Ads::AdWords::v201603::FeedItemAttributeValue;
use Google::Ads::AdWords::v201603::FeedItemOperation;
use Google::Ads::AdWords::v201603::FeedMapping;
use Google::Ads::AdWords::v201603::FeedMappingOperation;
use Google::Ads::AdWords::v201603::FeedOperation;
use Google::Ads::AdWords::v201603::Function;
use Google::Ads::AdWords::v201603::Location;
...
sub create_site_links_feed() {
  ...
  my $text_attribute = Google::Ads::AdWords::v201603::FeedAttribute->new({
      type => "STRING",
      name => "Link Text"
  });
  my $final_url_attribute = Google::Ads::AdWords::v201603::FeedAttribute->new({
      type => "URL_LIST",
      name => "Link Final URLs"
  });
  my $line_1_attribute = Google::Ads::AdWords::v201603::FeedAttribute->new({
      type => "STRING",
      name => "Line 1 Description"
  });
  my $line_2_attribute = Google::Ads::AdWords::v201603::FeedAttribute->new({
      type => "STRING",
      name => "Line 2 Description"
  });
  my $feed = Google::Ads::AdWords::v201603::Feed->new({
      name       => $feed_name,
      attributes => [
  ...
  my $operation = Google::Ads::AdWords::v201603::FeedOperation->new({
      operator => "ADD",
      operand  => $feed
  });
...
sub create_feed_item_add_operation() {
  ...
  my $text_attribute_value =
    Google::Ads::AdWords::v201603::FeedItemAttributeValue->new({
  ...
  my $feed_item = Google::Ads::AdWords::v201603::FeedItem->new({
  ...
  if ($location_id) {
    my $location =
      Google::Ads::AdWords::v201603::Location->new({id => $location_id});
    $feed_item->set_geoTargeting($location);
  }

  my $operation = Google::Ads::AdWords::v201603::FeedItemOperation->new({
      operand  => $feed_item,
      operator => "ADD"
  });
...
sub create_site_links_feed_mapping() {
  ...
  my $text_field_mapping =
    Google::Ads::AdWords::v201603::AttributeFieldMapping->new({
      feedAttributeId => $site_links_data->{"linkTextFeedAttributeId"},
  ...
  my $feed_mapping = Google::Ads::AdWords::v201603::FeedMapping->new({
  ...
  my $operation = Google::Ads::AdWords::v201603::FeedMappingOperation->new({
...
sub create_site_links_campaign_feed() {
  ...
  my $matching_function = Google::Ads::AdWords::v201603::Function->new(
    {functionString => $matching_function_string});

  my $campaign_feed = Google::Ads::AdWords::v201603::CampaignFeed->new({
      feedId           => $site_links_data->{"siteLinksFeedId"},
  ...
  my $result = $client->CampaignFeedService()->mutate({
      operations => [
        Google::Ads::AdWords::v201603::CampaignFeedOperation->new({
