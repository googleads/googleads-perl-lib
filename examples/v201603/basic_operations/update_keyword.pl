...
sub update_keyword {
  ...
  my $criterion =
    Google::Ads::AdWords::v201603::Criterion->new({id => $keyword_id,});
  ...
  # Create bids.
  my $bids = Google::Ads::AdWords::v201603::BiddingStrategyConfiguration->new({
      bids => [
  ...
  # Create operation.
  my $operation = Google::Ads::AdWords::v201603::AdGroupCriterionOperation->new(
    {
