...
use Google::Ads::AdWords::v201603::ManagedCustomer;
use Google::Ads::AdWords::v201603::ManagedCustomerOperation;
...
sub create_account {
  ...
  my $account = Google::Ads::AdWords::v201603::ManagedCustomer->new({
  ...
  my $operation = Google::Ads::AdWords::v201603::ManagedCustomerOperation->new({
      operator => "ADD",
      operand  => $account
  });
