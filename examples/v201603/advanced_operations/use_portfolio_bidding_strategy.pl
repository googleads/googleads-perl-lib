...
use Google::Ads::AdWords::v201603::SharedBiddingStrategy;
use Google::Ads::AdWords::v201603::TargetSpendBiddingScheme;
use Google::Ads::AdWords::v201603::Money;
use Google::Ads::AdWords::v201603::BiddingStrategyOperation;
use Google::Ads::AdWords::v201603::BudgetOperation;
use Google::Ads::AdWords::v201603::NetworkSetting;
...
sub create_bidding_strategy {
  ...
  my $bidding_strategy =
    Google::Ads::AdWords::v201603::SharedBiddingStrategy->new({
      name => "Maximize Clicks " . uniqid(),
      type => "TARGET_SPEND",

      # Create the bidding scheme.
      biddingScheme =>
        Google::Ads::AdWords::v201603::TargetSpendBiddingScheme->new({
          # Optionally set additional bidding scheme parameters.
          bidCeiling => Google::Ads::AdWords::v201603::Money->new(
            {microAmount => 2000000,}
          ),
          spendTarget => Google::Ads::AdWords::v201603::Money->new(
            {microAmount => 20000000,})})});

  # Create operation.
  my $operation = Google::Ads::AdWords::v201603::BiddingStrategyOperation->new({
      operator => "ADD",
...
sub create_shared_budget {
  ...
  my $operation = Google::Ads::AdWords::v201603::BudgetOperation->new({
      operator => 'ADD',
      operand  => Google::Ads::AdWords::v201603::Budget->new({
          period => 'DAILY',
          amount => Google::Ads::AdWords::v201603::Money->new(
...
sub create_campaign_with_bidding_strategy {
  ...
  my $campaign = Google::Ads::AdWords::v201603::Campaign->new({
      ...
      budget =>
        Google::Ads::AdWords::v201603::Budget->new({budgetId => $budget_id}),
      ...
      networkSetting => Google::Ads::AdWords::v201603::NetworkSetting->new({
  ...
  # Create operation.
  my $operation = Google::Ads::AdWords::v201603::CampaignOperation->new({
      operator => 'ADD',
      operand  => $campaign
  });
