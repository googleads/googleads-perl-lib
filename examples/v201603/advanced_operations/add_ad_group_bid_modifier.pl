...
use Google::Ads::AdWords::v201603::AdGroupBidModifierOperation;
use Google::Ads::AdWords::v201603::AdGroupBidModifier;
use Google::Ads::AdWords::v201603::Platform;
...
sub add_ad_group_bid_modifier {
  ...
  my $mobile = Google::Ads::AdWords::v201603::Platform->new({id => 30001});

  # Create the bid modifier.
  my $modifier = Google::Ads::AdWords::v201603::AdGroupBidModifier->new({
  ...
  my $operation =
    Google::Ads::AdWords::v201603::AdGroupBidModifierOperation->new({
      operator => "ADD",
      operand  => $modifier
    });
