...
use Google::Ads::AdWords::v201603::CampaignExtensionSetting;
use Google::Ads::AdWords::v201603::CampaignExtensionSettingOperation;
use Google::Ads::AdWords::v201603::CampaignFeedOperation;
use Google::Ads::AdWords::v201603::ExtensionSetting;
use Google::Ads::AdWords::v201603::ExtensionSetting::Platform;
use Google::Ads::AdWords::v201603::FeedItem;
use Google::Ads::AdWords::v201603::FeedItemOperation;
use Google::Ads::AdWords::v201603::SitelinkFeedItem;
use Google::Ads::AdWords::v201603::UrlList;
...
sub get_feed_items_from_argument() {
  ...
  if ( $lhs_operand_size == 1
    && $lhs_operand->[0]
    ->isa("Google::Ads::AdWords::v201603::RequestContextOperand")
...
sub create_extension_setting() {
  ...
  my $campaign_extension_setting =
    Google::Ads::AdWords::v201603::CampaignExtensionSetting->new({
  ...
  foreach my $feed_item_id (@{$feed_item_ids}) {
    ...
    my $sitelink_feed_item =
      Google::Ads::AdWords::v201603::SitelinkFeedItem->new({
    ...
    if ($item_attributes->{'final_urls'}) {
      $sitelink_feed_item->set_sitelinkFinalUrls(
        Google::Ads::AdWords::v201603::UrlList->new(
  ...
  $campaign_extension_setting->set_extensionSetting(
    Google::Ads::AdWords::v201603::ExtensionSetting->new({
  ...
  my $result = $client->CampaignExtensionSettingService()->mutate({
      operations => [
        Google::Ads::AdWords::v201603::CampaignExtensionSettingOperation->new({
...
sub delete_old_feed_items() {
  ...
  foreach my $feed_item_id (@{$feed_item_ids}) {
    push @operations,
      Google::Ads::AdWords::v201603::FeedItemOperation->new({
        operator => 'REMOVE',
        operand  => Google::Ads::AdWords::v201603::FeedItem->new({
            feedId     => $feed->get_id(),
