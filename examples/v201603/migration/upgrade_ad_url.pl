...
use Google::Ads::AdWords::v201603::AdUrlUpgrade;
...
sub upgrade_ad_url {
  ...
  if ($ad_group_ad) {
    ...
    my $ad_url_upgrade = Google::Ads::AdWords::v201603::AdUrlUpgrade->new({
...
sub get_ad_group_ad {
  ...
  my $ad_id_predicate = Google::Ads::AdWords::v201603::Predicate->new({
      field    => "Id",
      operator => "EQUALS",
      values   => [$ad_id]});
