...
use Google::Ads::AdWords::v201603::Draft;
use Google::Ads::AdWords::v201603::DraftOperation;
...
sub add_draft {
  ...
  my $draft = Google::Ads::AdWords::v201603::Draft->new({
      baseCampaignId => $base_campaign_id,
      draftName      => sprintf("Test Draft #%s", uniqid())});

  # Create operation.
  my $draft_operation = Google::Ads::AdWords::v201603::DraftOperation->new({
      operator => "ADD",
      operand  => $draft
  });
  ...
  if ($result) {
    ...
    my $criterion = Google::Ads::AdWords::v201603::Language->new({
        id => 1003    # Spanish
    });
    ...
    my $operation =
      Google::Ads::AdWords::v201603::CampaignCriterionOperation->new({
        operator => "ADD",
        operand  => Google::Ads::AdWords::v201603::CampaignCriterion->new({
