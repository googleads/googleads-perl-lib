...
use Google::Ads::AdWords::v201603::AdGroup;
use Google::Ads::AdWords::v201603::AdGroupAd;
use Google::Ads::AdWords::v201603::AdGroupAdOperation;
use Google::Ads::AdWords::v201603::AdGroupCriterionOperation;
use Google::Ads::AdWords::v201603::AdGroupOperation;
use Google::Ads::AdWords::v201603::BatchJob;
use Google::Ads::AdWords::v201603::BatchJobOperation;
use Google::Ads::AdWords::v201603::BiddableAdGroupCriterion;
use Google::Ads::AdWords::v201603::Budget;
use Google::Ads::AdWords::v201603::BudgetOperation;
use Google::Ads::AdWords::v201603::CampaignCriterionOperation;
use Google::Ads::AdWords::v201603::CampaignOperation;
use Google::Ads::AdWords::v201603::CpcBid;
use Google::Ads::AdWords::v201603::Keyword;
use Google::Ads::AdWords::v201603::Money;
use Google::Ads::AdWords::v201603::NegativeCampaignCriterion;
use Google::Ads::AdWords::v201603::Predicate;
use Google::Ads::AdWords::v201603::Paging;
use Google::Ads::AdWords::v201603::Selector;
use Google::Ads::AdWords::v201603::TextAd;
...
sub add_complete_campaign_using_batch_job {
  ...
  my $operation = Google::Ads::AdWords::v201603::BatchJobOperation->new({
      operator => 'ADD',
      operand  => Google::Ads::AdWords::v201603::BatchJob->new({})});
...
sub _create_budget_operation {
  my $budget = Google::Ads::AdWords::v201603::Budget->new({
      # Required attributes.
      budgetId => _next_id(),
      name     => "Interplanetary budget #" . uniqid(),
      amount =>
        Google::Ads::AdWords::v201603::Money->new({microAmount => 5000000}),
      deliveryMethod => "STANDARD"
  });

  my $budget_operation = Google::Ads::AdWords::v201603::BudgetOperation->new({
      operator => "ADD",
      operand  => $budget
  });
...
sub _create_campaign_operations {
  ...
  for (my $i = 1 ; $i < NUMBER_OF_CAMPAIGNS_TO_ADD ; $i++) {
    my $campaign = Google::Ads::AdWords::v201603::Campaign->new({
        id                     => _next_id(),
        ...
        biddingStrategyConfiguration =>
          Google::Ads::AdWords::v201603::BiddingStrategyConfiguration->new({
            biddingStrategyType => "MANUAL_CPC",
            # You can optionally provide a bidding scheme in place of the type.
          }
          ),
        budget => Google::Ads::AdWords::v201603::Budget->new(
          {budgetId => $budget_operation->get_operand()->get_budgetId()})});
    my $campaign_operation =
      Google::Ads::AdWords::v201603::CampaignOperation->new({
        operator => "ADD",
        operand  => $campaign
      });
...
sub _create_campaign_criterion_operations() {
  ...
  for my $campaign_operation (@campaign_operations) {
    # Create keyword.
    my $keyword = Google::Ads::AdWords::v201603::Keyword->new(
      {matchType => "BROAD", text => "venus"});

    my $negative_criterion =
      Google::Ads::AdWords::v201603::NegativeCampaignCriterion->new({
    ...
    my $negative_criterion_operation =
      Google::Ads::AdWords::v201603::CampaignCriterionOperation->new({
        operator => "ADD",
...
sub _create_ad_group_operations {
  ...
  for my $campaign_operation (@campaign_operations) {
    for (my $i = 1 ; $i < NUMBER_OF_ADGROUPS_TO_ADD ; $i++) {
      my $ad_group = Google::Ads::AdWords::v201603::AdGroup->new({
          id         => _next_id(),
          campaignId => $campaign_operation->get_operand()->get_id(),
          ...
          biddingStrategyConfiguration =>
            Google::Ads::AdWords::v201603::BiddingStrategyConfiguration->new({
              bids => [
                Google::Ads::AdWords::v201603::CpcBid->new({
                    bid => Google::Ads::AdWords::v201603::Money->new(
                      {microAmount => 10000000})})]})});
      my $ad_group_operation =
        Google::Ads::AdWords::v201603::AdGroupOperation->new({
          operator => "ADD",
          operand  => $ad_group
        });
  ...
  for my $ad_group_operation (@ad_group_operations) {
    for (my $i = 1 ; $i < NUMBER_OF_KEYWORDS_TO_ADD ; $i++) {
      ...
      my $ad_group_criterion =
        Google::Ads::AdWords::v201603::BiddableAdGroupCriterion->new({
      ...
      my $ad_group_criterion_operation =
        Google::Ads::AdWords::v201603::AdGroupCriterionOperation->new({
          operator => "ADD",
...
sub _create_ad_group_ad_operations() {
  ...
  for my $ad_group_operation (@ad_group_operations) {
    ...
    my $text_ad = Google::Ads::AdWords::v201603::TextAd->new({
        headline     => "Cruise to Mars",
        description1 => "Visit the Red Planet in style.",
        description2 => "Low-gravity for everyone!",
        displayUrl   => "www.example.com",
        finalUrls    => ["http://www.example.com/1"]});

    # Create ad group ad for the text ad.
    my $text_ad_group_ad = Google::Ads::AdWords::v201603::AdGroupAd->new({
    ...
    my $text_ad_group_ad_operation =
      Google::Ads::AdWords::v201603::AdGroupAdOperation->new({
        operator => "ADD",
...
sub _verify_operations {
  ...
  my $predicate = Google::Ads::AdWords::v201603::Predicate->new({
      field    => "Id",
      operator => "IN",
      values   => [$job_id]});
  my $paging = Google::Ads::AdWords::v201603::Paging->new({
      startIndex    => 0,
      numberResults => 1
  });
  my $selector = Google::Ads::AdWords::v201603::Selector->new({
      fields =>
...
my $client = Google::Ads::AdWords::Client->new({version => "v201603"});
