...
use Google::Ads::AdWords::v201603::AdGroupExperimentData;
use Google::Ads::AdWords::v201603::AdGroupOperation;
use Google::Ads::AdWords::v201603::BidMultiplier;
use Google::Ads::AdWords::v201603::BiddableAdGroupCriterion;
use Google::Ads::AdWords::v201603::BiddableAdGroupCriterionExperimentData;
use Google::Ads::AdWords::v201603::Criterion;
use Google::Ads::AdWords::v201603::Experiment;
use Google::Ads::AdWords::v201603::ExperimentOperation;
use
  Google::Ads::AdWords::v201603::ManualCPCAdGroupCriterionExperimentBidMultiplier;
use Google::Ads::AdWords::v201603::ManualCPCAdGroupExperimentBidMultipliers;
...
sub add_experiment {
  ...
  my $experiment = Google::Ads::AdWords::v201603::Experiment->new({
  ...
  my $experiment_operation =
    Google::Ads::AdWords::v201603::ExperimentOperation->new({
      operator => "ADD",
      operand  => $experiment
    });
  ...
  my $ad_group =
    Google::Ads::AdWords::v201603::AdGroup->new({id => $ad_group_id});

  # Create experiment bid multiplier rule that will modify ad group bid for the
  # experiment.
  my $bid_multiplier =
    Google::Ads::AdWords::v201603::ManualCPCAdGroupExperimentBidMultipliers->
    new({
      maxCpcMultiplier =>
        Google::Ads::AdWords::v201603::BidMultiplier->new({multiplier => 1.5})}
    );

  # Set experiment data to the ad group.
  my $experiment_data =
    Google::Ads::AdWords::v201603::AdGroupExperimentData->new({
  ...
  # Create operation.
  my $operation = Google::Ads::AdWords::v201603::AdGroupOperation->new({
      operand  => $ad_group,
      operator => "SET"
  });
  ...
  my $criterion =
    Google::Ads::AdWords::v201603::Criterion->new({id => $criterion_id,});
  ...
  $experiment_data =
    Google::Ads::AdWords::v201603::BiddableAdGroupCriterionExperimentData->new({
      experimentId            => $experiment_id,
      experimentDeltaStatus   => "MODIFIED",
  ...
  # Create operation.
  $operation = Google::Ads::AdWords::v201603::AdGroupCriterionOperation->new({
