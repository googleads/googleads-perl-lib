...
use Google::Ads::AdWords::v201603::UserListConversionType;
...
sub add_audience {
  ...
  my $conversion_type =
    Google::Ads::AdWords::v201603::UserListConversionType->new({name => $name});

  # Create remarketing user list.
  my $user_list = Google::Ads::AdWords::v201603::BasicUserList->new({
      name            => $name,
  ...
  # Create operation.
  my $operation = Google::Ads::AdWords::v201603::UserListOperation->new({
      operator => "ADD",
      operand  => $user_list
  });
