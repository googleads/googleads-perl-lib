...
use Google::Ads::AdWords::v201603::CrmBasedUserList;
use Google::Ads::AdWords::v201603::MutateMembersOperand;
use Google::Ads::AdWords::v201603::MutateMembersOperation;
...
sub add_crm_based_user_list {
  ...
  # Create a user list.
  my $user_list = Google::Ads::AdWords::v201603::CrmBasedUserList->new({
  ...
  if ($result->get_value()) {
    ...
    my $operand     = Google::Ads::AdWords::v201603::MutateMembersOperand->new({
        userListId => $userlist_id,
        members    => \@email_list
    });

    my $member_operation =
      Google::Ads::AdWords::v201603::MutateMembersOperation->new({
        operator => "ADD",
        operand  => $operand
      });
