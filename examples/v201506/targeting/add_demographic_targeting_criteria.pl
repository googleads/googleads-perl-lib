...
use Google::Ads::AdWords::v201506::AgeRange;
use Google::Ads::AdWords::v201506::BiddableAdGroupCriterion;
use Google::Ads::AdWords::v201506::Gender;
...
sub add_demographic_targeting_criteria {
  ...
  my $gender_male =
    Google::Ads::AdWords::v201506::Gender->new({id => GENDER_MALE});
  ...
  my $age_range = Google::Ads::AdWords::v201506::AgeRange->new(
  ...
  foreach my $criterion (@criteria) {
    my $operation =
      Google::Ads::AdWords::v201506::AdGroupCriterionOperation->new({
        operator => "ADD",
        operand => Google::Ads::AdWords::v201506::BiddableAdGroupCriterion->new(
          {
