...
use Google::Ads::AdWords::v201506::BasicUserList;
use Google::Ads::AdWords::v201506::DateKey;
use Google::Ads::AdWords::v201506::DateRuleItem;
use Google::Ads::AdWords::v201506::DateSpecificRuleUserList;
use Google::Ads::AdWords::v201506::ExpressionRuleUserList;
use Google::Ads::AdWords::v201506::NumberKey;
use Google::Ads::AdWords::v201506::NumberRuleItem;
use Google::Ads::AdWords::v201506::Operator;
use Google::Ads::AdWords::v201506::Rule;
use Google::Ads::AdWords::v201506::RuleItem;
use Google::Ads::AdWords::v201506::RuleItemGroup;
use Google::Ads::AdWords::v201506::StringKey;
use Google::Ads::AdWords::v201506::StringRuleItem;
use Google::Ads::AdWords::v201506::UserListOperation;
...
sub add_rule_based_user_lists {
  ...
  my $checkout_string_rule_item =
    Google::Ads::AdWords::v201506::StringRuleItem->new({
      key => Google::Ads::AdWords::v201506::StringKey->new(
        {name => "ecomm_pagetype"}
      ),
      op    => "EQUALS",
      value => "checkout"
    });
  my $checkout_rule_item = Google::Ads::AdWords::v201506::RuleItem->new(
    {StringRuleItem => $checkout_string_rule_item});

  my $cart_size_number_rule_item =
    Google::Ads::AdWords::v201506::NumberRuleItem->new({
      key =>
        Google::Ads::AdWords::v201506::NumberKey->new({name => "cartsize"}),
      op    => "GREATER_THAN",
      value => "1"
    });
  my $cart_size_rule_item = Google::Ads::AdWords::v201506::RuleItem->new(
  ...
  my $checkout_multiple_item_group =
    Google::Ads::AdWords::v201506::RuleItemGroup->new(
  ...
  my $start_date_date_rule_item =
    Google::Ads::AdWords::v201506::DateRuleItem->new({
      key =>
        Google::Ads::AdWords::v201506::DateKey->new({name => "checkoutdate"}),
      op    => "AFTER",
      value => $rule_start_date
    });

  my $start_date_rule_item = Google::Ads::AdWords::v201506::RuleItem->new(
  ...
  my $end_date_rule_item = Google::Ads::AdWords::v201506::RuleItem->new(
  ...
  # together.
  my $rule = Google::Ads::AdWords::v201506::Rule->new({
      groups => [
  ...
  my $expression_user_list =
    Google::Ads::AdWords::v201506::ExpressionRuleUserList->new({
  ...
  my $date_user_list =
    Google::Ads::AdWords::v201506::DateSpecificRuleUserList->new({
  ...
  my $operations = [
    Google::Ads::AdWords::v201506::UserListOperation->new({
        operator => "ADD",
