...
use Google::Ads::AdWords::v201506::LanguageSearchParameter;
use Google::Ads::AdWords::Logging;
use Google::Ads::AdWords::v201506::Paging;
use Google::Ads::AdWords::v201506::RelatedToQuerySearchParameter;
use Google::Ads::AdWords::v201506::TargetingIdeaSelector;
...
sub get_keyword_ideas {
  ...
  # Create selector.
  my $selector = Google::Ads::AdWords::v201506::TargetingIdeaSelector->new({
      requestType => "IDEAS",
      ideaType    => "KEYWORD",
  ...
  my $query_search_parameter =
    Google::Ads::AdWords::v201506::RelatedToQuerySearchParameter->new(
    {queries => [$seed_query]});
  ...
  my $language_english =
    Google::Ads::AdWords::v201506::Language->new({id => 1000});
  my $language_search_parameter =
    Google::Ads::AdWords::v201506::LanguageSearchParameter->new(
