...
use Google::Ads::AdWords::v201506::AttributeFieldMapping;
use Google::Ads::AdWords::v201506::CampaignFeed;
...
use Google::Ads::AdWords::v201506::FeedMapping;
use Google::Ads::AdWords::v201506::FeedMappingOperation;
use Google::Ads::AdWords::v201506::FeedOperation;
...
sub create_site_links_feed() {
  ...
  my $text_attribute = Google::Ads::AdWords::v201506::FeedAttribute->new({
      type => "STRING",
      name => "Link Text"
  });
  my $final_url_attribute = Google::Ads::AdWords::v201506::FeedAttribute->new({
      type => "URL_LIST",
      name => "Link Final URLs"
  });
  my $line_1_attribute = Google::Ads::AdWords::v201506::FeedAttribute->new({
      type => "STRING",
      name => "Line 1 Description"
  });
  my $line_2_attribute = Google::Ads::AdWords::v201506::FeedAttribute->new({
      type => "STRING",
      name => "Line 2 Description"
  });
  my $feed = Google::Ads::AdWords::v201506::Feed->new({
      name       => $feed_name,
      attributes => [
  ...
  my $operation = Google::Ads::AdWords::v201506::FeedOperation->new({
      operator => "ADD",
      operand  => $feed
  });
...
sub create_site_links_feed_mapping() {
  ...
  my $text_field_mapping =
    Google::Ads::AdWords::v201506::AttributeFieldMapping->new({
      feedAttributeId => $site_links_data->{"linkTextFeedAttributeId"},
  ...
  my $feed_mapping = Google::Ads::AdWords::v201506::FeedMapping->new({
  ...
  my $operation = Google::Ads::AdWords::v201506::FeedMappingOperation->new({
...
sub create_site_links_campaign_feed() {
  ...
  my $matching_function =
    Google::Ads::AdWords::v201506::Function->new(
    {functionString => $matching_function_string});

  my $campaign_feed = Google::Ads::AdWords::v201506::CampaignFeed->new({
      feedId           => $site_links_data->{"siteLinksFeedId"},
