...
use Google::Ads::AdWords::v201506::CpcBid;
use Google::Ads::AdWords::v201506::Criterion;
use Google::Ads::AdWords::v201506::Money;
use Google::Ads::AdWords::v201506::NegativeAdGroupCriterion;
use Google::Ads::AdWords::v201506::ProductBiddingCategory;
use Google::Ads::AdWords::v201506::ProductCanonicalCondition;
use Google::Ads::AdWords::v201506::ProductBrand;
use Google::Ads::AdWords::v201506::ProductPartition;
...
sub add_product_partition_tree {
  ...
  create_unit(
    ...
    $ad_group_id,
    $root,
    Google::Ads::AdWords::v201506::ProductCanonicalCondition->new(
      {condition => "NEW"}
    ),
    200000
  );
  ...
  create_unit($operations, $ad_group_id, $other_condition,
    Google::Ads::AdWords::v201506::ProductBrand->new({value => "CoolBrand"}),
    900000);

  create_unit($operations, $ad_group_id, $other_condition,
    Google::Ads::AdWords::v201506::ProductBrand->new({value => "CheapBrand"}),
    10000);

  my $other_brand =
    create_subdivision($operations, $next_id--, $ad_group_id, $other_condition,
    Google::Ads::AdWords::v201506::ProductBrand->new());
  ...
  create_unit(
    ...
    $ad_group_id,
    $other_brand,
    Google::Ads::AdWords::v201506::ProductBiddingCategory->new({
...
sub create_subdivision {
  ...
  my $division = Google::Ads::AdWords::v201506::ProductPartition->new({
  ...
  my $criterion = Google::Ads::AdWords::v201506::BiddableAdGroupCriterion->new({
...
sub create_unit {
  ...
  my $unit = Google::Ads::AdWords::v201506::ProductPartition->new(
    {partitionType => "UNIT",});
  ...
  if ($bid_amount && $bid_amount > 0) {
    my $biddingStrategyConfiguration =
      Google::Ads::AdWords::v201506::BiddingStrategyConfiguration->new({
        bids => [
          Google::Ads::AdWords::v201506::CpcBid->new({
              bid => Google::Ads::AdWords::v201506::Money->new(
    ...
    $criterion = Google::Ads::AdWords::v201506::NegativeAdGroupCriterion->new();
  }
...
sub create_add_operation {
  ...
  my $operation = Google::Ads::AdWords::v201506::AdGroupCriterionOperation->new(
    {
