...
use Google::Ads::AdWords::v201506::CampaignCriterion;
...
use Google::Ads::AdWords::v201506::ProductCustomAttribute;
use Google::Ads::AdWords::v201506::ProductOfferId;
use Google::Ads::AdWords::v201506::ProductScope;
use Google::Ads::AdWords::v201506::ProductType;
...
sub add_product_scope {
  ...
  my $product_scope = Google::Ads::AdWords::v201506::ProductScope->new({
      # This set of dimensions is for demonstration purposes only. It would be
      # extremely unlikely that you want to include so many dimensions in your
      # product scope.
      dimensions => [
        Google::Ads::AdWords::v201506::ProductBrand->new({value => "Nexus"}),
        Google::Ads::AdWords::v201506::ProductCanonicalCondition->new(
          {condition => "NEW"}
        ),
        Google::Ads::AdWords::v201506::ProductCustomAttribute->new({
            type  => "CUSTOM_ATTRIBUTE_0",
            value => "my attribute value"
          }
        ),
        Google::Ads::AdWords::v201506::ProductOfferId->new({value => "book1"}),
        Google::Ads::AdWords::v201506::ProductType->new({
  ...
  my $campaign_criterion =
    Google::Ads::AdWords::v201506::CampaignCriterion->new({
