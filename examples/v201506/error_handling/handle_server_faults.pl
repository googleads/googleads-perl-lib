...
use Google::Ads::AdWords::v201506::ConversionOptimizerBiddingScheme;
...
sub handle_server_faults {
  ...
  my $biddingStrategyConfiguration =
    Google::Ads::AdWords::v201506::BiddingStrategyConfiguration->new({
      ...
      biddingScheme =>
        Google::Ads::AdWords::v201506::ConversionOptimizerBiddingScheme->new({
          pricingMode => "CLICKS",
          bidType     => "TARGET_CPA"
        })});
  ...
  my $budget = Google::Ads::AdWords::v201506::Budget->new({
      amount =>
        Google::Ads::AdWords::v201506::Money->new({microAmount => 50000000}),
  ...
  my $campaignOperation = Google::Ads::AdWords::v201506::CampaignOperation->new(
    {
      operator => "ADD",
      operand  => $campaign
    });
