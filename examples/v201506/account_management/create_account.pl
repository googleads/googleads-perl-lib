...
use Google::Ads::AdWords::v201506::ManagedCustomer;
use Google::Ads::AdWords::v201506::ManagedCustomerOperation;
...
sub create_account {
  ...
  my $account = Google::Ads::AdWords::v201506::ManagedCustomer->new({
  ...
  my $operation = Google::Ads::AdWords::v201506::ManagedCustomerOperation->new({
      operator => "ADD",
      operand  => $account
  });
