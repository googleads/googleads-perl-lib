...
use Google::Ads::AdWords::v201506::TemplateAd;
use Google::Ads::AdWords::v201506::TemplateElementField;
...
sub add_click_to_download_ad {
  ...
  my $click_to_download_ad = Google::Ads::AdWords::v201506::TemplateAd->new({
  ...
  my $headline = Google::Ads::AdWords::v201506::TemplateElementField->new({
      name      => "headline",
      fieldText => "Enjoy your drive in Mars",
      type      => "TEXT"
  });

  my $description1 = Google::Ads::AdWords::v201506::TemplateElementField->new({
      name      => "description1",
      fieldText => "Realistic physics simulation",
      type      => "TEXT"
  });

  my $description2 = Google::Ads::AdWords::v201506::TemplateElementField->new({
      name      => "description2",
      fieldText => "Race against players online",
      type      => "TEXT"
  });

  my $appId = Google::Ads::AdWords::v201506::TemplateElementField->new({
      name      => "appId",
      fieldText => "com.example.demogame",
      type      => "TEXT"
  });

  my $appStore = Google::Ads::AdWords::v201506::TemplateElementField->new({
      name      => "appStore",
      fieldText => "2",
      type      => "ENUM"
  });

  my $adData = Google::Ads::AdWords::v201506::TemplateElement->new({
      uniqueName => "adData",
  ...
  my $click_to_download_ad_group_ad =
    Google::Ads::AdWords::v201506::AdGroupAd->new({
