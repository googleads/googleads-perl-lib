...
use Google::Ads::AdWords::v201506::AdGroupBidModifierOperation;
use Google::Ads::AdWords::v201506::AdGroupBidModifier;
...
sub add_ad_group_bid_modifier {
  ...
  my $mobile = Google::Ads::AdWords::v201506::Platform->new({id => 30001});

  # Create the bid modifier.
  my $modifier = Google::Ads::AdWords::v201506::AdGroupBidModifier->new({
  ...
  my $operation =
    Google::Ads::AdWords::v201506::AdGroupBidModifierOperation->new({
      operator => "ADD",
      operand  => $modifier
    });
