...
use Google::Ads::AdWords::v201506::FrequencyCap;
use Google::Ads::AdWords::v201506::GeoTargetTypeSetting;
use Google::Ads::AdWords::v201506::ManualCpcBiddingScheme;
...
sub add_campaigns {
  ...
  my $budget = Google::Ads::AdWords::v201506::Budget->new({
      # Required attributes.
      name => "Interplanetary budget #" . uniqid(),
      amount =>
        Google::Ads::AdWords::v201506::Money->new({microAmount => 5000000}),
      deliveryMethod => "STANDARD",
      period         => "DAILY"
  });

  my $budget_operation = Google::Ads::AdWords::v201506::BudgetOperation->new({
      operator => "ADD",
      operand  => $budget
  });
  ...
  for (my $i = 0 ; $i < $num_campaigns ; $i++) {
    ...
    my $campaign = Google::Ads::AdWords::v201506::Campaign->new({
        ...
        budget =>
          Google::Ads::AdWords::v201506::Budget->new({budgetId => $budgetId}),
        ...
        frequencyCap => Google::Ads::AdWords::v201506::FrequencyCap->new({
            impressions => 5,
            timeUnit    => "DAY",
            level       => "ADGROUP"
          }
        ...
        settings => [
          ...
          Google::Ads::AdWords::v201506::GeoTargetTypeSetting->new({
    ...
    my $campaign_operation =
      Google::Ads::AdWords::v201506::CampaignOperation->new({
        operator => "ADD",
        operand  => $campaign
      });
