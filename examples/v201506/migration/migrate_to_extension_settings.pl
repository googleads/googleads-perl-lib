...
use Google::Ads::AdWords::v201506::CampaignExtensionSetting;
use Google::Ads::AdWords::v201506::CampaignExtensionSettingOperation;
use Google::Ads::AdWords::v201506::CampaignFeedOperation;
use Google::Ads::AdWords::v201506::ExtensionSetting;
use Google::Ads::AdWords::v201506::ExtensionSetting::Platform;
use Google::Ads::AdWords::v201506::FeedItem;
use Google::Ads::AdWords::v201506::FeedItemOperation;
use Google::Ads::AdWords::v201506::SitelinkFeedItem;
use Google::Ads::AdWords::v201506::UrlList;
...
sub get_feed_items_from_argument() {
  ...
  if ( $lhs_operand_size == 1
    && $lhs_operand->[0]
    ->isa("Google::Ads::AdWords::v201506::RequestContextOperand")
...
sub delete_campaign_feed() {
  ...
  my $result = $client->CampaignFeedService()->mutate({
      operations => [
        Google::Ads::AdWords::v201506::CampaignFeedOperation->new({
...
sub create_extension_setting() {
  ...
  my $campaign_extension_setting =
    Google::Ads::AdWords::v201506::CampaignExtensionSetting->new({
  ...
  foreach my $feed_item_id (@{$feed_item_ids}) {
    ...
    my $sitelink_feed_item =
      Google::Ads::AdWords::v201506::SitelinkFeedItem->new({
    ...
    if ($item_attributes->{'final_urls'}) {
      $sitelink_feed_item->set_sitelinkFinalUrls(
        Google::Ads::AdWords::v201506::UrlList->new(
  ...
  $campaign_extension_setting->set_extensionSetting(
    Google::Ads::AdWords::v201506::ExtensionSetting->new({
  ...
  my $result = $client->CampaignExtensionSettingService()->mutate({
      operations => [
        Google::Ads::AdWords::v201506::CampaignExtensionSettingOperation->new({
...
sub delete_old_feed_items() {
  ...
  foreach my $feed_item_id (@{$feed_item_ids}) {
    push @operations,
      Google::Ads::AdWords::v201506::FeedItemOperation->new({
        operator => 'REMOVE',
        operand  => Google::Ads::AdWords::v201506::FeedItem->new({
            feedId     => $feed->get_id(),
