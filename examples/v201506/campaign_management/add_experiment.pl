...
use Google::Ads::AdWords::v201506::AdGroupCriterionOperation;
use Google::Ads::AdWords::v201506::AdGroupExperimentData;
use Google::Ads::AdWords::v201506::AdGroupOperation;
use Google::Ads::AdWords::v201506::BidMultiplier;
use Google::Ads::AdWords::v201506::BiddableAdGroupCriterion;
use Google::Ads::AdWords::v201506::BiddableAdGroupCriterionExperimentData;
use Google::Ads::AdWords::v201506::Criterion;
use Google::Ads::AdWords::v201506::Experiment;
use Google::Ads::AdWords::v201506::ExperimentOperation;
use
  Google::Ads::AdWords::v201506::ManualCPCAdGroupCriterionExperimentBidMultiplier;
use Google::Ads::AdWords::v201506::ManualCPCAdGroupExperimentBidMultipliers;
...
sub add_experiment {
  ...
  my $experiment = Google::Ads::AdWords::v201506::Experiment->new({
  ...
  my $experiment_operation =
    Google::Ads::AdWords::v201506::ExperimentOperation->new({
      operator => "ADD",
      operand  => $experiment
    });
  ...
  my $ad_group =
    Google::Ads::AdWords::v201506::AdGroup->new({id => $ad_group_id});

  # Create experiment bid multiplier rule that will modify ad group bid for the
  # experiment.
  my $bid_multiplier =
    Google::Ads::AdWords::v201506::ManualCPCAdGroupExperimentBidMultipliers->
    new({
      maxCpcMultiplier =>
        Google::Ads::AdWords::v201506::BidMultiplier->new({multiplier => 1.5})}
    );

  # Set experiment data to the ad group.
  my $experiment_data =
    Google::Ads::AdWords::v201506::AdGroupExperimentData->new({
  ...
  # Create operation.
  my $operation = Google::Ads::AdWords::v201506::AdGroupOperation->new({
      operand  => $ad_group,
      operator => "SET"
  });
  ...
  my $criterion =
    Google::Ads::AdWords::v201506::Criterion->new({id => $criterion_id,});

  my $ad_group_criterion =
    Google::Ads::AdWords::v201506::BiddableAdGroupCriterion->new({
  ...
  $experiment_data =
    Google::Ads::AdWords::v201506::BiddableAdGroupCriterionExperimentData->new({
      experimentId            => $experiment_id,
      experimentDeltaStatus   => "MODIFIED",
  ...
  # Create operation.
  $operation = Google::Ads::AdWords::v201506::AdGroupCriterionOperation->new({
