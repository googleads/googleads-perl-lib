...
use Google::Ads::AdWords::v201309::UploadConversion;
use Google::Ads::AdWords::v201309::ConversionTrackerOperation;
use Google::Ads::AdWords::v201309::OfflineConversionFeed;
use Google::Ads::AdWords::v201309::OfflineConversionFeedOperation;
...
sub upload_offline_conversions {
  ...
  my $upload_conversion = Google::Ads::AdWords::v201309::UploadConversion->new({
    category => 'PAGE_VIEW',
  ...
  my $upload_operation =
      Google::Ads::AdWords::v201309::ConversionTrackerOperation->new({
        operator => "ADD",
