...
use Google::Ads::AdWords::v201601::LanguageSearchParameter;
use Google::Ads::AdWords::Logging;
use Google::Ads::AdWords::v201601::Paging;
use Google::Ads::AdWords::v201601::RelatedToQuerySearchParameter;
use Google::Ads::AdWords::v201601::TargetingIdeaSelector;
...
sub get_keyword_ideas {
  ...
  # Create selector.
  my $selector = Google::Ads::AdWords::v201601::TargetingIdeaSelector->new({
      requestType => "IDEAS",
      ideaType    => "KEYWORD",
  ...
  my $query_search_parameter =
    Google::Ads::AdWords::v201601::RelatedToQuerySearchParameter->new(
    {queries => [$seed_query]});
  ...
  my $language_english =
    Google::Ads::AdWords::v201601::Language->new({id => 1000});
  my $language_search_parameter =
    Google::Ads::AdWords::v201601::LanguageSearchParameter->new(
    {languages => [$language_english]});

  $selector->set_searchParameters(
    [$query_search_parameter, $language_search_parameter]);
