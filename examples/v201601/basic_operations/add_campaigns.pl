...
use Google::Ads::AdWords::v201601::Campaign;
use Google::Ads::AdWords::v201601::CampaignOperation;
use Google::Ads::AdWords::v201601::FrequencyCap;
use Google::Ads::AdWords::v201601::GeoTargetTypeSetting;
use Google::Ads::AdWords::v201601::ManualCpcBiddingScheme;
...
sub add_campaigns {
  ...
  for (my $i = 0 ; $i < $num_campaigns ; $i++) {
    ...
    my $campaign = Google::Ads::AdWords::v201601::Campaign->new({
        ...
        budget =>
          Google::Ads::AdWords::v201601::Budget->new({budgetId => $budgetId}),
        ...
        frequencyCap => Google::Ads::AdWords::v201601::FrequencyCap->new({
            impressions => 5,
            timeUnit    => "DAY",
            level       => "ADGROUP"
          }
        ...
        settings => [
          ...
          Google::Ads::AdWords::v201601::GeoTargetTypeSetting->new({
