...
use Google::Ads::AdWords::v201601::CrmBasedUserList;
use Google::Ads::AdWords::v201601::MutateMembersOperand;
use Google::Ads::AdWords::v201601::MutateMembersOperation;
...
sub add_crm_based_user_list {
  ...
  if ($result->get_value()) {
    ...
    my $operand     = Google::Ads::AdWords::v201601::MutateMembersOperand->new({
        userListId => $userlist_id,
        members    => \@email_list
    });

    my $member_operation =
      Google::Ads::AdWords::v201601::MutateMembersOperation->new({
        operator => "ADD",
        operand  => $operand
      });
