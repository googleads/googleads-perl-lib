...
use Google::Ads::AdWords::v201601::ManagedCustomer;
use Google::Ads::AdWords::v201601::ManagedCustomerOperation;
...
sub create_account {
  ...
  my $account = Google::Ads::AdWords::v201601::ManagedCustomer->new({
  ...
  my $operation = Google::Ads::AdWords::v201601::ManagedCustomerOperation->new({
      operator => "ADD",
      operand  => $account
  });
