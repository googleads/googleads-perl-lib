...
use Google::Ads::AdWords::v201601::AdGroupExperimentData;
use Google::Ads::AdWords::v201601::AdGroupOperation;
use Google::Ads::AdWords::v201601::BidMultiplier;
use Google::Ads::AdWords::v201601::BiddableAdGroupCriterion;
use Google::Ads::AdWords::v201601::BiddableAdGroupCriterionExperimentData;
use Google::Ads::AdWords::v201601::Criterion;
use Google::Ads::AdWords::v201601::Experiment;
use Google::Ads::AdWords::v201601::ExperimentOperation;
use
  Google::Ads::AdWords::v201601::ManualCPCAdGroupCriterionExperimentBidMultiplier;
use Google::Ads::AdWords::v201601::ManualCPCAdGroupExperimentBidMultipliers;
...
sub add_experiment {
  ...
  my $experiment = Google::Ads::AdWords::v201601::Experiment->new({
  ...
  my $experiment_operation =
    Google::Ads::AdWords::v201601::ExperimentOperation->new({
      operator => "ADD",
      operand  => $experiment
    });
  ...
  my $ad_group =
    Google::Ads::AdWords::v201601::AdGroup->new({id => $ad_group_id});

  # Create experiment bid multiplier rule that will modify ad group bid for the
  # experiment.
  my $bid_multiplier =
    Google::Ads::AdWords::v201601::ManualCPCAdGroupExperimentBidMultipliers->
    new({
      maxCpcMultiplier =>
        Google::Ads::AdWords::v201601::BidMultiplier->new({multiplier => 1.5})}
    );

  # Set experiment data to the ad group.
  my $experiment_data =
    Google::Ads::AdWords::v201601::AdGroupExperimentData->new({
  ...
  # Create operation.
  my $operation = Google::Ads::AdWords::v201601::AdGroupOperation->new({
      operand  => $ad_group,
      operator => "SET"
  });
  ...
  my $criterion =
    Google::Ads::AdWords::v201601::Criterion->new({id => $criterion_id,});
  ...
  $experiment_data =
    Google::Ads::AdWords::v201601::BiddableAdGroupCriterionExperimentData->new({
      experimentId            => $experiment_id,
      experimentDeltaStatus   => "MODIFIED",
  ...
  # Create operation.
  $operation = Google::Ads::AdWords::v201601::AdGroupCriterionOperation->new({
