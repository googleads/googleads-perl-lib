...
use Google::Ads::AdWords::v201601::BiddingStrategyConfiguration;
use Google::Ads::AdWords::v201601::CpcBid;
use Google::Ads::AdWords::v201601::Criterion;
use Google::Ads::AdWords::v201601::Money;
use Google::Ads::AdWords::v201601::NegativeAdGroupCriterion;
use Google::Ads::AdWords::v201601::ProductBiddingCategory;
use Google::Ads::AdWords::v201601::ProductCanonicalCondition;
use Google::Ads::AdWords::v201601::ProductBrand;
use Google::Ads::AdWords::v201601::ProductPartition;
...
sub add_product_partition_tree {
  ...
  create_unit(
    ...
    $ad_group_id,
    $root,
    Google::Ads::AdWords::v201601::ProductCanonicalCondition->new(
      {condition => "NEW"}
    ),
    200000
  );
  ...
  create_unit($operations, $ad_group_id, $other_condition,
    Google::Ads::AdWords::v201601::ProductBrand->new({value => "CoolBrand"}),
    900000);

  create_unit($operations, $ad_group_id, $other_condition,
    Google::Ads::AdWords::v201601::ProductBrand->new({value => "CheapBrand"}),
    10000);

  my $other_brand =
    create_subdivision($operations, $next_id--, $ad_group_id, $other_condition,
    Google::Ads::AdWords::v201601::ProductBrand->new());
  ...
  create_unit(
    ...
    $ad_group_id,
    $other_brand,
    Google::Ads::AdWords::v201601::ProductBiddingCategory->new({
...
sub create_subdivision {
  ...
  my $division = Google::Ads::AdWords::v201601::ProductPartition->new({
  ...
  my $criterion = Google::Ads::AdWords::v201601::BiddableAdGroupCriterion->new({
...
sub create_unit {
  ...
  my $unit = Google::Ads::AdWords::v201601::ProductPartition->new(
    {partitionType => "UNIT",});
  ...
  if ($bid_amount && $bid_amount > 0) {
    ...
    $criterion = Google::Ads::AdWords::v201601::NegativeAdGroupCriterion->new();
  }
...
sub create_add_operation {
  ...
  my $operation = Google::Ads::AdWords::v201601::AdGroupCriterionOperation->new(
    {
