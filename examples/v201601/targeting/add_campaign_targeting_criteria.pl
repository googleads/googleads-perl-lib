...
use Google::Ads::AdWords::v201601::ConstantOperand;
use Google::Ads::AdWords::v201601::Function;
use Google::Ads::AdWords::v201601::GeoTargetOperand;
use Google::Ads::AdWords::v201601::IncomeOperand;
use Google::Ads::AdWords::v201601::Language;
use Google::Ads::AdWords::v201601::Location;
use Google::Ads::AdWords::v201601::LocationExtensionOperand;
use Google::Ads::AdWords::v201601::LocationGroups;
use Google::Ads::AdWords::v201601::PlacesOfInterestOperand;
use Google::Ads::AdWords::v201601::Platform;
...
sub add_campaign_targeting_criteria {
  ...
  my $california = Google::Ads::AdWords::v201601::Location->new({id => 21137});
  push @criteria, $california;
  my $mexico = Google::Ads::AdWords::v201601::Location->new({
      id => 2484    # Mexico
  });
  ...
  my $english = Google::Ads::AdWords::v201601::Language->new({id => 1000});
  push @criteria, $english;
  my $spanish = Google::Ads::AdWords::v201601::Language->new({id => 1003});
  ...
  my $income = Google::Ads::AdWords::v201601::LocationGroups->new({
      matchingFunction => Google::Ads::AdWords::v201601::Function->new({
          operator   => "AND",
          lhsOperand => Google::Ads::AdWords::v201601::IncomeOperand->new({
          ...
          rhsOperand => Google::Ads::AdWords::v201601::GeoTargetOperand->new({
              locations => [1015116]    # Miami, FL
            })})});
  push @criteria, $income;

  my $placesOfInterest = Google::Ads::AdWords::v201601::LocationGroups->new({
      matchingFunction => Google::Ads::AdWords::v201601::Function->new({
          operator => "AND",
          lhsOperand =>
            Google::Ads::AdWords::v201601::PlacesOfInterestOperand->new({
  ...
  if ($location_feed_id) {
    ...
    my $radius = Google::Ads::AdWords::v201601::ConstantOperand->new({
        type        => "DOUBLE",
        unit        => "MILES",
        doubleValue => 10.0
    });
    my $radiusLocationGroup =
      Google::Ads::AdWords::v201601::LocationGroups->new({
        matchingFunction => Google::Ads::AdWords::v201601::Function->new({
            operator => "IDENTITY",
            lhsOperand =>
              Google::Ads::AdWords::v201601::LocationExtensionOperand->new(
              {radius => $radius})}
        ),
  ...
  foreach my $criterion (@criteria) {
    my $operation =
      Google::Ads::AdWords::v201601::CampaignCriterionOperation->new({
        operator => "ADD",
        operand  => Google::Ads::AdWords::v201601::CampaignCriterion->new({
