...
use Google::Ads::AdWords::v201601::ExtensionSetting;
use Google::Ads::AdWords::v201601::ExtensionSetting::Platform;
...
use Google::Ads::AdWords::v201601::UrlList;
...
sub get_feed_items_from_argument() {
  ...
  if ( $lhs_operand_size == 1
    && $lhs_operand->[0]
    ->isa("Google::Ads::AdWords::v201601::RequestContextOperand")
...
sub create_extension_setting() {
  ...
  foreach my $feed_item_id (@{$feed_item_ids}) {
    ...
    my $sitelink_feed_item =
      Google::Ads::AdWords::v201601::SitelinkFeedItem->new({
    ...
    if ($item_attributes->{'final_urls'}) {
      $sitelink_feed_item->set_sitelinkFinalUrls(
        Google::Ads::AdWords::v201601::UrlList->new(
  ...
  $campaign_extension_setting->set_extensionSetting(
    Google::Ads::AdWords::v201601::ExtensionSetting->new({
...
sub delete_old_feed_items() {
  ...
  foreach my $feed_item_id (@{$feed_item_ids}) {
    push @operations,
      Google::Ads::AdWords::v201601::FeedItemOperation->new({
        operator => 'REMOVE',
        operand  => Google::Ads::AdWords::v201601::FeedItem->new({
            feedId     => $feed->get_id(),
