...
use Google::Ads::AdWords::v201601::UploadConversion;
use Google::Ads::AdWords::v201601::ConversionTrackerOperation;
use Google::Ads::AdWords::v201601::OfflineConversionFeed;
use Google::Ads::AdWords::v201601::OfflineConversionFeedOperation;
...
sub upload_offline_conversions {
  ...
  my $upload_conversion = Google::Ads::AdWords::v201601::UploadConversion->new({
      category                  => 'PAGE_VIEW',
  ...
  my $upload_operation =
    Google::Ads::AdWords::v201601::ConversionTrackerOperation->new({
      operator => "ADD",
  ...
  my $feed = Google::Ads::AdWords::v201601::OfflineConversionFeed->new({
  ...
  my $offline_conversion_operation =
    Google::Ads::AdWords::v201601::OfflineConversionFeedOperation->new({
      operator => "ADD",
      operand  => $feed
    });
