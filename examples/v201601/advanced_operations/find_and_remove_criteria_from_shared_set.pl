...
use Google::Ads::AdWords::v201601::CampaignSharedSet;
use Google::Ads::AdWords::v201601::CampaignSharedSetOperation;
use Google::Ads::AdWords::v201601::Criterion;
use Google::Ads::AdWords::v201601::Keyword;
use Google::Ads::AdWords::v201601::OrderBy;
use Google::Ads::AdWords::v201601::Paging;
use Google::Ads::AdWords::v201601::Placement;
use Google::Ads::AdWords::v201601::Predicate;
use Google::Ads::AdWords::v201601::Selector;
use Google::Ads::AdWords::v201601::SharedCriterion;
use Google::Ads::AdWords::v201601::SharedCriterionOperation;
use Google::Ads::AdWords::v201601::SharedSet;
use Google::Ads::AdWords::v201601::SharedSetOperation;
...
sub find_and_remove_criteria_from_shared_set {
  ...
  my $selector = Google::Ads::AdWords::v201601::Selector->new({
      ...
      predicates => [
        Google::Ads::AdWords::v201601::Predicate->new({
            field    => "CampaignId",
            operator => "EQUALS",
            values   => [$campaign_id]})
      ],
  ...
  $paging = Google::Ads::AdWords::v201601::Paging->new({
      startIndex    => 0,
      numberResults => PAGE_SIZE
  });
  $selector = Google::Ads::AdWords::v201601::Selector->new({
      fields => [
  ...
  my @remove_criterion_operations =
    ...
    sub {
      ...
      if ($criterion->isa("Google::Ads::AdWords::v201601::Keyword")) {
        printf "Shared negative keyword with ID %d and text '%s' was " .
          "found.\n",
          $criterion->get_id(),
          $criterion->get_text();
      } elsif ($criterion->isa("Google::Ads::AdWords::v201601::Placement")) {
      ...
      my $shared_criterion_operation =
        Google::Ads::AdWords::v201601::SharedCriterionOperation->new({
          operator => 'REMOVE',
          operand  => Google::Ads::AdWords::v201601::SharedCriterion->new({
              criterion => Google::Ads::AdWords::v201601::Criterion->new(
                {id => $criterion->get_id()}
              ),
