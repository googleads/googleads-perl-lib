...
use Google::Ads::AdWords::v201601::CustomParameter;
use Google::Ads::AdWords::v201601::CustomParameters;
use Google::Ads::AdWords::v201601::Image;
use Google::Ads::AdWords::v201601::ImageAd;
use Google::Ads::AdWords::v201601::TemplateAd;
use Google::Ads::AdWords::v201601::TextAd;
use Google::Ads::AdWords::v201601::Video;
...
sub add_text_ad_with_upgraded_urls {
  ...
  # or feed item levels.
  my $season_parameter = Google::Ads::AdWords::v201601::CustomParameter->new({
      key   => "season",
      value => "christmas"
  });
  my $promo_code_parameter =
    Google::Ads::AdWords::v201601::CustomParameter->new({
      key   => "promocode",
      value => "NYC123"
    });
  my $tracking_url_parameters =
    Google::Ads::AdWords::v201601::CustomParameters->new(
