...
use Google::Ads::AdWords::v201306::AdWordsConversionTracker;
use Google::Ads::AdWords::v201306::ConversionTrackerOperation;
...
sub add_conversion_tracker {
  ...
  my $conversion_tracker =
      Google::Ads::AdWords::v201306::AdWordsConversionTracker->new({
  ...
  my $conversion_operation =
      Google::Ads::AdWords::v201306::ConversionTrackerOperation->new({
        operator => "ADD",
