...
use Google::Ads::AdWords::v201306::BasicUserList;
use Google::Ads::AdWords::v201306::Selector;
use Google::Ads::AdWords::v201306::UserListConversionType;
use Google::Ads::AdWords::v201306::UserListOperation;
...
sub add_audience {
  ...
  my $conversion_type =
      Google::Ads::AdWords::v201306::UserListConversionType->new({
          name => $name
      });

  # Create remarketing user list.
  my $user_list = Google::Ads::AdWords::v201306::BasicUserList->new({
    name => $name,
  ...
  # Create operation.
  my $operation = Google::Ads::AdWords::v201306::UserListOperation->new({
    operator => "ADD",
    operand => $user_list
  });
  ...
  if ($result->get_value()) {
    ...
    sleep(5);
    my $predicate = Google::Ads::AdWords::v201306::Predicate->new({
      field => "Id",
      operator => "IN",
    ...
    $selector = Google::Ads::AdWords::v201306::Selector->new({
      fields => ["Id"],
