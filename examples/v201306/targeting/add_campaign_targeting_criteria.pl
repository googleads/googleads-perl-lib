...
use Google::Ads::AdWords::v201306::CampaignCriterionOperation;
use Google::Ads::AdWords::v201306::Language;
use Google::Ads::AdWords::v201306::Location;
use Google::Ads::AdWords::v201306::Platform;
...
sub add_campaign_targeting_criteria {
  ...
  my $california = Google::Ads::AdWords::v201306::Location->new({
    id => 21137
  });
  push @criteria, $california;
  my $mexico = Google::Ads::AdWords::v201306::Location->new({
    id => 2484 # Mexico
  });
  ...
  my $english = Google::Ads::AdWords::v201306::Language->new({
    id => 1000
  });
  push @criteria, $english;
  my $spanish = Google::Ads::AdWords::v201306::Language->new({
    id => 1003
  });
  ...
  foreach my $criterion (@criteria) {
    my $operation =
        Google::Ads::AdWords::v201306::CampaignCriterionOperation->new({
          operator => "ADD",
          operand => Google::Ads::AdWords::v201306::CampaignCriterion->new({
