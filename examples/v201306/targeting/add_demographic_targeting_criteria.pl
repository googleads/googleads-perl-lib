...
use Google::Ads::AdWords::v201306::AgeRange;
use Google::Ads::AdWords::v201306::BiddableAdGroupCriterion;
use Google::Ads::AdWords::v201306::Gender;
...
sub add_demographic_targeting_criteria {
  ...
  my $gender_male = Google::Ads::AdWords::v201306::Gender->new({
    id => GENDER_MALE
  });
  ...
  my $age_range = Google::Ads::AdWords::v201306::AgeRange->new({
