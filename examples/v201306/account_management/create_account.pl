...
use Google::Ads::AdWords::v201306::ManagedCustomer;
use Google::Ads::AdWords::v201306::ManagedCustomerOperation;
...
sub create_account {
  ...
  my $account = Google::Ads::AdWords::v201306::ManagedCustomer->new({
  ...
  my $operation = Google::Ads::AdWords::v201306::ManagedCustomerOperation->new({
    operator        => "ADD",
    operand         => $account
  });
