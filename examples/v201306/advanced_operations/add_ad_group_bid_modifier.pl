...
use Google::Ads::AdWords::v201306::AdGroupBidModifierOperation;
use Google::Ads::AdWords::v201306::AdGroupBidModifier;
...
sub add_ad_group_bid_modifier {
  ...
  my $modifier = Google::Ads::AdWords::v201306::AdGroupBidModifier->new({
  ...
  my $operation =
      Google::Ads::AdWords::v201306::AdGroupBidModifierOperation->new({
        operator => "ADD",
        operand => $modifier
      });
