...
# To enhance a campaign, run campaign_management/set_campaign_enhanced.pl.
#
...
sub set_bid_modifier {
  ...
  my $mobile = Google::Ads::AdWords::v201306::Platform->new({
    id => 30001
  });

  # Create criterion with modified bid.
  my $criterion = Google::Ads::AdWords::v201306::CampaignCriterion->new({
