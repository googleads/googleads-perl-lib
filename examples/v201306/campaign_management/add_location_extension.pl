...
use Google::Ads::AdWords::v201306::Address;
use Google::Ads::AdWords::v201306::CampaignAdExtension;
use Google::Ads::AdWords::v201306::CampaignAdExtensionOperation;
use Google::Ads::AdWords::v201306::GeoLocationSelector;
use Google::Ads::AdWords::v201306::LocationExtension;
...
sub add_location_extension {
  ...
  # Create address.
  my $address = Google::Ads::AdWords::v201306::Address->new({
  ...
  my $selector = Google::Ads::AdWords::v201306::GeoLocationSelector->new({
    addresses => [$address]
  });
  ...
  my $location_extension =
      Google::Ads::AdWords::v201306::LocationExtension->new({
  ...
  my $campaign_location_ad_extension =
      Google::Ads::AdWords::v201306::CampaignAdExtension->new({
