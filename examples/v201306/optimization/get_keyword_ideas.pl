...
use Google::Ads::AdWords::v201306::LanguageSearchParameter;
use Google::Ads::AdWords::Logging;
use Google::Ads::AdWords::v201306::Paging;
use Google::Ads::AdWords::v201306::RelatedToQuerySearchParameter;
use Google::Ads::AdWords::v201306::TargetingIdeaSelector;
...
sub get_keyword_ideas {
  ...
  # Create selector.
  my $selector = Google::Ads::AdWords::v201306::TargetingIdeaSelector->new({
    requestType => "IDEAS",
    ideaType => "KEYWORD",
  ...
  my $query_search_parameter =
      Google::Ads::AdWords::v201306::RelatedToQuerySearchParameter->new({
        queries => [$seed_query]
      });
  ...
  # Note: As of v201306, only a single language parameter is allowed.
  my $language_english = Google::Ads::AdWords::v201306::Language->new({
    id => 1000
  });
  my $language_search_parameter =
      Google::Ads::AdWords::v201306::LanguageSearchParameter->new({
