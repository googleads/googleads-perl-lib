...
use Google::Ads::AdWords::v201306::Image;
use Google::Ads::AdWords::v201306::ImageAd;
use Google::Ads::AdWords::v201306::TemplateAd;
use Google::Ads::AdWords::v201306::TextAd;
use Google::Ads::AdWords::v201306::Video;
...
sub add_text_ads {
  ...
  for(my $i = 0; $i < $num_ads; $i++) {
    # Create text ad.
    my $text_ad = Google::Ads::AdWords::v201306::TextAd->new({
    ...
    my $text_ad_group_ad = Google::Ads::AdWords::v201306::AdGroupAd->new({
