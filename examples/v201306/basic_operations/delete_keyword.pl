...
#
# This example deletes a keyword using the 'REMOVE' operator. To get keywords,
...
sub delete_keyword {
  ...
  my $ad_group_criterion =
      Google::Ads::AdWords::v201306::AdGroupCriterion->new({
  ...
  if ($result->get_value()) {
    ...
    printf "Keyword with ad group id \"%d\" and id \"%d\" was deleted.\n",
