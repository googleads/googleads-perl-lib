...
use Google::Ads::AdWords::v201509::CustomParameter;
use Google::Ads::AdWords::v201509::CustomParameters;
use Google::Ads::AdWords::v201509::Image;
use Google::Ads::AdWords::v201509::ImageAd;
use Google::Ads::AdWords::v201509::TemplateAd;
use Google::Ads::AdWords::v201509::TextAd;
use Google::Ads::AdWords::v201509::Video;
...
sub add_text_ad_with_upgraded_urls {
  ...
  # or feed item levels.
  my $season_parameter = Google::Ads::AdWords::v201509::CustomParameter->new({
      key   => "season",
      value => "christmas"
  });
  my $promo_code_parameter =
    Google::Ads::AdWords::v201509::CustomParameter->new({
      key   => "promocode",
      value => "NYC123"
    });
  my $tracking_url_parameters =
    Google::Ads::AdWords::v201509::CustomParameters->new(
