...
use Google::Ads::AdWords::v201509::AdCustomizerFeed;
use Google::Ads::AdWords::v201509::AdCustomizerFeedAttribute;
use Google::Ads::AdWords::v201509::AdCustomizerFeedOperation;
...
use Google::Ads::AdWords::v201509::FeedItemAdGroupTargeting;
...
use Google::Ads::AdWords::v201509::FunctionOperand;
use Google::Ads::AdWords::v201509::RequestContextOperand;
...
sub create_customizer_feed() {
  ...
  my $name_attribute =
    Google::Ads::AdWords::v201509::AdCustomizerFeedAttribute->new({
      type => "STRING",
      name => "Name"
    });
  my $price_attribute =
  ...
  my $ad_customizer_feed = Google::Ads::AdWords::v201509::AdCustomizerFeed->new(
    {
      feedName       => $feed_name,
      feedAttributes => [$name_attribute, $price_attribute, $date_attribute]});

  my $operation = Google::Ads::AdWords::v201509::AdCustomizerFeedOperation->new(
    {
      operator => "ADD",
...
sub create_feed_item_add_operation() {
  ...
  my $feed_item = Google::Ads::AdWords::v201509::FeedItem->new({
      ...
      adGroupTargeting =>
        Google::Ads::AdWords::v201509::FeedItemAdGroupTargeting->new(
  ...
  foreach my $ad_group_id (@{$ad_group_ids}) {
    push @operations,
      Google::Ads::AdWords::v201509::AdGroupAdOperation->new({
        operator => "ADD",
        operand  => Google::Ads::AdWords::v201509::AdGroupAd->new({
