...
use Google::Ads::AdWords::v201509::UploadConversion;
use Google::Ads::AdWords::v201509::ConversionTrackerOperation;
use Google::Ads::AdWords::v201509::OfflineConversionFeed;
use Google::Ads::AdWords::v201509::OfflineConversionFeedOperation;
...
sub upload_offline_conversions {
  ...
  my $upload_conversion = Google::Ads::AdWords::v201509::UploadConversion->new({
      category                  => 'PAGE_VIEW',
  ...
  my $upload_operation =
    Google::Ads::AdWords::v201509::ConversionTrackerOperation->new({
      operator => "ADD",
  ...
  my $feed = Google::Ads::AdWords::v201509::OfflineConversionFeed->new({
  ...
  my $offline_conversion_operation =
    Google::Ads::AdWords::v201509::OfflineConversionFeedOperation->new({
      operator => "ADD",
      operand  => $feed
    });
