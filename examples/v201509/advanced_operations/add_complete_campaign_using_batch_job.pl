...
use Google::Ads::AdWords::v201509::AdGroup;
use Google::Ads::AdWords::v201509::AdGroupAd;
use Google::Ads::AdWords::v201509::AdGroupAdOperation;
use Google::Ads::AdWords::v201509::AdGroupCriterionOperation;
use Google::Ads::AdWords::v201509::AdGroupOperation;
use Google::Ads::AdWords::v201509::BatchJob;
use Google::Ads::AdWords::v201509::BatchJobOperation;
use Google::Ads::AdWords::v201509::BiddableAdGroupCriterion;
use Google::Ads::AdWords::v201509::Budget;
use Google::Ads::AdWords::v201509::BudgetOperation;
use Google::Ads::AdWords::v201509::CampaignCriterionOperation;
use Google::Ads::AdWords::v201509::CampaignOperation;
use Google::Ads::AdWords::v201509::CpcBid;
use Google::Ads::AdWords::v201509::Keyword;
use Google::Ads::AdWords::v201509::Money;
use Google::Ads::AdWords::v201509::NegativeCampaignCriterion;
use Google::Ads::AdWords::v201509::Predicate;
use Google::Ads::AdWords::v201509::Paging;
use Google::Ads::AdWords::v201509::Selector;
use Google::Ads::AdWords::v201509::TextAd;
...
sub add_complete_campaign_using_batch_job {
  ...
  my $operation = Google::Ads::AdWords::v201509::BatchJobOperation->new({
      operator => 'ADD',
      operand  => Google::Ads::AdWords::v201509::BatchJob->new({})});
...
sub _create_budget_operation {
  my $budget = Google::Ads::AdWords::v201509::Budget->new({
      ...
      amount =>
        Google::Ads::AdWords::v201509::Money->new({microAmount => 5000000}),
      deliveryMethod => "STANDARD",
      period         => "DAILY"
  });

  my $budget_operation = Google::Ads::AdWords::v201509::BudgetOperation->new({
      operator => "ADD",
      operand  => $budget
  });
...
sub _create_campaign_operations {
  ...
  for (my $i = 1 ; $i < NUMBER_OF_CAMPAIGNS_TO_ADD ; $i++) {
    my $campaign = Google::Ads::AdWords::v201509::Campaign->new({
        ...
        budget => Google::Ads::AdWords::v201509::Budget->new(
          {budgetId => $budget_operation->get_operand()->get_budgetId()})});
    my $campaign_operation =
      Google::Ads::AdWords::v201509::CampaignOperation->new({
        operator => "ADD",
        operand  => $campaign
      });
...
sub _create_campaign_criterion_operations() {
  ...
  for my $campaign_operation (@campaign_operations) {
    # Create keyword.
    my $keyword = Google::Ads::AdWords::v201509::Keyword->new(
      {matchType => "BROAD", text => "venus"});

    my $negative_criterion =
      Google::Ads::AdWords::v201509::NegativeCampaignCriterion->new({
    ...
    my $negative_criterion_operation =
      Google::Ads::AdWords::v201509::CampaignCriterionOperation->new({
        operator => "ADD",
...
sub _create_ad_group_operations {
  ...
  for my $campaign_operation (@campaign_operations) {
    for (my $i = 1 ; $i < NUMBER_OF_ADGROUPS_TO_ADD ; $i++) {
      my $ad_group = Google::Ads::AdWords::v201509::AdGroup->new({
          id         => _next_id(),
          campaignId => $campaign_operation->get_operand()->get_id(),
          ...
          biddingStrategyConfiguration =>
            Google::Ads::AdWords::v201509::BiddingStrategyConfiguration->new({
              bids => [
                Google::Ads::AdWords::v201509::CpcBid->new({
                    bid => Google::Ads::AdWords::v201509::Money->new(
                      {microAmount => 10000000})})]})});
      my $ad_group_operation =
        Google::Ads::AdWords::v201509::AdGroupOperation->new({
          operator => "ADD",
          operand  => $ad_group
        });
  ...
  for my $ad_group_operation (@ad_group_operations) {
    for (my $i = 1 ; $i < NUMBER_OF_KEYWORDS_TO_ADD ; $i++) {
      ...
      my $ad_group_criterion =
        Google::Ads::AdWords::v201509::BiddableAdGroupCriterion->new({
      ...
      my $ad_group_criterion_operation =
        Google::Ads::AdWords::v201509::AdGroupCriterionOperation->new({
          operator => "ADD",
...
sub _create_ad_group_ad_operations() {
  ...
  for my $ad_group_operation (@ad_group_operations) {
    ...
    my $text_ad = Google::Ads::AdWords::v201509::TextAd->new({
    ...
    my $text_ad_group_ad = Google::Ads::AdWords::v201509::AdGroupAd->new({
    ...
    my $text_ad_group_ad_operation =
      Google::Ads::AdWords::v201509::AdGroupAdOperation->new({
        operator => "ADD",
...
sub _verify_operations {
  ...
  my $predicate = Google::Ads::AdWords::v201509::Predicate->new({
      field    => "Id",
      operator => "IN",
      values   => [$job_id]});
  my $paging = Google::Ads::AdWords::v201509::Paging->new({
      startIndex    => 0,
      numberResults => 1
  });
