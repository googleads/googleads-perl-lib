...
use Google::Ads::AdWords::v201509::AdGroupEstimateRequest;
use Google::Ads::AdWords::v201509::CampaignEstimateRequest;
use Google::Ads::AdWords::v201509::Keyword;
use Google::Ads::AdWords::v201509::KeywordEstimateRequest;
use Google::Ads::AdWords::v201509::Language;
use Google::Ads::AdWords::v201509::Location;
use Google::Ads::AdWords::v201509::TrafficEstimatorSelector;
...
sub estimate_keyword_traffic {
  ...
  my @keywords = (
    Google::Ads::AdWords::v201509::Keyword->new({
        text      => "mars cruise",
        matchType => "BROAD"
      }
    ),
  ...
  foreach my $keyword (@keywords) {
    push @keyword_estimate_requests,
      Google::Ads::AdWords::v201509::KeywordEstimateRequest->new(
      {keyword => $keyword,});
  }
  ...
  my $ad_group_estimate_request =
    Google::Ads::AdWords::v201509::AdGroupEstimateRequest->new({
      keywordEstimateRequests => \@keyword_estimate_requests,
      maxCpc =>
        Google::Ads::AdWords::v201509::Money->new({microAmount => 1000000})});

  # Create campaign estimate requests.
  my $campaign_estimate_request =
    Google::Ads::AdWords::v201509::CampaignEstimateRequest->new({
      adGroupEstimateRequests => [$ad_group_estimate_request],
      criteria                => [
        Google::Ads::AdWords::v201509::Location->new({
            id => "2840"    # US - see http://goo.gl/rlrFr
          }
        ),
        Google::Ads::AdWords::v201509::Language->new({
            id => "1000"    # en - see http://goo.gl/LvMmS
          })]});

  # Create selector.
  my $selector = Google::Ads::AdWords::v201509::TrafficEstimatorSelector->new(
