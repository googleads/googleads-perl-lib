...
use Google::Ads::AdWords::v201509::LanguageSearchParameter;
use Google::Ads::AdWords::Logging;
use Google::Ads::AdWords::v201509::Paging;
use Google::Ads::AdWords::v201509::RelatedToQuerySearchParameter;
use Google::Ads::AdWords::v201509::TargetingIdeaSelector;
...
sub get_keyword_ideas {
  ...
  # Create selector.
  my $selector = Google::Ads::AdWords::v201509::TargetingIdeaSelector->new({
      requestType => "IDEAS",
      ideaType    => "KEYWORD",
  ...
  my $query_search_parameter =
    Google::Ads::AdWords::v201509::RelatedToQuerySearchParameter->new(
    {queries => [$seed_query]});
  ...
  my $language_english =
    Google::Ads::AdWords::v201509::Language->new({id => 1000});
  my $language_search_parameter =
    Google::Ads::AdWords::v201509::LanguageSearchParameter->new(
