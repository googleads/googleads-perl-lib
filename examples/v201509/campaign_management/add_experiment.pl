...
use Google::Ads::AdWords::v201509::AdGroupExperimentData;
use Google::Ads::AdWords::v201509::AdGroupOperation;
use Google::Ads::AdWords::v201509::BidMultiplier;
use Google::Ads::AdWords::v201509::BiddableAdGroupCriterion;
use Google::Ads::AdWords::v201509::BiddableAdGroupCriterionExperimentData;
use Google::Ads::AdWords::v201509::Criterion;
use Google::Ads::AdWords::v201509::Experiment;
use Google::Ads::AdWords::v201509::ExperimentOperation;
use
  Google::Ads::AdWords::v201509::ManualCPCAdGroupCriterionExperimentBidMultiplier;
use Google::Ads::AdWords::v201509::ManualCPCAdGroupExperimentBidMultipliers;
...
sub add_experiment {
  ...
  my $experiment = Google::Ads::AdWords::v201509::Experiment->new({
  ...
  my $experiment_operation =
    Google::Ads::AdWords::v201509::ExperimentOperation->new({
      operator => "ADD",
      operand  => $experiment
    });
  ...
  my $ad_group =
    Google::Ads::AdWords::v201509::AdGroup->new({id => $ad_group_id});

  # Create experiment bid multiplier rule that will modify ad group bid for the
  # experiment.
  my $bid_multiplier =
    Google::Ads::AdWords::v201509::ManualCPCAdGroupExperimentBidMultipliers->
    new({
      maxCpcMultiplier =>
        Google::Ads::AdWords::v201509::BidMultiplier->new({multiplier => 1.5})}
    );

  # Set experiment data to the ad group.
  my $experiment_data =
    Google::Ads::AdWords::v201509::AdGroupExperimentData->new({
  ...
  # Create operation.
  my $operation = Google::Ads::AdWords::v201509::AdGroupOperation->new({
      operand  => $ad_group,
      operator => "SET"
  });
  ...
  my $criterion =
    Google::Ads::AdWords::v201509::Criterion->new({id => $criterion_id,});
  ...
  $experiment_data =
    Google::Ads::AdWords::v201509::BiddableAdGroupCriterionExperimentData->new({
      experimentId            => $experiment_id,
      experimentDeltaStatus   => "MODIFIED",
  ...
  # Create operation.
  $operation = Google::Ads::AdWords::v201509::AdGroupCriterionOperation->new({
