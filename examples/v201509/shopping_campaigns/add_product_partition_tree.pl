...
use Google::Ads::AdWords::v201509::NegativeAdGroupCriterion;
use Google::Ads::AdWords::v201509::ProductBiddingCategory;
use Google::Ads::AdWords::v201509::ProductCanonicalCondition;
use Google::Ads::AdWords::v201509::ProductBrand;
use Google::Ads::AdWords::v201509::ProductPartition;
...
sub add_product_partition_tree {
  ...
  create_unit(
    ...
    $ad_group_id,
    $root,
    Google::Ads::AdWords::v201509::ProductCanonicalCondition->new(
      {condition => "NEW"}
    ),
    200000
  );
  ...
  create_unit($operations, $ad_group_id, $other_condition,
    Google::Ads::AdWords::v201509::ProductBrand->new({value => "CoolBrand"}),
    900000);

  create_unit($operations, $ad_group_id, $other_condition,
    Google::Ads::AdWords::v201509::ProductBrand->new({value => "CheapBrand"}),
    10000);

  my $other_brand =
    create_subdivision($operations, $next_id--, $ad_group_id, $other_condition,
    Google::Ads::AdWords::v201509::ProductBrand->new());
  ...
  create_unit(
    ...
    $ad_group_id,
    $other_brand,
    Google::Ads::AdWords::v201509::ProductBiddingCategory->new({
...
sub create_subdivision {
  ...
  my $division = Google::Ads::AdWords::v201509::ProductPartition->new({
  ...
  my $criterion = Google::Ads::AdWords::v201509::BiddableAdGroupCriterion->new({
...
sub create_unit {
  ...
  my $unit = Google::Ads::AdWords::v201509::ProductPartition->new(
    {partitionType => "UNIT",});
  ...
  if ($bid_amount && $bid_amount > 0) {
    ...
    $criterion = Google::Ads::AdWords::v201509::NegativeAdGroupCriterion->new();
  }
...
sub create_add_operation {
  ...
  my $operation = Google::Ads::AdWords::v201509::AdGroupCriterionOperation->new(
    {
