...
use Google::Ads::AdWords::v201509::ManagedCustomer;
use Google::Ads::AdWords::v201509::ManagedCustomerOperation;
...
sub create_account {
  ...
  my $account = Google::Ads::AdWords::v201509::ManagedCustomer->new({
  ...
  my $operation = Google::Ads::AdWords::v201509::ManagedCustomerOperation->new({
      operator => "ADD",
      operand  => $account
  });
