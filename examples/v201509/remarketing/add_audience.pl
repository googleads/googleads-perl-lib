...
use Google::Ads::AdWords::v201509::UserListConversionType;
...
sub add_audience {
  ...
  my $conversion_type =
    Google::Ads::AdWords::v201509::UserListConversionType->new({name => $name});

  # Create remarketing user list.
  my $user_list = Google::Ads::AdWords::v201509::BasicUserList->new({
      name            => $name,
