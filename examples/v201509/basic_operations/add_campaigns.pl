...
use Google::Ads::AdWords::v201509::FrequencyCap;
use Google::Ads::AdWords::v201509::GeoTargetTypeSetting;
use Google::Ads::AdWords::v201509::ManualCpcBiddingScheme;
...
sub add_campaigns {
  ...
  for (my $i = 0 ; $i < $num_campaigns ; $i++) {
    ...
    my $campaign = Google::Ads::AdWords::v201509::Campaign->new({
        ...
        budget =>
          Google::Ads::AdWords::v201509::Budget->new({budgetId => $budgetId}),
        ...
        frequencyCap => Google::Ads::AdWords::v201509::FrequencyCap->new({
            impressions => 5,
            timeUnit    => "DAY",
            level       => "ADGROUP"
          }
        ...
        settings => [
          ...
          Google::Ads::AdWords::v201509::GeoTargetTypeSetting->new({
