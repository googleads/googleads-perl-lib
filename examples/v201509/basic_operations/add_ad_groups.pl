...
use Google::Ads::AdWords::v201509::TargetingSetting;
use Google::Ads::AdWords::v201509::TargetingSettingDetail;
        ...
        settings => [
          ...
          Google::Ads::AdWords::v201509::TargetingSetting->new({
              details => [
                ...
                Google::Ads::AdWords::v201509::TargetingSettingDetail->new({
