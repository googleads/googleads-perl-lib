...
use Google::Ads::AdWords::v201609::GeoTargetOperand;
use Google::Ads::AdWords::v201609::IncomeOperand;
use Google::Ads::AdWords::v201609::Language;
use Google::Ads::AdWords::v201609::Location;
use Google::Ads::AdWords::v201609::LocationExtensionOperand;
use Google::Ads::AdWords::v201609::LocationGroups;
use Google::Ads::AdWords::v201609::Platform;
...
sub add_campaign_targeting_criteria {
  ...
  my $mexico = Google::Ads::AdWords::v201609::Location->new({
      id => 2484    # Mexico
  });
  ...
  my $income = Google::Ads::AdWords::v201609::LocationGroups->new({
      matchingFunction => Google::Ads::AdWords::v201609::Function->new({
          operator   => "AND",
          lhsOperand => Google::Ads::AdWords::v201609::IncomeOperand->new({
          ...
          rhsOperand => Google::Ads::AdWords::v201609::GeoTargetOperand->new({
  ...
  if ($location_feed_id) {
    ...
    my $radius = Google::Ads::AdWords::v201609::ConstantOperand->new({
        type        => "DOUBLE",
        unit        => "MILES",
        doubleValue => 10.0
    });
    my $radiusLocationGroup =
      Google::Ads::AdWords::v201609::LocationGroups->new({
        matchingFunction => Google::Ads::AdWords::v201609::Function->new({
            operator => "IDENTITY",
            lhsOperand =>
              Google::Ads::AdWords::v201609::LocationExtensionOperand->new(
              {radius => $radius})}
        ),
