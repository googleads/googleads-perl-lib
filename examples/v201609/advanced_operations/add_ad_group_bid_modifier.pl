...
use Google::Ads::AdWords::v201609::AdGroupBidModifierOperation;
use Google::Ads::AdWords::v201609::AdGroupBidModifier;
...
sub add_ad_group_bid_modifier {
  ...
  my $mobile = Google::Ads::AdWords::v201609::Platform->new({id => 30001});

  # Create the bid modifier.
  my $modifier = Google::Ads::AdWords::v201609::AdGroupBidModifier->new({
  ...
  my $operation =
    Google::Ads::AdWords::v201609::AdGroupBidModifierOperation->new({
      operator => "ADD",
      operand  => $modifier
    });
