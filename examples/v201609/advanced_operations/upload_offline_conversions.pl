...
use Google::Ads::AdWords::v201609::UploadConversion;
use Google::Ads::AdWords::v201609::ConversionTrackerOperation;
use Google::Ads::AdWords::v201609::OfflineConversionFeed;
use Google::Ads::AdWords::v201609::OfflineConversionFeedOperation;
...
sub upload_offline_conversions {
  ...
  my $upload_conversion = Google::Ads::AdWords::v201609::UploadConversion->new({
      category                  => 'PAGE_VIEW',
  ...
  my $feed = Google::Ads::AdWords::v201609::OfflineConversionFeed->new({
  ...
  my $offline_conversion_operation =
    Google::Ads::AdWords::v201609::OfflineConversionFeedOperation->new({
      operator => "ADD",
      operand  => $feed
    });
