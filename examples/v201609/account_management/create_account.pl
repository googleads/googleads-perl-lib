...
use Google::Ads::AdWords::v201609::ManagedCustomer;
use Google::Ads::AdWords::v201609::ManagedCustomerOperation;
...
sub create_account {
  ...
  my $account = Google::Ads::AdWords::v201609::ManagedCustomer->new({
  ...
  my $operation = Google::Ads::AdWords::v201609::ManagedCustomerOperation->new({
      operator => "ADD",
      operand  => $account
  });
