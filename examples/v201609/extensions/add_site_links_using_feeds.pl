...
use Google::Ads::AdWords::v201609::AttributeFieldMapping;
use Google::Ads::AdWords::v201609::CampaignFeed;
use Google::Ads::AdWords::v201609::CampaignFeedOperation;
use Google::Ads::AdWords::v201609::Feed;
use Google::Ads::AdWords::v201609::FeedAttribute;
use Google::Ads::AdWords::v201609::FeedItem;
use Google::Ads::AdWords::v201609::FeedItemAttributeValue;
use Google::Ads::AdWords::v201609::FeedItemGeoRestriction;
use Google::Ads::AdWords::v201609::FeedItemOperation;
use Google::Ads::AdWords::v201609::FeedMapping;
use Google::Ads::AdWords::v201609::FeedMappingOperation;
use Google::Ads::AdWords::v201609::FeedOperation;
use Google::Ads::AdWords::v201609::Function;
...
sub create_site_links_feed() {
  ...
  my $text_attribute = Google::Ads::AdWords::v201609::FeedAttribute->new({
    type => "STRING",
    name => "Link Text"
  });
  my $final_url_attribute = Google::Ads::AdWords::v201609::FeedAttribute->new({
    type => "URL_LIST",
  ...
  my $operation = Google::Ads::AdWords::v201609::FeedOperation->new({
    operator => "ADD",
    operand  => $feed
  });
...
sub create_feed_item_add_operation() {
  ...
  if ($location_id) {
    my $location =
      Google::Ads::AdWords::v201609::Location->new({id => $location_id});
  ...
  my $operation = Google::Ads::AdWords::v201609::FeedItemOperation->new({
    operand  => $feed_item,
    operator => "ADD"
  });
...
sub create_site_links_feed_mapping() {
  ...
  my $feed_mapping = Google::Ads::AdWords::v201609::FeedMapping->new({
...
sub create_site_links_campaign_feed() {
  ...
  my $matching_function = Google::Ads::AdWords::v201609::Function->new(
    {functionString => $matching_function_string});

  my $campaign_feed = Google::Ads::AdWords::v201609::CampaignFeed->new({
      feedId           => $site_links_data->{"siteLinksFeedId"},
  ...
  my $result = $client->CampaignFeedService()->mutate({
      operations => [
        Google::Ads::AdWords::v201609::CampaignFeedOperation->new({
