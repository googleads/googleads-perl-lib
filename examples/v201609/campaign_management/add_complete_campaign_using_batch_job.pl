...
use Google::Ads::AdWords::v201609::AdGroup;
...
use Google::Ads::AdWords::v201609::AdGroupOperation;
use Google::Ads::AdWords::v201609::BatchJob;
use Google::Ads::AdWords::v201609::BatchJobOperation;
...
use Google::Ads::AdWords::v201609::NegativeCampaignCriterion;
...
sub add_complete_campaign_using_batch_job {
  ...
  my $operation = Google::Ads::AdWords::v201609::BatchJobOperation->new({
      operator => 'ADD',
      operand  => Google::Ads::AdWords::v201609::BatchJob->new({})});
...
sub _create_campaign_operations {
  ...
  for (my $i = 1 ; $i < NUMBER_OF_CAMPAIGNS_TO_ADD ; $i++) {
    my $campaign = Google::Ads::AdWords::v201609::Campaign->new({
        ...
        budget => Google::Ads::AdWords::v201609::Budget->new(
...
sub _create_campaign_criterion_operations() {
  ...
  for my $campaign_operation (@campaign_operations) {
    ...
    my $negative_criterion =
      Google::Ads::AdWords::v201609::NegativeCampaignCriterion->new({
  ...
  for my $campaign_operation (@campaign_operations) {
    for (my $i = 1 ; $i < NUMBER_OF_ADGROUPS_TO_ADD ; $i++) {
      ...
      my $ad_group_operation =
        Google::Ads::AdWords::v201609::AdGroupOperation->new({
          operator => "ADD",
          operand  => $ad_group
        });
  ...
  for my $ad_group_operation (@ad_group_operations) {
    for (my $i = 1 ; $i < NUMBER_OF_KEYWORDS_TO_ADD ; $i++) {
      ...
      my $ad_group_criterion_operation =
        Google::Ads::AdWords::v201609::AdGroupCriterionOperation->new({
          operator => "ADD",
