...
use Google::Ads::AdWords::v201609::OfflineCallConversionFeed;
use Google::Ads::AdWords::v201609::OfflineCallConversionFeedOperation;
...
sub upload_offline_conversions {
  ...
  # conversions.
  my $feed = Google::Ads::AdWords::v201609::OfflineCallConversionFeed->new({
  ...
  my $offline_conversion_operation =
    Google::Ads::AdWords::v201609::OfflineCallConversionFeedOperation->new({
      operator => "ADD",
      operand  => $feed
    });
