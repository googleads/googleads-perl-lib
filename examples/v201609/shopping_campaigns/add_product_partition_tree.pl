...
use Google::Ads::AdWords::v201609::BiddingStrategyConfiguration;
use Google::Ads::AdWords::v201609::CpcBid;
use Google::Ads::AdWords::v201609::Criterion;
use Google::Ads::AdWords::v201609::Money;
use Google::Ads::AdWords::v201609::NegativeAdGroupCriterion;
...
use Google::Ads::AdWords::v201609::ProductPartition;
...
sub add_product_partition_tree {
  ...
  create_unit($operations, $ad_group_id, $other_condition,
    Google::Ads::AdWords::v201609::ProductBrand->new({value => "CoolBrand"}),
    900000);

  create_unit($operations, $ad_group_id, $other_condition,
    Google::Ads::AdWords::v201609::ProductBrand->new({value => "CheapBrand"}),
    10000);

  my $other_brand =
    create_subdivision($operations, $next_id--, $ad_group_id, $other_condition,
    Google::Ads::AdWords::v201609::ProductBrand->new());
...
sub create_subdivision {
  ...
  my $division = Google::Ads::AdWords::v201609::ProductPartition->new({
  ...
  my $criterion = Google::Ads::AdWords::v201609::BiddableAdGroupCriterion->new({
...
sub create_unit {
  ...
  my $unit = Google::Ads::AdWords::v201609::ProductPartition->new(
    {partitionType => "UNIT",});
  ...
  if ($bid_amount && $bid_amount > 0) {
    ...
    $criterion = Google::Ads::AdWords::v201609::NegativeAdGroupCriterion->new();
  }
