...
use Google::Ads::AdWords::v201609::TargetingSetting;
use Google::Ads::AdWords::v201609::TargetingSettingDetail;
  ...
  for (my $i = 0 ; $i < $num_ad_groups ; $i++) {
    ...
    my $ad_group = Google::Ads::AdWords::v201609::AdGroup->new({
        ...
        settings => [
          ...
          Google::Ads::AdWords::v201609::TargetingSetting->new({
              details => [
                # Restricting to serve ads that match your ad group placements.
                # This is equivalent to choosing "Target and bid" in the UI.
                Google::Ads::AdWords::v201609::TargetingSettingDetail->new({
