...
use Google::Ads::AdWords::v201609::FrequencyCap;
use Google::Ads::AdWords::v201609::GeoTargetTypeSetting;
use Google::Ads::AdWords::v201609::ManualCpcBiddingScheme;
...
sub add_campaigns {
  ...
  for (my $i = 0 ; $i < $num_campaigns ; $i++) {
    ...
    my $campaign = Google::Ads::AdWords::v201609::Campaign->new({
        ...
        frequencyCap => Google::Ads::AdWords::v201609::FrequencyCap->new({
            impressions => 5,
            timeUnit    => "DAY",
            level       => "ADGROUP"
          }
        ...
        settings => [
          ...
          Google::Ads::AdWords::v201609::GeoTargetTypeSetting->new({
